import{j as r}from"./jsx-runtime-Nms4Y4qS.js";import{S as E}from"./index-Brw_kfkv.js";import{r as s}from"./index-BwDkhjyp.js";import{C as G}from"./index-YYnwjzoa.js";import{g as F,h as H,i as A}from"./fondue-icons330-C1IajNtr.js";import{e as b}from"./Select-D9R_SZWK.js";import{T as l}from"./TextInput-CQW1Q6kX.js";const P="_root_v784d_5",X="_inputs_v784d_12",$="_colorFormatInput_v784d_23",S="_colorAlphaInput_v784d_24",B="_colorChannelInputGroup_v784d_28",D="_inputDecorator_v784d_39",O="_gradientInput_v784d_43",L="_reactColorful_v784d_46",z="_valueInput_v784d_50",u={root:P,inputs:X,colorFormatInput:$,colorAlphaInput:S,colorChannelInputGroup:B,inputDecorator:D,gradientInput:O,reactColorful:L,valueInput:z},y={red:255,green:255,blue:255,alpha:1,name:""},_="HEX",M=e=>{if(e)return`rgba(${e.red}, ${e.green}, ${e.blue}, ${e.alpha||1})`},w=e=>{const a=/^([\dA-Fa-f]{3}){1,2}$/;return e.length>2&&a.test(e)},U=e=>{const a=/^([\dA-Fa-f]{3}){1,2}$/,t=e.match(a);if(!t)return{red:0,green:0,blue:0,alpha:0};const n=t[0];return n.length===3?{red:parseInt(`${n[0]}${n[0]}`,16),green:parseInt(`${n[1]}${n[1]}`,16),blue:parseInt(`${n[2]}${n[2]}`,16),alpha:1}:{red:parseInt(n.slice(0,2),16),green:parseInt(n.slice(2,4),16),blue:parseInt(n.slice(4,6),16),alpha:1}},v=e=>{const{red:a,green:t,blue:n}=e;return`${a.toString(16).padStart(2,"0")}${t.toString(16).padStart(2,"0")}${n.toString(16).padStart(2,"0")}`},I=(e,a)=>a==="HEX"?{...e,name:`#${v(e)}`}:{...e,name:`rgba(${e.red}, ${e.green}, ${e.blue}, ${e.alpha||1})`},h=(e,a=0,t=255)=>e.length===0||parseInt(e)<a?a:parseInt(e)>t?t:parseInt(e),k=({currentColor:e=y,onColorChange:a=()=>{},"data-test-id":t="color-picker-input"},n)=>r.jsx("div",{className:u.gradientInput,"data-test-id":t,ref:n,children:r.jsx(G,{className:u.reactColorful,color:{r:e.red,g:e.green,b:e.blue,a:e.alpha===void 0?1:e.alpha},onChange:i=>a({red:i.r,green:i.g,blue:i.b,alpha:i.a})})});k.displayName="ColorPicker.Gradient";const x=s.forwardRef(k);k.__docgenInfo={description:"",methods:[],displayName:"ColorPicker.Gradient",props:{currentColor:{required:!1,tsType:{name:"signature",type:"object",raw:`{
    red: number;
    green: number;
    blue: number;
    alpha?: number;
