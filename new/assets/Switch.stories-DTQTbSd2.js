import{j as e}from"./jsx-runtime-DBEcOq3S.js";import{r as i}from"./index-DtJulBIN.js";import{b as de}from"./fondue-icons324-Bw2AQYl8.js";import{L as te}from"./Label-Bir9PH-9.js";import{T as j}from"./Tooltip-DFl4NmEH.js";import{u as ue,c as me}from"./index-BHYJtXto.js";import{u as pe,P as ae}from"./index-Dhc4yksV.js";import{c as he}from"./index-P-l_ls5c.js";import{u as fe}from"./index-BRCTM6zp.js";import{u as ge}from"./index-CvTA8V3i.js";import{c as be}from"./styleUtilities-BnElyh0X.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-COuo08O9.js";import"./index-BqTDQIm7.js";import"./index-Bw4vj2Av.js";import"./index-CvF5QBWm.js";import"./index-D21DJKX5.js";var _="Switch",[we,Xe]=he(_),[ve,Se]=we(_),re=i.forwardRef((t,o)=>{const{__scopeSwitch:a,name:r,checked:s,defaultChecked:d,required:l,disabled:c,value:m="on",onCheckedChange:x,...q}=t,[u,y]=i.useState(null),ce=pe(o,h=>y(h)),C=i.useRef(!1),L=u?!!u.closest("form"):!0,[p=!1,ie]=ue({prop:s,defaultProp:d,onChange:x});return e.jsxs(ve,{scope:a,checked:p,disabled:c,children:[e.jsx(ae.button,{type:"button",role:"switch","aria-checked":p,"aria-required":l,"data-state":ne(p),"data-disabled":c?"":void 0,disabled:c,value:m,...q,ref:ce,onClick:me(t.onClick,h=>{ie(le=>!le),L&&(C.current=h.isPropagationStopped(),C.current||h.stopPropagation())})}),L&&e.jsx(Te,{control:u,bubbles:!C.current,name:r,value:m,checked:p,required:l,disabled:c,style:{transform:"translateX(-100%)"}})]})});re.displayName=_;var se="SwitchThumb",oe=i.forwardRef((t,o)=>{const{__scopeSwitch:a,...r}=t,s=Se(se,a);return e.jsx(ae.span,{"data-state":ne(s.checked),"data-disabled":s.disabled?"":void 0,...r,ref:o})});oe.displayName=se;var Te=t=>{const{control:o,checked:a,bubbles:r=!0,...s}=t,d=i.useRef(null),l=fe(a),c=ge(o);return i.useEffect(()=>{const m=d.current,x=window.HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(x,"checked").set;if(l!==a&&u){const y=new Event("click",{bubbles:r});u.call(m,a),m.dispatchEvent(y)}},[l,a,r]),e.jsx("input",{type:"checkbox","aria-hidden":!0,defaultChecked:a,...s,tabIndex:-1,ref:d,style:{...t.style,...c,position:"absolute",pointerEvents:"none",opacity:0,margin:0}})};function ne(t){return t?"checked":"unchecked"}var ke=re,xe=oe;const ye="_root_3rs89_5",Ce="_small_3rs89_27",je="_medium_3rs89_31",Ee="_large_3rs89_35",_e="_thumb_3rs89_49",E={root:ye,small:Ce,medium:je,large:Ee,thumb:_e},qe=({value:t,defaultValue:o,size:a="medium",onChange:r,"data-test-id":s="fondue-switch","aria-label":d="Switch",...l},c)=>e.jsx(ke,{ref:c,checked:t,defaultChecked:o,className:be([E.root,E[a]]),onCheckedChange:r,"aria-label":d,"data-test-id":s,...l,children:e.jsx(xe,{className:E.thumb})}),n=i.forwardRef(qe);n.displayName="Switch";n.__docgenInfo={description:"",methods:[],displayName:"Switch",props:{id:{required:!1,tsType:{name:"string"},description:""},name:{required:!1,tsType:{name:"string"},description:""},size:{required:!1,tsType:{name:"union",raw:"'small' | 'medium' | 'large'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'medium'"},{name:"literal",value:"'large'"}]},description:`The size of the switch component.
...
@param event - The event object`},"data-test-id":{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'fondue-switch'",computed:!1}},"aria-label":{defaultValue:{value:"'Switch'",computed:!1},required:!1}}};const $e={component:n,tags:["autodocs"],parameters:{status:{type:"in_progress"}},argTypes:{size:{control:{type:"select",options:["small","medium","large"]}}},args:{id:"airplane-mode","aria-label":"Toggle airplane mode"},decorators:[t=>e.jsx("div",{className:"tw-flex tw-gap-1.5 tw-items-center",children:e.jsx(t,{})})]},f={args:{defaultValue:!0}},g={args:{defaultValue:!1}},b={args:{defaultValue:!1,disabled:!0}},w={args:{defaultValue:!1,required:!0}},v={render:t=>e.jsxs(e.Fragment,{children:[e.jsx(te,{id:"label",htmlFor:"switch",children:"Switch"}),e.jsx(n,{...t,id:"switch","aria-labelledby":"label"})]})},S={render:t=>e.jsxs(e.Fragment,{children:[e.jsxs(te,{id:"label",htmlFor:"switch",children:["Switch",e.jsxs(j.Root,{children:[e.jsx(j.Trigger,{children:e.jsx(de,{size:"16"})}),e.jsx(j.Content,{children:"Tooltip"})]})]}),e.jsx(n,{...t,id:"switch","aria-labelledby":"label"})]})},T={render:t=>{const[o,a]=i.useState(!1),r=s=>{a(s)};return e.jsx(n,{value:o,onChange:r,...t})}},k={render:t=>e.jsxs(e.Fragment,{children:[e.jsx(n,{...t,size:"small"}),e.jsx(n,{...t,size:"medium"}),e.jsx(n,{...t,size:"large"})]})};var z,F,R;f.parameters={...f.parameters,docs:{...(z=f.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    defaultValue: true
  }
