...
describe('getAreaFillColors', () => {
    test('correct colors for three data sets and no missing data', () => {
        const colors = getAreaFillColors(3, 0);
        expect(colors).toEqual(WEAK_COLORS);
    });

    test('correct colors for two data sets and two missing data sets', () => {
    ...
    test('correct colors for one data set and three missing data sets', () => {
    ...
    test('correct colors for five data sets and two missing data sets', () => {
