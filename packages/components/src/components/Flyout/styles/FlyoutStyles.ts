...
export const flyoutContentStyles = sv({
    base: 'tw-block tw-bg-base tw-shadow-mid tw-border tw-border-line tw-max-w-[--flyout-max-width] tw-group',
    variants: {
        rounded: {
            true: 'tw-rounded',
            false: '',
...
export const flyoutFooterStyles =
    'tw-border-t tw-border-line tw-font-medium tw-flex tw-justify-end tw-gap-2 ' +
    'group-data-[flyout-spacing=compact]:tw-p-4 ' +
    'group-data-[flyout-spacing=comfortable]:tw-p-6 ' +
    'group-data-[flyout-spacing=spacious]:tw-p-10';
