...
export const dialogContentStyles = sv({
    base:
        ...
        'tw-min-w-[--dialog-min-width] tw-max-w-[--dialog-max-width] tw-min-h-[--dialog-min-height] tw-max-h-[600px] tw-h-fit tw-overflow-hidden ' +
        'has-[[data-dialog-layout-component]]:tw-grid tw-grid-rows-[auto_auto_minmax(0_,_1fr)_auto] sm:tw-grid-rows-[auto_minmax(0_,_1fr)_auto] tw-grid-cols-[min-content_auto]',
    variants: {
        rounded: {
            true: 'tw-rounded-lg',
            false: '',
