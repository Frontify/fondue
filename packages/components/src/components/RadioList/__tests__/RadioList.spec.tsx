...
describe('RadioList component', () => {
    ...
    it('respects readOnly state', async () => {
        ...
        // ReadOnly state prevents interaction, so we just verify it's set
        expect(onValueChange).not.toHaveBeenCalled();
    });
    ...
    it('handles individual radio button disabled state', async () => {
        const onValueChange = vi.fn();
        render(
    ...
    it('handles individual radio button readOnly state', async () => {
        const onValueChange = vi.fn();
