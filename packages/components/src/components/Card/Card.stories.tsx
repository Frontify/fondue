...
export const WithLargeBanner: Story = {
    render: (args) => {
        return (
            <Card.Root {...args}>
                <Card.Banner size="large">
                    <Card.BannerImage src="https://picsum.photos/seed/card3/400/300" alt="Large banner" />
                    <Card.Badges>
                ...
                <Card.Title>Large Banner Card</Card.Title>
...
const FourStatesExample = () => {
    ...
    return (
        <Flex gap="1rem">
            {cards.map((card) => (
                <div key={card.id} style={{ width: 210 }}>
                    <Card.Root
...
const gridCards = [
    { name: 'Healthway Labs', logo: 'https://picsum.photos/seed/hw/80/80', banner: 'https://picsum.photos/seed/hw-bg/400/200' },
    { name: 'Strive', logo: 'https://picsum.photos/seed/strive/80/80', banner: 'https://picsum.photos/seed/strive-bg/400/200' },
    { name: 'Pizza Pie', logo: 'https://picsum.photos/seed/pizza/80/80', banner: 'https://picsum.photos/seed/pizza-bg/400/200' },
    ...
    { name: 'Nobrand: Neutral', logo: 'https://picsum.photos/seed/nobrand1/80/80', banner: 'https://picsum.photos/seed/nobrand1-bg/400/200' },
    { name: 'Nobrand: Neutral', logo: 'https://picsum.photos/seed/nobrand2/80/80', banner: 'https://picsum.photos/seed/nobrand2-bg/400/200' },
...
export const ResponsiveGrid: Story = {
    ...
    render: () => (
        ...
        >
            {gridCards.map((card) => (
                <Card.Root key={card.name + card.logo} onClick={() => {}}>
                    <Card.Banner size="large">
                        {card.banner ? (
