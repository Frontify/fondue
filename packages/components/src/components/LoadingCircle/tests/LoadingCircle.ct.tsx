...
test('should render with defaults', async ({ mount }) => {
    const wrapper = await mount(<LoadingCircle data-test-id="loading-circle-root" />);
    const component = wrapper.getByTestId('loading-circle-root');
...
test('should render x-small', async ({ mount }) => {
    const wrapper = await mount(<LoadingCircle size="x-small" data-test-id="loading-circle-root" />);
    const component = wrapper.getByTestId('loading-circle-root');
    await expect(component).toBeVisible();
...
test('should render small', async ({ mount }) => {
    const wrapper = await mount(<LoadingCircle size="small" data-test-id="loading-circle-root" />);
    const component = wrapper.getByTestId('loading-circle-root');
    await expect(component).toBeVisible();
...
test('should render medium', async ({ mount }) => {
    const wrapper = await mount(<LoadingCircle size="medium" data-test-id="loading-circle-root" />);
    const component = wrapper.getByTestId('loading-circle-root');
    await expect(component).toBeVisible();
    await expect(component).toHaveCSS('width', '32px');
    await expect(component).toHaveCSS('height', '32px');
...
test('should render large', async ({ mount }) => {
    const wrapper = await mount(<LoadingCircle size="large" data-test-id="loading-circle-root" />);
    const component = wrapper.getByTestId('loading-circle-root');
    await expect(component).toBeVisible();
...
test('should render progress variant', async ({ mount }) => {
    const wrapper = await mount(<LoadingCircle variant="progress" data-test-id="loading-circle-root" />);
    const component = wrapper.getByTestId('loading-circle-root');
    await expect(component).toBeVisible();
    await expect(component).toHaveCSS('border-left-color', 'rgb(182, 10, 227)');
});
...
test('should render success variant', async ({ mount }) => {
    const wrapper = await mount(<LoadingCircle variant="success" data-test-id="loading-circle-root" />);
    const component = wrapper.getByTestId('loading-circle-root');
    await expect(component).toBeVisible();
...
test('should render danger variant', async ({ mount }) => {
    const wrapper = await mount(<LoadingCircle variant="danger" data-test-id="loading-circle-root" />);
    const component = wrapper.getByTestId('loading-circle-root');
    await expect(component).toBeVisible();
