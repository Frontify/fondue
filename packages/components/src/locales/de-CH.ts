...
const translations = {
    AssetInput_browse: 'Durchsuchen',
    AssetInput_upload: 'Hochladen',
    ...
    Select_selectedItemsCount: '${count} ausgewählt',
    ...
    Tree_renameInputLabel: 'Neuer Name',
