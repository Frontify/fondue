...
describe('serializeNodeToHtmlRecursive()', () => {
    ...
    it('serializes with quotes in them correctly', () => {
        ...
        expect(result).to.be.equal(
            '<p dir="auto" class="tw-break-words" style="font-size: 14px; font-style: normal; font-weight: normal;"><a dir="auto" class="tw-break-words" style="font-size: 14px; font-style: normal; color: rgb(182, 10, 227, 1); text-decoration: underline; cursor: pointer;" target="_self" href="https://frontify.com">This is a Link.</a></p>',
        );
    });
