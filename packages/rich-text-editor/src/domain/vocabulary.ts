...
/**
 * Stands in for "every list that is mounted" inside a `BlockSpec.contains`, so
 * a list item can allow nesting without naming lists that may not exist yet.
 * The schema assembler expands it to every mounted block declared `isList`.
 */
