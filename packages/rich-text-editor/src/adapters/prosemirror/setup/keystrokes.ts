...
import { type EditorControlApi, type RteInputRule, type RtePlugin } from '#/domain';

import { declaredTriggers, triggerTrackingPlugin } from '../live/floating';
import { listKeys } from '../live/lists';
