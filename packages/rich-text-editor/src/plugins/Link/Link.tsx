...
export const linkPlugin = (): RtePlugin => ({
        ...
        marks: [
            {
                ...
                render: ({ value, children }) => {
                    ...
                    // Partial: a pasted `<a>` without an href leaves it unset.
    ...
    floating: {
        ...
        // the user is picking text to format, which is the toolbar's job — and
        // is what the toolbar's own flyout leaves behind while it is open.
        render: ({ api }) => {
