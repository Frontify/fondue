...
export type FigmaVariableValue = FigmaVariableColorValue | FigmaVariableStringValue | FigmaVariableNumberValue | FigmaVariableBooleanValue | FigmaVariableAliasValue
