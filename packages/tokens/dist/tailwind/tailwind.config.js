        ...
        plugin(function ({ addUtilities }) {
            addUtilities({
                '.body-x-small-default': {
                    ...
                    letterCasing: 'var(--typography-letter-casing-default)',
                },
                '.body-x-small-strong': {
                    fontFamily: 'var(--typography-font-family-primary)',
                    fontSize: 'var(--typography-font-size-x-small)',
