...
export default {
    theme: {
        colors: {
            charts: {
                dim: { DEFAULT: 'var(--color-charts-dim-default)' },
                missing: { DEFAULT: 'var(--color-charts-missing-default)' },
                negative: {
                    DEFAULT: 'var(--color-charts-negative-default)',
                    hover: 'var(--color-charts-negative-hover)',
                    subtle: 'var(--color-charts-negative-subtle)',
                },
                primary: {
                    DEFAULT: 'var(--color-charts-primary-default)',
                    hover: 'var(--color-charts-primary-hover)',
                    subtle: 'var(--color-charts-primary-subtle)',
                },
                secondary: {
                    DEFAULT: 'var(--color-charts-secondary-default)',
                    hover: 'var(--color-charts-secondary-hover)',
                    subtle: 'var(--color-charts-secondary-subtle)',
                },
                tertiary: {
                    DEFAULT: 'var(--color-charts-tertiary-default)',
                    hover: 'var(--color-charts-tertiary-hover)',
                    subtle: 'var(--color-charts-tertiary-subtle)',
                },
            },
            container: {
                disabled: {
            ...
            'low-contrast': { DEFAULT: 'var(--color-low-contrast-default)' },
        ...
        outlineColor: { DEFAULT: 'var(--color-focus-default)' },
        outlineWidth: { DEFAULT: '4px' },
    ...
    plugins: [
        plugin(function ({ addUtilities }) {
            addUtilities({
                ...
                '.ring-focus': {
                    boxShadow: '0 0 0 2px var(--color-surface-default), 0 0 0 6px var(--color-focus-default)',
                    outline: 'none',
                },
            });
        }),
