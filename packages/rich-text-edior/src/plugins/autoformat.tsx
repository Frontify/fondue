...
export const AutoformatPlugin: RtePlugin = {
    ...
    inputRules: [
        ...
        // Blocks.
        { kind: 'block', match: '# ', block: 'heading', attributes: { level: 1 } },
        { kind: 'block', match: '## ', block: 'heading', attributes: { level: 2 } },
        { kind: 'block', match: '### ', block: 'heading', attributes: { level: 3 } },
        { kind: 'block', match: '#### ', block: 'heading', attributes: { level: 4 } },
