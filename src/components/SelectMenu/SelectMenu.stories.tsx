...
import { SelectMenu as SelectMenuComponent, SelectMenuProps } from "./SelectMenu";
...
export const SelectMenu: Story<SelectMenuProps & { onClick: () => void }> = (args) => {
    ...
    return (
        <div>
            <SelectMenuComponent {...args} menuBlocks={menuBlocks} />
