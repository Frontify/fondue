...
const dataWithIcon = data.map((item) => Object.assign({}, item, { decorator: <IconJohanna /> }));
...
const dataWithBadgeAndIcon = dataWithBadge.map((item) => Object.assign({}, item, { decorator: <IconJohanna /> }));
