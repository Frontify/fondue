...
describe('AccordionHeaderIcon Component', () => {
    ...
    it('renders switch type', () => {
        cy.mount(<AccordionHeaderIcon isOpen>Title</AccordionHeaderIcon>);
    ...
    it('renders with large switch', () => {
        cy.mount(
            <AccordionHeaderIcon isOpen size="large">
                Title
            </AccordionHeaderIcon>,
        );
    ...
    it('renders with medium switch', () => {
        cy.mount(
            <AccordionHeaderIcon isOpen size="medium">
                Title
            </AccordionHeaderIcon>,
        );
    ...
    it('renders with small switch', () => {
        cy.mount(
            <AccordionHeaderIcon isOpen size="small">
                Title
            </AccordionHeaderIcon>,
        );
