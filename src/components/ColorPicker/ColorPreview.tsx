...
export const ColorPreview: FC<ColorPreviewProps> = ({ color }) => {
    ...
    return (
        <div
            className="tw-sticky tw-box-content tw-shrink-0 tw-h-2 tw-top-0 tw-bg-white tw-z-20 dark:tw-bg-black-95 tw-shadow-inner tw-border-l tw-border-t tw-border-r tw-border-line tw-rounded-t"
