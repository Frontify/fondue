...
export const ColorInput: FC<ColorInputProps> = ({
    ...
    return (
        <div
            {...focusProps}
            className={merge([
                'tw-flex tw-items-center tw-h-9 tw-px-2 tw-border tw-rounded tw-text-s tw-font-sans tw-relative tw-bg-base focus-within:tw-border-black-90 tw-border-black-20',
