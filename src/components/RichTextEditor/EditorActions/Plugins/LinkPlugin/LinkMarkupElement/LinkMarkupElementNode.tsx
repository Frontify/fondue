...
import { LINK_CHANGE_CANCELED, LINK_CHANGE_CONFIRMED } from '../helpers/events';
import { getAndUpsertLink } from '../helpers/transforms/getAndUpsertLink';
import { ChosenLink } from '../helpers/types';
import { LinkChooserFlyout } from '../helpers/ui/LinkChooserFlyout';
import { LinkChooserPreviewFlyout } from '../helpers/ui/LinkChooserPreviewFlyout';

export const LINK_CLASSES = 'tw-text-text-interactive tw-underline tw-cursor-pointer';

export const LinkMarkupElementNode: FC<PlateRenderElementProps> = (props) => {
