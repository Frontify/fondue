...
export function EmojiPickerNavigation({
    ...
    return (
        <nav id="emoji-nav" className="tw-mb-2.5 tw-border-0 tw-border-b tw-border-solid tw-border-b-gray-100 tw-p-3">
                    ...
                    .map(({ id }) => (
                        <button
                            ...
                            className={cn(
                                ...
                                id === focusedCategory && 'tw-pointer-events-none tw-fill-current tw-text-blue-600',
                            )}
                            onClick={() => onClick(id)}
                        >
