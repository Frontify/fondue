    ...
    return (
        <div className="tw-flex tw-items-center tw-border-t tw-border-gray-100 tw-p-2">
            ...
            <div className="tw-overflow-hidden tw-pl-2">
                ...
                <div className="tw-truncate tw-text-xs tw-text-slate-500 dark:tw-text-slate-400">{`:${emoji?.id}:`}</div>
            </div>
        </div>
    );
}
...
function NoEmoji({ i18n }: NoEmojiPreviewProps) {
    return (
        <div className="tw-flex tw-items-center tw-border-t tw-border-gray-100 tw-p-2">
            ...
            <div className="tw-overflow-hidden tw-pl-2">
                <div className="tw-truncate tw-text-sm tw-text-gray-600">{i18n.searchNoResultsTitle}</div>
                <div className="tw-truncate tw-text-xs tw-text-slate-500 dark:tw-text-slate-400">
...
function PickAnEmoji({ i18n }: PickAnEmojiPreviewProps) {
    return (
        <div className="tw-flex tw-items-center tw-border-t tw-border-gray-100 tw-p-2">
            ...
            <div className="tw-overflow-hidden tw-pl-2">
                <div className="tw-truncate tw-text-lg tw-text-slate-500 dark:tw-text-slate-400">{i18n.pick}</div>
            </div>
        </div>
    );
}
