...
export const ButtonDisabledClasses: Record<Solid, string> = {
    ...
    [Solid.empty]: 'tw-not-allowed tw-pointer-events-none tw-border-transparent tw-text-text-disabled ',
};
...
export const ButtonStyleClasses: Record<Solid, Record<ButtonEmphasis, Record<ButtonStyle, ButtonElements>>> = {
    [Solid.filled]: {
