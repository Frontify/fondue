...
import { OrderableListV2 as OrderableListComponent } from "./OrderableListV2";
...
export default {
    title: "Components/Orderable List V 2",
...
export const OrderableListV2: Story<OrderableListProps<StoryListItem>> = ({ onMove, dragDisabled }) => {
