...
import { DragProperties, ItemDragState, OrderableListV2, OrderableListItem, OrderableListProps } from ".";
...
const OrderableListWithDefaultProps = ({
    ...
    <OrderableListV2 renderContent={renderContent} dragDisabled={dragDisabled} items={items} onMove={onMove} />
);

describe("OrderableListV2 Component", () => {
