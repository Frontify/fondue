...
import { IconItem, SegmentedPicker, TextOrNumberItem } from './SegmentedPicker';
...
const Component: FC<Props> = ({ items, disabled = false }) => {
    ...
    return <SegmentedPicker items={items} activeItemId={active} onChange={setActive} disabled={disabled} />;
};
