...
export const TextInput = forwardRef<HTMLInputElement, TextInputProps>(
    (
        ...
        const { isFocusVisible: extraActionButtonIsFocusVisible, focusProps: extraActionButtonFocusProps } =
            useFocusRing();

        const { copy, status } = useCopy();

        const inputElement = useForwardedRef<HTMLInputElement | null>(ref);
