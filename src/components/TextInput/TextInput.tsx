...
export const TextInput: FC<TextInputProps> = ({
    ...
    return (
        <div
            {...focusProps}
            className={merge([
                'tw-flex tw-items-center tw-h-9 tw-gap-2 tw-px-3 tw-border hover:tw-border-black-90 tw-transition tw-rounded tw-text-s tw-font-sans tw-relative tw-bg-base',
