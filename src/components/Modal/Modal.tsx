            ...
            <FocusScope contain restoreFocus autoFocus>
                ...
                >
                    <div
                        ...
                        className="tw-flex-initial tw-min-h-0 tw-w-full tw-flex tw-bg-base tw-overflow-hidden tw-border tw-border-solid tw-border-line-strong tw-rounded tw-shadow-2xl"
                    >
                        {visual?.pattern && (
