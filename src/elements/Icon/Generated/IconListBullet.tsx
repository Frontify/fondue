...
function IconListBullet(props: IconProps): React.ReactElement<IconProps> {
...
const MemoIconListBullet = React.memo(IconListBullet);
export default MemoIconListBullet;
