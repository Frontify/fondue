...
function IconEmojiUnhappy(props: IconProps): React.ReactElement<IconProps> {
...
const MemoIconEmojiUnhappy = React.memo(IconEmojiUnhappy);
export default MemoIconEmojiUnhappy;
