...
export const AddBlockButton: FC<AddBlockButtonProps> = ({
    ...
    return (
        <button
            ...
            className={`tw-text-white tw-bg-violet-60 tw-rounded tw-inline-flex tw-items-center tw-w-7 tw-h-6 tw-relative tw-p-1 tw-transition-colors hover:tw-bg-violet-70 active:tw-bg-violet-70 ${
