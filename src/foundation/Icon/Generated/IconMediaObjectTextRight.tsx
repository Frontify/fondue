...
const MemoizedIconMediaObjectTextRight = memo(IconMediaObjectTextRight);
MemoizedIconMediaObjectTextRight.displayName = 'FondueIconMediaObjectTextRight';

export default MemoizedIconMediaObjectTextRight;
