...
const MemoizedIconArrowRoundClockwise = memo(IconArrowRoundClockwise);
MemoizedIconArrowRoundClockwise.displayName = 'FondueIconArrowRoundClockwise';

export default MemoizedIconArrowRoundClockwise;
