...
function IconStrikethrough(props: GeneratedIconProps): React.ReactElement<GeneratedIconProps> {
    ...
    return (
        <svg
            ...
            {...props}
        >
            <path d="M11.577 14.929H9.269v-3.941H7.731v3.94H5.423v1.54h6.154v-1.54Z" />
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M.75 8.544a.75.75 0 0 1 .75-.75h14a.75.75 0 0 1 0 1.5h-14a.75.75 0 0 1-.75-.75Z"
            />
            <path d="M7.747 5.93h1.506V2.16h4.742v1.538H15.5V.621h-14v3.077h1.505V2.16h4.742v3.77Z" />
        </svg>
    );
}
