    ...
    return (
        ...
        >
            <path
                fill="currentColor"
                fillRule="evenodd"
                d="M25.988 16 16 10.184 6.012 16 16 21.817 25.988 16Zm-8.982-7.545a2 2 0 0 0-2.013 0l-11.472 6.68a1 1 0 0 0 0 1.73l11.472 6.68a2 2 0 0 0 2.013 0l11.473-6.68a1 1 0 0 0 0-1.73l-11.473-6.68Z"
                clipRule="evenodd"
            />
        </svg>
    );
