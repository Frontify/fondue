...
const MemoizedIconMediaObjectImage = memo(IconMediaObjectImage);
MemoizedIconMediaObjectImage.displayName = 'FondueIconMediaObjectImage';

export default MemoizedIconMediaObjectImage;
