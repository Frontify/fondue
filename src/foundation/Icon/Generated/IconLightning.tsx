        ...
        return (
            <span>
                {size === IconSize.Size12 && props.filled && (
                    <IconLightning12Filled {...props}/>
                )}{size === IconSize.Size12 && !props.filled && (
                    <IconLightning12 {...props}/>
                )}{size === IconSize.Size16 && props.filled && (
                    <IconLightning16Filled {...props}/>
                )}{size === IconSize.Size16 && !props.filled && (
                    <IconLightning16 {...props}/>
                )}{size === IconSize.Size20 && props.filled && (
                    <IconLightning20Filled {...props}/>
                )}{size === IconSize.Size20 && !props.filled && (
                    <IconLightning20 {...props}/>
                )}{size === IconSize.Size24 && props.filled && (
                    <IconLightning24Filled {...props}/>
                )}{size === IconSize.Size24 && !props.filled && (
                    <IconLightning24 {...props}/>
                )}{size === IconSize.Size32 && props.filled && (
                    <IconLightning32Filled {...props}/>
                )}{size === IconSize.Size32 && !props.filled && (
                    <IconLightning32 {...props}/>
                )}
            </span>
        );
    }
