...
function IconFaceExtraHappy12(props: GeneratedIconProps): React.ReactElement<GeneratedIconProps> {
    ...
    return (
        ...
        >
            <g fill="currentColor">
                <path d="M5.09 4.864a.682.682 0 1 1-1.363 0 .682.682 0 0 1 1.364 0Zm2.5.681a.682.682 0 1 0 0-1.363.682.682 0 0 0 0 1.363Z" />
                <path
                    fillRule="evenodd"
                    d="M3.746 6.943h4.488a.5.5 0 0 1 .43.755c-.63 1.064-1.526 1.596-2.688 1.596-1.165 0-2.053-.535-2.664-1.603a.5.5 0 0 1 .434-.748Zm2.23 1.6c.746 0 1.325-.27 1.785-.85h-3.55c.448.58 1.02.85 1.765.85Z"
                    clipRule="evenodd"
                />
                <path
                    fillRule="evenodd"
...
const Memo = memo(IconFaceExtraHappy12);
export default Memo;
