...
function IconRectangleLandscape24(props: GeneratedIconProps): React.ReactElement<GeneratedIconProps> {
...
export default memo(IconRectangleLandscape24);
