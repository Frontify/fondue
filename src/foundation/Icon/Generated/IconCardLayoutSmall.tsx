...
const MemoizedIconCardLayoutSmall = memo(IconCardLayoutSmall);
MemoizedIconCardLayoutSmall.displayName = 'FondueIconCardLayoutSmall';

export default MemoizedIconCardLayoutSmall;
