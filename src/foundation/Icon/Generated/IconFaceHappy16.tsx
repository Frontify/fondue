...
function IconFaceHappy16(props: GeneratedIconProps): React.ReactElement<GeneratedIconProps> {
    ...
    return (
        ...
        >
            <g fill="currentColor">
                <path d="M6.788 6.485a.91.91 0 1 1-1.818 0 .91.91 0 0 1 1.818 0Zm3.333.909a.91.91 0 1 0 0-1.818.91.91 0 0 0 0 1.818ZM4.699 8.973a.605.605 0 0 0-.271.813c.71 1.42 1.931 2.154 3.572 2.154 1.64 0 2.862-.733 3.572-2.154a.606.606 0 1 0-1.084-.542c-.502 1.004-1.3 1.483-2.488 1.483s-1.986-.479-2.488-1.483a.606.606 0 0 0-.813-.27Z" />
                <path
                    fillRule="evenodd"
