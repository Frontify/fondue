...
function IconQuestionMarkCircle20(props: GeneratedIconProps): React.ReactElement<GeneratedIconProps> {
...
export default memo(IconQuestionMarkCircle20);
