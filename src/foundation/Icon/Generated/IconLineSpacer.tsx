...
function IconLineSpacer(props: GeneratedIconProps): React.ReactElement<GeneratedIconProps> {
...
const MemoIconLineSpacer = React.memo(IconLineSpacer);
export default MemoIconLineSpacer;
