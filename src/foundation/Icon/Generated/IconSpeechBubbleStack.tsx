...
const MemoizedIconSpeechBubbleStack = memo(IconSpeechBubbleStack);
MemoizedIconSpeechBubbleStack.displayName = 'FondueIconSpeechBubbleStack';

export default MemoizedIconSpeechBubbleStack;
