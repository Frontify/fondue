    ...
    return (
        ...
        >
            <path
                fill="currentColor"
                fillRule="evenodd"
                d="M9 10.125A.125.125 0 0 0 9.125 10V8a.375.375 0 1 1 .75 0v2a.875.875 0 0 1-.875.875H3A.875.875 0 0 1 2.125 10V8a.375.375 0 1 1 .75 0v2c0 .069.056.125.125.125h6Zm0-8.25c.069 0 .125.056.125.125v2a.375.375 0 1 0 .75 0V2A.875.875 0 0 0 9 1.125H3A.875.875 0 0 0 2.125 2v2a.375.375 0 1 0 .75 0V2c0-.069.056-.125.125-.125h6Zm1 4.149a.375.375 0 0 1-.375.375h-.906a.375.375 0 0 1 0-.75h.906c.207 0 .375.167.375.375Zm-2.719 0a.375.375 0 0 1-.375.375H5.094a.375.375 0 0 1 0-.75h1.812c.207 0 .375.167.375.375Zm-3.625 0a.375.375 0 0 1-.375.375h-.906a.375.375 0 0 1 0-.75h.906c.207 0 .375.167.375.375Z"
                clipRule="evenodd"
            />
        </svg>
    );
...
const Memo = memo(IconDividerDashed12);
export default Memo;
