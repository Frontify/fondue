...
const MemoizedIconImageWithText = memo(IconImageWithText);
MemoizedIconImageWithText.displayName = 'FondueIconImageWithText';

export default MemoizedIconImageWithText;
