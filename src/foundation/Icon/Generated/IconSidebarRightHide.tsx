...
const MemoizedIconSidebarRightHide = memo(IconSidebarRightHide);
MemoizedIconSidebarRightHide.displayName = 'FondueIconSidebarRightHide';

export default MemoizedIconSidebarRightHide;
