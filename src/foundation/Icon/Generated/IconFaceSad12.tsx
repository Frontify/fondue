...
function IconFaceSad12(props: GeneratedIconProps): React.ReactElement<GeneratedIconProps> {
    ...
    return (
        ...
        >
            <g fill="currentColor">
                <path d="M5.09 4.41a.682.682 0 1 1-1.363 0 .682.682 0 0 1 1.364 0Zm2.5.68a.682.682 0 1 0 0-1.363.682.682 0 0 0 0 1.364ZM3.524 8.452a.455.455 0 0 1-.203-.61C3.853 6.777 4.769 6.227 6 6.227c1.23 0 2.147.55 2.68 1.615a.455.455 0 1 1-.814.407C7.49 7.496 6.891 7.136 6 7.136c-.89 0-1.49.36-1.866 1.113a.455.455 0 0 1-.61.203Z" />
                <path
                    fillRule="evenodd"
