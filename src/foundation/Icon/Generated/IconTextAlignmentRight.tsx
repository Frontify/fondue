...
const MemoizedIconTextAlignmentRight = memo(IconTextAlignmentRight);
MemoizedIconTextAlignmentRight.displayName = 'FondueIconTextAlignmentRight';

export default MemoizedIconTextAlignmentRight;
