...
const MemoizedIconDocumentCode = memo(IconDocumentCode);
MemoizedIconDocumentCode.displayName = 'FondueIconDocumentCode';

export default MemoizedIconDocumentCode;
