...
const MemoizedIconArrowFitBottomLeft = memo(IconArrowFitBottomLeft);
MemoizedIconArrowFitBottomLeft.displayName = 'FondueIconArrowFitBottomLeft';

export default MemoizedIconArrowFitBottomLeft;
