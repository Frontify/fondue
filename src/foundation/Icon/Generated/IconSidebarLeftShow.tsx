...
const MemoizedIconSidebarLeftShow = memo(IconSidebarLeftShow);
MemoizedIconSidebarLeftShow.displayName = 'FondueIconSidebarLeftShow';

export default MemoizedIconSidebarLeftShow;
