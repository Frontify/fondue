...
const MemoizedIconClockAlternative1 = memo(IconClockAlternative1);
MemoizedIconClockAlternative1.displayName = 'FondueIconClockAlternative1';

export default MemoizedIconClockAlternative1;
