...
const MemoizedIconArrowBottomToTop = memo(IconArrowBottomToTop);
MemoizedIconArrowBottomToTop.displayName = 'FondueIconArrowBottomToTop';

export default MemoizedIconArrowBottomToTop;
