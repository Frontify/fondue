...
function IconFaceHappy12(props: GeneratedIconProps): React.ReactElement<GeneratedIconProps> {
    ...
    return (
        ...
        >
            <g fill="currentColor">
                <path d="M5.09 4.864a.682.682 0 1 1-1.363 0 .682.682 0 0 1 1.364 0Zm2.5.681a.682.682 0 1 0 0-1.363.682.682 0 0 0 0 1.363ZM3.524 6.73a.455.455 0 0 0-.203.61C3.853 8.405 4.77 8.955 6 8.955c1.23 0 2.147-.55 2.68-1.615a.455.455 0 0 0-.814-.407C7.49 7.686 6.891 8.045 6 8.045c-.89 0-1.49-.359-1.866-1.112a.455.455 0 0 0-.61-.203Z" />
                <path
                    fillRule="evenodd"
