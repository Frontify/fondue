...
const MemoizedIconMediaObjectRatio1To3 = memo(IconMediaObjectRatio1To3);
MemoizedIconMediaObjectRatio1To3.displayName = 'FondueIconMediaObjectRatio1To3';

export default MemoizedIconMediaObjectRatio1To3;
