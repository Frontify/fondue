...
const MemoizedIconDocumentArrowRight = memo(IconDocumentArrowRight);
MemoizedIconDocumentArrowRight.displayName = 'FondueIconDocumentArrowRight';

export default MemoizedIconDocumentArrowRight;
