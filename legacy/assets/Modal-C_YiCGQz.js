import{r as m,j as i}from"./iframe-DdaLCHUc.js";import{b as W,$ as C,a as F}from"./useDialog-Dz35zY-Q.js";import{$ as A}from"./FocusScope-Cf4uSUpw.js";import{a as V}from"./useOverlayTriggerState-ClyVhkHP.js";import{b as P}from"./chain-Co2ZCjzx.js";import{$ as O}from"./useEffectEvent-DnDWDQ4U.js";import{$ as M,b as k}from"./keyboard-B5m0G2nG.js";import{u as G}from"./useFocusRing-BESbWJEl.js";import{m as w}from"./merge-DI-veSMP.js";import{S as _}from"./ScrollWrapper-3RcWCjXb.js";import{B as U,e as X}from"./Button-LQA4uMwY.js";import{I as K}from"./IconSize-BcCrF_mi.js";import{F as Y,P as Z,b as J,p as Q}from"./FrontifyPattern-ClbuPRRq.js";import{A as ee}from"./index-D8AYIqMa.js";import{m as L}from"./proxy-BCGWzsA_.js";function j(e,t){let a=e;for(M(a,t)&&(a=a.parentElement);a&&!M(a,t);)a=a.parentElement;return a||document.scrollingElement||document.documentElement}const y=typeof document<"u"&&window.visualViewport;let h=0,E;function te(e={}){let{isDisabled:t}=e;O(()=>{if(!t)return h++,h===1&&(G()?E=ne():E=ae()),()=>{h--,h===0&&E()}},[t])}function ae(){let e=window.innerWidth-document.documentElement.clientWidth;return P(e>0&&("scrollbarGutter"in document.documentElement.style?q(document.documentElement,"scrollbarGutter","stable"):q(document.documentElement,"paddingRight",`${e}px`)),q(document.documentElement,"overflow","hidden"))}function ne(){let e,t=!1,a=r=>{let o=r.target;e=M(o)?o:j(o,!0),t=!1;let u=o.ownerDocument.defaultView.getSelection();u&&!u.isCollapsed&&u.containsNode(o,!0)&&(t=!0),"selectionStart"in o&&"selectionEnd"in o&&o.selectionStart<o.selectionEnd&&o.ownerDocument.activeElement===o&&(t=!0)},n=document.createElement("style");n.textContent=`
@layer {
  * {
