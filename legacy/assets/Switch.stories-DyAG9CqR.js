import{r as c,j as P}from"./iframe-Lx3fyMem.js";import{T as I}from"./TooltipIcon-ps-0n-ya.js";import{I as _}from"./LegacyTooltip-BKLxuPOW.js";import{S as z}from"./Switch-Dl0K0Py9.js";import"./preload-helper-C1FmrZbK.js";import"./IconQuestionMarkCircle-Bivy8uKw.js";import"./IconSize-BcCrF_mi.js";import"./focusStyle-Ch_WJ4aJ.js";import"./merge-DI-veSMP.js";import"./useLink-BPyXKjtr.js";import"./useFocusable-BdWoFksO.js";import"./useFocusRing-CiEMWpN8.js";import"./useEffectEvent-CZMgj56A.js";import"./chain-DlM-WH6Z.js";import"./index-B3Qgt-lS.js";import"./usePopper-Bihzf9VH.js";import"./index-DqcmmWsV.js";import"./Button-BzXDiA4y.js";import"./useButton-CGHLoVvN.js";import"./Portal-DJmtadYa.js";import"./useMemoizedId-DQZ_sCPh.js";import"./IconCheckMark-BqM_w58-.js";import"./IconExclamationMarkCircle24-DDTJ82xZ.js";import"./IconExclamationMarkTriangle-NkEknEiV.js";import"./IconExclamationMarkTriangle24-COrLupZ7.js";import"./InputLabel-CBUy_XX1.js";const H=["small","medium"],k=["on","off","indeterminate"],q=["default","heading"],ce={title:"Components/Switch",component:z,tags:["autodocs"],argTypes:{size:{options:H,control:{type:"radio"}},labelStyle:{options:q,control:{type:"radio"}},label:{placeholder:"Switch label",type:{name:"string",required:!1},control:{type:"text"}},mode:{options:k,control:{type:"radio"}},onChange:{table:{disable:!1},action:"Change"}},args:{mode:"on",disabled:!1,labelStyle:"default",hug:!1,name:"switch-name",size:"small"},parameters:{status:{type:"deprecated"},docs:{description:{component:"### This component is deprecated, please use the [new Switch component](/docs/current_components-switch--documentation) instead."}}}},o=e=>{const[d,m]=c.useState(e.mode||"off");c.useEffect(()=>{e.mode&&m(e.mode)},[e.mode]);const j=A=>{m(d==="on"?"off":"on"),e.onChange&&e.onChange(A)};return P.jsx(z,{...e,onChange:j,mode:d})},t=o.bind({});t.args={size:"small"};const n=o.bind({});n.args={size:"medium"};const s=o.bind({});s.args={label:"Switch label"};const r=o.bind({});r.args={label:"Switch label",tooltip:{content:"Switch tooltip"}};const a=o.bind({});a.args={label:"Switch label",tooltip:[{content:"First tooltip"},{content:"Second Tooltip",triggerIcon:P.jsx(_,{}),triggerStyle:I.Warning}]};const i=o.bind({});i.args={hug:!0,label:"Switch label"};var g,l,p;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:`(args: Props) => {
