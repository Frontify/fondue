import{j as i}from"./jsx-runtime-DF2Pcvd1.js";import{a as W,b as C,c as F}from"./useDialog-CIZ0-wxX.js";import{a as A}from"./FocusScope-BWgBfqGF.js";import{a as V}from"./useOverlayTriggerState-BgjoQp14.js";import{a as P}from"./chain-z5L_5vtA.js";import{$ as O}from"./useEffectEvent-BOE4tD14.js";import{$ as M,a as k}from"./keyboard-APSnmnkX.js";import{q as G}from"./useFocusRing-BMciCUIT.js";import{r as m}from"./index-B2-qRKKC.js";import{m as w}from"./merge-DI-veSMP.js";import{a as _}from"./ScrollWrapper-DzW8ABe3.js";import{c as U,B as X}from"./Button-BmAjlSjh.js";import{I as K}from"./IconSize-BcCrF_mi.js";import{F as Y,P as Z,b as J,p as Q}from"./FrontifyPattern-5PG0oenB.js";import{A as ee}from"./index-C8Y7mxzH.js";import{m as L}from"./proxy-B63y3FxE.js";function j(e,t){let a=e;for(M(a,t)&&(a=a.parentElement);a&&!M(a,t);)a=a.parentElement;return a||document.scrollingElement||document.documentElement}const y=typeof document<"u"&&window.visualViewport;let h=0,q;function te(e={}){let{isDisabled:t}=e;O(()=>{if(!t)return h++,h===1&&(G()?q=ne():q=ae()),()=>{h--,h===0&&q()}},[t])}function ae(){let e=window.innerWidth-document.documentElement.clientWidth;return P(e>0&&("scrollbarGutter"in document.documentElement.style?E(document.documentElement,"scrollbarGutter","stable"):E(document.documentElement,"paddingRight",`${e}px`)),E(document.documentElement,"overflow","hidden"))}function ne(){let e,t=!1,a=r=>{let o=r.target;e=M(o)?o:j(o,!0),t=!1;let u=o.ownerDocument.defaultView.getSelection();u&&!u.isCollapsed&&u.containsNode(o,!0)&&(t=!0),"selectionStart"in o&&"selectionEnd"in o&&o.selectionStart<o.selectionEnd&&o.ownerDocument.activeElement===o&&(t=!0)},n=document.createElement("style");n.textContent=`
@layer {
  * {
