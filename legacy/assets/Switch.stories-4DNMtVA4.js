import{r as c,j as P}from"./iframe-CVCmaElJ.js";import{T as I}from"./TooltipIcon-C2KZ48Gy.js";import{I as _}from"./LegacyTooltip-Dltc1CIc.js";import{S as z}from"./Switch-DPafk-U6.js";import"./preload-helper-C1FmrZbK.js";import"./IconQuestionMarkCircle-DAYxoVwf.js";import"./IconSize-BcCrF_mi.js";import"./focusStyle-Ch_WJ4aJ.js";import"./merge-DI-veSMP.js";import"./useLink-cZXDHnU-.js";import"./useFocusable-DA3044bw.js";import"./useFocusRing-C1bjenSz.js";import"./useEffectEvent-RCnZCbUp.js";import"./chain-gSz1IcKJ.js";import"./index-BiG_-6RV.js";import"./usePopper-B4KYEDCk.js";import"./index-B1SWNDVV.js";import"./Button-D2G-tVxk.js";import"./useButton-DBnkCyXV.js";import"./Portal-BUS0CIYb.js";import"./useMemoizedId-BtpWxv9J.js";import"./IconCheckMark-DgOstlMS.js";import"./IconExclamationMarkCircle24-CoeDw1Gy.js";import"./IconExclamationMarkTriangle-D8xz_Yug.js";import"./IconExclamationMarkTriangle24-IE-yhapB.js";import"./InputLabel-CIqbqboC.js";const H=["small","medium"],k=["on","off","indeterminate"],q=["default","heading"],ce={title:"Components/Switch",component:z,tags:["autodocs"],argTypes:{size:{options:H,control:{type:"radio"}},labelStyle:{options:q,control:{type:"radio"}},label:{placeholder:"Switch label",type:{name:"string",required:!1},control:{type:"text"}},mode:{options:k,control:{type:"radio"}},onChange:{table:{disable:!1},action:"Change"}},args:{mode:"on",disabled:!1,labelStyle:"default",hug:!1,name:"switch-name",size:"small"},parameters:{status:{type:"deprecated"},docs:{description:{component:"### This component is deprecated, please use the [new Switch component](/docs/current_components-switch--documentation) instead."}}}},o=e=>{const[d,m]=c.useState(e.mode||"off");c.useEffect(()=>{e.mode&&m(e.mode)},[e.mode]);const j=A=>{m(d==="on"?"off":"on"),e.onChange&&e.onChange(A)};return P.jsx(z,{...e,onChange:j,mode:d})},t=o.bind({});t.args={size:"small"};const n=o.bind({});n.args={size:"medium"};const s=o.bind({});s.args={label:"Switch label"};const r=o.bind({});r.args={label:"Switch label",tooltip:{content:"Switch tooltip"}};const a=o.bind({});a.args={label:"Switch label",tooltip:[{content:"First tooltip"},{content:"Second Tooltip",triggerIcon:P.jsx(_,{}),triggerStyle:I.Warning}]};const i=o.bind({});i.args={hug:!0,label:"Switch label"};var g,l,p;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:`(args: Props) => {
