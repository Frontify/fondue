import{j as e}from"./jsx-runtime-Nms4Y4qS.js";import{r as c}from"./index-BwDkhjyp.js";import{B as H,a as M,b as A}from"./Badge-D-eWKloI.js";import{B as w}from"./Button-DqlvyMV-.js";import{F as g}from"./FormControl-DczuTmTS.js";import{S as K}from"./SegmentedControls-EyNzYqVo.js";import{I as U}from"./IconCalendar-C4r3yC4l.js";import{V as _}from"./validation-C9S5KgfE.js";import{D as m,s as f,a as z}from"./DatePicker-GzrCNsyz.js";import"./_commonjsHelpers-BosuxZz1.js";import"./IconCross-Bt-I3opn.js";import"./IconSize-BcCrF_mi.js";import"./focusStyle-CBFElZiz.js";import"./merge-DI-veSMP.js";import"./colors-cqDZVL9s.js";import"./useButton-DFNFXdnN.js";import"./useFocusable-wKuCPQI4.js";import"./useFocusRing-Vzyl7-Lk.js";import"./SSRProvider-CYXx33DY.js";import"./chain-D5h1pgIF.js";import"./InputLabel-BhyWxXNA.js";import"./TooltipIcon-DJnGWxbA.js";import"./LegacyTooltip-5QAr2ROW.js";import"./useLink-Bd1Qu62S.js";import"./usePopper-DPXU-o95.js";import"./index-DxjWwZXO.js";import"./index-CfyPTyT-.js";import"./Portal-0C9N3MSP.js";import"./useMemoizedId-EtHZ7Sxa.js";import"./IconCheckMark-CLvJH1sB.js";import"./IconExclamationMarkCircle-Cob4vb5T.js";import"./IconExclamationMarkCircle24-DpwtNT9z.js";import"./IconExclamationMarkTriangle-CRTWkDyu.js";import"./IconExclamationMarkTriangle24-GqPjgFpk.js";import"./IconQuestionMarkCircle-C_agVHg1.js";import"./useFormValidationState-Bo5Bz1o-.js";import"./FocusScope-DegwnO3I.js";import"./useField-DuYpSm4Z.js";import"./useLabels-DH9bA-v0.js";import"./context-C2PaECDE.js";import"./VisuallyHidden-BM0TqGgS.js";import"./useControlledState-C0C-dzuH.js";import"./motion-C48bHxkn.js";import"./floating-ui.react-dom-CbGxnGIJ.js";import"./IconCaretRight-CxmZKZHS.js";import"./TextInput-C-6f_S1r.js";import"./LoadingCircle-CZrma5le.js";import"./IconEyeOff-Dzh4tjis.js";import"./IconCaretDown-Cxrx1sF_.js";import"./IconCaretDown16-BGp5IVAI.js";import"./IconCaretUp-BvepHPo7.js";const ze={title:"Components/DatePicker",component:m,tags:["autodocs"],args:{dateFormat:"MMM dd, yyyy"},argTypes:{validation:{options:Object.values(_),control:{type:"select"}}}},h=a=>{const[o,t]=c.useState();return e.jsx(m,{...a,variant:"single",startDate:null,endDate:null,value:o,onChange:s=>t(s)})},V=a=>{const[o,t]=c.useState();return e.jsxs("div",{className:"tw-flex tw-flex-col",children:[e.jsxs("div",{className:"tw-flex tw-flex-row tw-justify-between",children:[e.jsx("div",{className:"tw-px-5 tw-py-3 tw-flex tw-flex-col tw-gap-3",children:e.jsx(g,{children:e.jsx(m,{...a,variant:"single",startDate:null,endDate:null,value:o,onChange:s=>t(s)})})}),e.jsx("div",{className:"tw-px-5 tw-py-3 tw-flex tw-flex-col tw-gap-3",children:e.jsx(g,{children:e.jsx(m,{...a,variant:"single",startDate:null,endDate:null,value:o,onChange:s=>t(s)})})})]}),e.jsx("div",{className:"tw-px-5 tw-py-3 tw-flex tw-flex-col tw-gap-3",children:e.jsx(g,{children:e.jsx(K,{activeItemId:"a",items:[{id:"a",value:"abc"},{id:"b",value:"def"},{id:"c",value:"ghi"}],onChange:()=>{}})})})]})},n=h.bind({});n.args={placeHolder:"Select a date",isClearable:!0,shouldCloseOnSelect:!0};n.storyName="Date Picker";const l=h.bind({});l.args={placeHolder:"Select a date",isClearable:!0,shouldCloseOnSelect:!0,customHeader:e.jsxs("div",{className:"tw-flex tw-gap-2 tw-grow",children:[e.jsx(w,{hugWidth:!1,children:"30d"}),e.jsx(w,{hugWidth:!1,children:"90d"}),e.jsx(w,{hugWidth:!1,children:"365d"})]})};l.storyName="Date Picker with custom header";const i=h.bind({});i.args={placeHolder:"Select a date",isClearable:!0,shouldCloseOnSelect:!0,minDate:f(new Date,5),maxDate:z(new Date,5)};const d=V.bind({});d.args={placeHolder:"Select a date",isClearable:!0,shouldCloseOnSelect:!0};const x={day:"numeric",month:"short",year:"numeric"},q=()=>{const[a,o]=c.useState(f(new Date,40)),[t,s]=c.useState(new Date),E=r=>{if(!r)return;const[u,W]=r;o(u),s(W)},D=c.useRef(null);return e.jsx(m,{value:t,startDate:a,endDate:t,onChange:E,onOpen:()=>{var r;(r=D.current)==null||r.setPreSelection(new Date)},onClose:()=>console.log("close"),onBlur:()=>console.log("blur"),minDate:f(new Date,40),maxDate:new Date,variant:"range",ref:D,onKeyDown:r=>{var u;r.code==="Tab"&&r.shiftKey&&((u=D.current)==null||u.setOpen(!1))},preventOpenOnFocus:!0,customTrigger:e.jsxs("button",{className:"tw-flex tw-items-center hover:tw-bg-box-neutral-hover tw-py-2 tw-px-4 tw-rounded tw-gap-2",children:[e.jsx(U,{}),"Date:",e.jsxs(H,{style:M.Progress,emphasis:A.Strong,size:"small",children:[new Intl.DateTimeFormat("en-US",x).format(a||new Date)," -"," ",new Intl.DateTimeFormat("en-US",x).format(t||new Date)]})]}),hasPopperArrow:!1,children:a&&t&&e.jsxs("div",{children:[e.jsx("div",{className:"tw-border-t tw-w-full tw-border-solid tw-border-line"}),e.jsx("div",{className:"tw-p-2",children:e.jsx("button",{className:`tw-bg-button-background tw-border-button-border tw-w-full
