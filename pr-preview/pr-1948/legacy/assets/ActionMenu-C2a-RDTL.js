import{j as m}from"./jsx-runtime-Nms4Y4qS.js";import{c as U,b as F,d as le,$ as ue,h as de,e as ce}from"./useFocusable-wKuCPQI4.js";import{$ as me,c as ve,a as pe,d as Te,g as Me,e as ye,m as fe,f as Ee}from"./helper-Ccf_fa6I.js";import{$ as ge,a as be,b as he}from"./SelectionManager-C_gdLktp.js";import{r as v}from"./index-BwDkhjyp.js";import{$ as ke}from"./useControlledState-C0C-dzuH.js";import{m as W}from"./merge-DI-veSMP.js";import{e as we,f as Le,$ as He}from"./useFocusRing-Vzyl7-Lk.js";import{b as P,$ as xe}from"./chain-D5h1pgIF.js";import{b as Ae}from"./MenuItem-Br_a5P6Q.js";import{S as qe}from"./Switch-O77c4Oge.js";import{d as $e}from"./focusStyle-CBFElZiz.js";const Y=new WeakMap;function Be(e,n,t){let{shouldFocusWrap:r=!0,onKeyDown:o,onKeyUp:i,...a}=e;!e["aria-label"]&&!e["aria-labelledby"]&&console.warn("An aria-label or aria-labelledby prop is required for accessibility.");let l=U(e,{labelable:!0}),{listProps:u}=me({...a,ref:t,selectionManager:n.selectionManager,collection:n.collection,disabledKeys:n.disabledKeys,shouldFocusWrap:r,linkBehavior:"override"});return Y.set(n,{onClose:e.onClose,onAction:e.onAction}),{menuProps:F(l,{onKeyDown:o,onKeyUp:i},{role:"menu",...u,onKeyDown:d=>{d.key!=="Escape"&&u.onKeyDown(d)}})}}function Se(e,n,t){let{id:r,key:o,closeOnSelect:i,isVirtualized:a,"aria-haspopup":l,onPressStart:u,onPressUp:d,onPress:y,onPressChange:h,onPressEnd:f,onHoverStart:T,onHoverChange:k,onHoverEnd:M,onKeyDown:E,onKeyUp:H,onFocus:x,onFocusChange:A,onBlur:J}=e,p=!!l;var q;let g=(q=e.isDisabled)!==null&&q!==void 0?q:n.selectionManager.isDisabled(o);var $;let N=($=e.isSelected)!==null&&$!==void 0?$:n.selectionManager.isSelected(o),B=Y.get(n),c=n.collection.getItem(o),b=e.onClose||B.onClose,Q=le(),j=s=>{var I;if(!p){if(!(c==null||(I=c.props)===null||I===void 0)&&I.onAction&&c.props.onAction(),B.onAction){let ie=B.onAction;ie(o)}s.target instanceof HTMLAnchorElement&&Q.open(s.target,s,c.props.href,c.props.routerOptions)}},S="menuitem";p||(n.selectionManager.selectionMode==="single"?S="menuitemradio":n.selectionManager.selectionMode==="multiple"&&(S="menuitemcheckbox"));let z=P(),V=P(),D=P(),w={id:r,"aria-disabled":g||void 0,role:S,"aria-label":e["aria-label"],"aria-labelledby":z,"aria-describedby":[V,D].filter(Boolean).join(" ")||void 0,"aria-controls":e["aria-controls"],"aria-haspopup":l,"aria-expanded":e["aria-expanded"]};n.selectionManager.selectionMode!=="none"&&!p&&(w["aria-checked"]=N),a&&(w["aria-posinset"]=c==null?void 0:c.index,w["aria-setsize"]=ve(n.collection));let X=s=>{s.pointerType==="keyboard"&&j(s),u==null||u(s)},Z=s=>{s.pointerType!=="keyboard"&&(j(s),!p&&b&&(i??(n.selectionManager.selectionMode!=="multiple"||n.selectionManager.isLink(o)))&&b()),d==null||d(s)},{itemProps:L,isFocused:ee}=pe({selectionManager:n.selectionManager,key:o,ref:t,shouldSelectOnPressUp:!0,allowsDifferentPressOrigin:!0,linkBehavior:"none"}),{pressProps:ne,isPressed:te}=ue({onPressStart:X,onPress:y,onPressUp:Z,onPressChange:h,onPressEnd:f,isDisabled:g}),{hoverProps:oe}=Te({isDisabled:g,onHoverStart(s){we()||(n.selectionManager.setFocused(!0),n.selectionManager.setFocusedKey(o)),T==null||T(s)},onHoverChange:k,onHoverEnd:M}),{keyboardProps:ae}=de({onKeyDown:s=>{if(s.repeat){s.continuePropagation();return}switch(s.key){case" ":!g&&n.selectionManager.selectionMode==="none"&&!p&&i!==!1&&b&&b();break;case"Enter":!g&&i!==!1&&!p&&b&&b();break;default:p||s.continuePropagation(),E==null||E(s);break}},onKeyUp:H}),{focusProps:re}=Le({onBlur:J,onFocus:x,onFocusChange:A}),_=U(c.props);delete _.id;let se=ce(c.props);return{menuItemProps:{...w,...F(_,se,p?{onFocus:L.onFocus,"data-key":L["data-key"]}:L,ne,oe,ae,re),tabIndex:L.tabIndex!=null?-1:void 0},labelProps:{id:z},descriptionProps:{id:V},keyboardShortcutProps:{id:D},isFocused:ee,isSelected:N,isPressed:te,isDisabled:g}}function Ie(e){let{heading:n,"aria-label":t}=e,r=xe();return{itemProps:{role:"presentation"},headingProps:n?{id:r,role:"presentation"}:{},groupProps:{role:"group","aria-label":t,"aria-labelledby":n?r:void 0}}}class Pe{*[Symbol.iterator](){yield*this.iterable}get size(){return this.keyMap.size}getKeys(){return this.keyMap.keys()}getKeyBefore(n){let t=this.keyMap.get(n);return t?t.prevKey:null}getKeyAfter(n){let t=this.keyMap.get(n);return t?t.nextKey:null}getFirstKey(){return this.firstKey}getLastKey(){return this.lastKey}getItem(n){return this.keyMap.get(n)}at(n){const t=[...this.getKeys()];return this.getItem(t[n])}constructor(n,{expandedKeys:t}={}){this.keyMap=new Map,this.iterable=n,t=t||new Set;let r=a=>{if(this.keyMap.set(a.key,a),a.childNodes&&(a.type==="section"||t.has(a.key)))for(let l of a.childNodes)r(l)};for(let a of n)r(a);let o,i=0;for(let[a,l]of this.keyMap)o?(o.nextKey=a,l.prevKey=o.key):(this.firstKey=a,l.prevKey=void 0),l.type==="item"&&(l.index=i++),o=l,o.nextKey=void 0;this.lastKey=o==null?void 0:o.key}}function Ce(e){let{onExpandedChange:n}=e,[t,r]=ke(e.expandedKeys?new Set(e.expandedKeys):void 0,e.defaultExpandedKeys?new Set(e.defaultExpandedKeys):new Set,n),o=ge(e),i=v.useMemo(()=>e.disabledKeys?new Set(e.disabledKeys):new Set,[e.disabledKeys]),a=be(e,v.useCallback(u=>new Pe(u,{expandedKeys:t}),[t]),null);return v.useEffect(()=>{o.focusedKey!=null&&!a.getItem(o.focusedKey)&&o.setFocusedKey(null)},[a,o.focusedKey]),{collection:a,expandedKeys:t,disabledKeys:i,toggleKey:u=>{r(Fe(t,u))},setExpandedKeys:r,selectionManager:new he(a,o)}}function Fe(e,n){let t=new Set(e);return t.has(n)?t.delete(n):t.add(n),t}const K=v.forwardRef(({ariaProps:e,children:n,scrollable:t=!1,border:r=!0},o)=>m.jsx("ul",{...e,ref:o,className:W(["tw-list-none tw-p-0 tw-m-0 tw-bg-base tw-z-20 focus-visible:tw-outline-none",r&&"tw-border tw-border-line tw-rounded",t&&"tw-overflow-y-auto"]),children:n}));K.displayName="FondueAriaList";K.__docgenInfo={description:"",methods:[],displayName:"FondueAriaList",props:{scrollable:{defaultValue:{value:"false",computed:!1},required:!1},border:{defaultValue:{value:"true",computed:!1},required:!1}}};const Ke=e=>typeof e.onClick<"u"&&typeof e.type>"u",C=e=>typeof e.onClick<"u"&&e.type==="switch",Oe=(e,n)=>{const[t,r]=v.useState(n??!1),[o,i]=v.useState({switchComponent:void 0,switchValue:null,toggleSwitch:null});return v.useEffect(()=>{if(e){const a=()=>r(!t);i({switchComponent:m.jsx(qe,{size:"small",mode:t?"on":"off"}),switchValue:t,toggleSwitch:a})}},[e,t]),o},O=({menuItem:e,node:n,state:t,isSelected:r,onClick:o})=>{const i=v.useRef(null),a=C(e)?e.initialValue:!1,{switchComponent:l=void 0,switchValue:u=null,toggleSwitch:d=null}=Oe(C(e),a),{menuItemProps:y}=Se({...n,onAction:()=>{Ke(e)&&e.onClick(),C(e)&&(d==null||d(),e.onClick(!u))},isDisabled:(e==null?void 0:e.disabled)||!1,"aria-label":typeof(e==null?void 0:e.title)=="string"?e==null?void 0:e.title:"Menu item"},t,i),{title:h,decorator:f,subtitle:T,size:k,style:M,disabled:E,selectionIndicator:H}=e,{isFocusVisible:x,focusProps:A}=He();return m.jsx("li",{...F(y,A,{onClick:()=>o==null?void 0:o()}),"data-test-id":"menu-item",className:W(["tw-relative hover:tw-bg-box-neutral-hover tw-list-none tw-outline-none",E&&"tw-pointer-events-none tw-top-px",x&&$e]),ref:i,children:m.jsx(Ae,{title:h,decorator:f,subtitle:T,size:k,style:M,disabled:E,active:r,selectionIndicator:H,switchComponent:l})})};O.displayName="FondueAriaMenuItem";O.__docgenInfo={description:"",methods:[],displayName:"FondueAriaMenuItem",props:{menuItem:{required:!0,tsType:{name:"union",raw:"MenuItemType | ActionMenuItemType | ActionMenuSwitchItemType",elements:[{name:"intersection",raw:"Omit<MenuItemProps, 'switchComponent'> & { id: string | number; link?: string }",elements:[{name:"Omit",elements:[{name:"intersection",raw:`{
    style?: MenuItemStyle;
    disabled?: boolean;
    active?: boolean;
    checked?: boolean;
