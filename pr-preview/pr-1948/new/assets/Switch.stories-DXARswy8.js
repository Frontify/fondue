import{j as e}from"./jsx-runtime-Nms4Y4qS.js";import{r as i}from"./index-BwDkhjyp.js";import{b as de}from"./fondue-icons324-_g5P3FDE.js";import{L as te}from"./Label-DGO3QOB6.js";import{T as j}from"./Tooltip-CUDe_PiA.js";import{c as ue}from"./index-DOnKqARA.js";import{u as me,P as ae}from"./index-Brw_kfkv.js";import{c as pe}from"./index-BWD2N0gV.js";import{u as he}from"./index-DGaPG0k3.js";import{u as fe}from"./index-BgCrdp81.js";import{u as ge}from"./index-kUwV4muI.js";import{c as be}from"./styleUtilities-BnElyh0X.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-DDjXImfa.js";import"./index-DxjWwZXO.js";import"./index-DduqEaLY.js";import"./index-BwIM2_zL.js";var _="Switch",[we,Xe]=pe(_),[ve,Se]=we(_),re=i.forwardRef((t,n)=>{const{__scopeSwitch:a,name:r,checked:s,defaultChecked:d,required:l,disabled:c,value:m="on",onCheckedChange:x,...q}=t,[u,y]=i.useState(null),ce=me(n,h=>y(h)),C=i.useRef(!1),L=u?!!u.closest("form"):!0,[p=!1,ie]=he({prop:s,defaultProp:d,onChange:x});return e.jsxs(ve,{scope:a,checked:p,disabled:c,children:[e.jsx(ae.button,{type:"button",role:"switch","aria-checked":p,"aria-required":l,"data-state":oe(p),"data-disabled":c?"":void 0,disabled:c,value:m,...q,ref:ce,onClick:ue(t.onClick,h=>{ie(le=>!le),L&&(C.current=h.isPropagationStopped(),C.current||h.stopPropagation())})}),L&&e.jsx(Te,{control:u,bubbles:!C.current,name:r,value:m,checked:p,required:l,disabled:c,style:{transform:"translateX(-100%)"}})]})});re.displayName=_;var se="SwitchThumb",ne=i.forwardRef((t,n)=>{const{__scopeSwitch:a,...r}=t,s=Se(se,a);return e.jsx(ae.span,{"data-state":oe(s.checked),"data-disabled":s.disabled?"":void 0,...r,ref:n})});ne.displayName=se;var Te=t=>{const{control:n,checked:a,bubbles:r=!0,...s}=t,d=i.useRef(null),l=fe(a),c=ge(n);return i.useEffect(()=>{const m=d.current,x=window.HTMLInputElement.prototype,u=Object.getOwnPropertyDescriptor(x,"checked").set;if(l!==a&&u){const y=new Event("click",{bubbles:r});u.call(m,a),m.dispatchEvent(y)}},[l,a,r]),e.jsx("input",{type:"checkbox","aria-hidden":!0,defaultChecked:a,...s,tabIndex:-1,ref:d,style:{...t.style,...c,position:"absolute",pointerEvents:"none",opacity:0,margin:0}})};function oe(t){return t?"checked":"unchecked"}var ke=re,xe=ne;const ye="_root_wthne_5",Ce="_small_wthne_28",je="_medium_wthne_32",Ee="_large_wthne_36",_e="_thumb_wthne_50",E={root:ye,small:Ce,medium:je,large:Ee,thumb:_e},qe=({value:t,defaultValue:n,size:a="medium",onChange:r,"data-test-id":s="fondue-switch","aria-label":d="Switch",...l},c)=>e.jsx(ke,{ref:c,checked:t,defaultChecked:n,className:be([E.root,E[a]]),onCheckedChange:r,"aria-label":d,"data-test-id":s,...l,children:e.jsx(xe,{className:E.thumb})}),o=i.forwardRef(qe);o.displayName="Switch";o.__docgenInfo={description:"",methods:[],displayName:"Switch",props:{id:{required:!1,tsType:{name:"string"},description:""},name:{required:!1,tsType:{name:"string"},description:""},size:{required:!1,tsType:{name:"union",raw:"'small' | 'medium' | 'large'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'medium'"},{name:"literal",value:"'large'"}]},description:`The size of the switch component.
