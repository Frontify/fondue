...
`,...(O=(D=r.parameters)==null?void 0:D.docs)==null?void 0:O.source}}};var L,V,k;o.parameters={...o.parameters,docs:{...(L=o.parameters)==null?void 0:L.docs,source:{code:`const WithDecorator = () => {
  return (
    <Select aria-label="Select an item" placeholder="Select an item">
...
`,...(k=(V=o.parameters)==null?void 0:V.docs)==null?void 0:k.source}}};var M,_,R;S.parameters={...S.parameters,docs:{...(M=S.parameters)==null?void 0:M.docs,source:{code:`const Clearable = () => {
  return (
    <Select aria-label="Select an item" placeholder="Select an item">
      <Select.Slot name="right">
        <IconIcon size={16} />
...
`,...(R=(_=S.parameters)==null?void 0:_.docs)==null?void 0:R.source}}};var q,J,K;i.parameters={...i.parameters,docs:{...(q=i.parameters)==null?void 0:q.docs,source:{code:`const CustomClearElement = () => {
  return (
    <Select aria-label="Select an item" placeholder="Select an item">
      <Select.Slot name="clear">
...
`,...(K=(J=i.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};var Q,U,X;u.parameters={...u.parameters,docs:{...(Q=u.parameters)==null?void 0:Q.docs,source:{code:`const DefaultItem = () => {
  return (
    <Select
      aria-label="Select an item"
      placeholder="Select an item"
...
`,...(X=(U=u.parameters)==null?void 0:U.docs)==null?void 0:X.source}}};var Y,Z,$;I.parameters={...I.parameters,docs:{...(Y=I.parameters)==null?void 0:Y.docs,source:{code:`const ItemGroups = () => {
  return (
    <Select aria-label="Select an item" placeholder="Select an item">
      <Select.Slot name="menu">
        <Select.Item value="test1">Test1</Select.Item>
...
`,...($=(Z=I.parameters)==null?void 0:Z.docs)==null?void 0:$.source}}};var ee,te,le;d.parameters={...d.parameters,docs:{...(ee=d.parameters)==null?void 0:ee.docs,source:{code:`const ItemGroupsWithHeaders = () => {
  return (
    <Select aria-label="Select an item" placeholder="Select an item">
      <Select.Slot name="menu">
        <Select.Item value="test1">Test1</Select.Item>
...
`,...(le=(te=d.parameters)==null?void 0:te.docs)==null?void 0:le.source}}};var se,ce,ae;v.parameters={...v.parameters,docs:{...(se=v.parameters)==null?void 0:se.docs,source:{code:`const OnlyItemGroups = () => {
  return (
    <Select aria-label="Select an item" placeholder="Select an item">
      <Select.Slot name="menu">
        <Select.Group groupId="Group 1">
...
`,...(ae=(ce=v.parameters)==null?void 0:ce.docs)==null?void 0:ae.source}}};var ne,re,me;p.parameters={...p.parameters,docs:{...(ne=p.parameters)==null?void 0:ne.docs,source:{code:`const CustomItem = () => {
  return (
    <Select aria-label="Select an item" placeholder="Select an item">
      <Select.Slot name="menu">
...
`,...(me=(re=p.parameters)==null?void 0:re.docs)==null?void 0:me.source}}};var oe,Se,ie;h.parameters={...h.parameters,docs:{...(oe=h.parameters)==null?void 0:oe.docs,source:{code:`const CustomItemIncludingSelectField = () => {
  return (
    <Select
      aria-label="Select an item"
      placeholder="Select an item"
...
`,...(ie=(Se=h.parameters)==null?void 0:Se.docs)==null?void 0:ie.source}}};var ue,Ie,de;T.parameters={...T.parameters,docs:{...(ue=T.parameters)==null?void 0:ue.docs,source:{code:`const ExternallyControlled = () => {
...
`,...(de=(Ie=T.parameters)==null?void 0:Ie.docs)==null?void 0:de.source}}};var ve,pe,he;x.parameters={...x.parameters,docs:{...(ve=x.parameters)==null?void 0:ve.docs,source:{code:`const OverflowingText = () => {
  return (
...
`,...(he=(pe=x.parameters)==null?void 0:pe.docs)==null?void 0:he.source}}};var Te,xe,ge;g.parameters={...g.parameters,docs:{...(Te=g.parameters)==null?void 0:Te.docs,source:{code:`const ListOverflow = () => {
  return (
    <>
      <Select aria-label="Select an item" placeholder="Select an item">
        <Select.Item value="test1">Test1</Select.Item>
...
`,...(ge=(xe=g.parameters)==null?void 0:xe.docs)==null?void 0:ge.source}}};var je,be,we;j.parameters={...j.parameters,docs:{...(je=j.parameters)==null?void 0:je.docs,source:{code:`const Success = () => {
  return (
    <Select
      aria-label="Select an item"
      placeholder="Select an item"
...
`,...(we=(be=j.parameters)==null?void 0:be.docs)==null?void 0:we.source}}};var fe,Ce,ye;b.parameters={...b.parameters,docs:{...(fe=b.parameters)==null?void 0:fe.docs,source:{code:`const Errored = () => {
  return (
    <Select.Combobox
      aria-label="Select an item"
      placeholder="Select an item"
...
`,...(ye=(Ce=b.parameters)==null?void 0:Ce.docs)==null?void 0:ye.source}}};var Ge,ze,Be;m.parameters={...m.parameters,docs:{...(Ge=m.parameters)==null?void 0:Ge.docs,source:{code:`const WithPlaceholder = () => {
  return (
    <Select aria-label="Select an item" placeholder="Select an item">
      <Select.Slot name="menu">
        <Select.Item value="test1">Test1</Select.Item>
...
`,...(Be=(ze=m.parameters)==null?void 0:ze.docs)==null?void 0:Be.source}}};var Ae,We,Fe;c.parameters={...c.parameters,docs:{...(Ae=c.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
  name: 'Select',
  render: args => {
    return <Select {...args}>
                <Select.Item value="test1">Test1</Select.Item>
