import{j as i}from"./jsx-runtime-DF2Pcvd1.js";import{a as W,b as C,c as F}from"./useDialog-DHPMxsmW.js";import{a as A}from"./FocusScope-B39fRxFN.js";import{a as V}from"./useOverlayTriggerState-DyEqI0jj.js";import{a as P}from"./chain-DrsK4odg.js";import{a as O}from"./useEffectEvent-Bx4XsOxK.js";import{$ as M,a as k}from"./keyboard-DWb2Gtmz.js";import{q as G}from"./useFocusRing-T6RsE8HB.js";import{r as m}from"./index-B2-qRKKC.js";import{m as w}from"./merge-DI-veSMP.js";import{a as _}from"./ScrollWrapper-DZgQQ_8U.js";import{c as U,B as X}from"./Button-DoFA_mR5.js";import{I as K}from"./IconSize-BcCrF_mi.js";import{F as Y,P as Z,b as J,p as Q}from"./FrontifyPattern-5PG0oenB.js";import{A as ee}from"./index-D309HAth.js";import{m as L}from"./motion-bD4j9jgw.js";function j(e,t){let a=e;for(M(a,t)&&(a=a.parentElement);a&&!M(a,t);)a=a.parentElement;return a||document.scrollingElement||document.documentElement}const y=typeof document<"u"&&window.visualViewport;let h=0,q;function te(e={}){let{isDisabled:t}=e;O(()=>{if(!t)return h++,h===1&&(G()?q=ne():q=ae()),()=>{h--,h===0&&q()}},[t])}function ae(){let e=window.innerWidth-document.documentElement.clientWidth;return P(e>0&&("scrollbarGutter"in document.documentElement.style?E(document.documentElement,"scrollbarGutter","stable"):E(document.documentElement,"paddingRight",`${e}px`)),E(document.documentElement,"overflow","hidden"))}function ne(){let e,t=!1,a=r=>{let o=r.target;e=M(o)?o:j(o,!0),t=!1;let u=o.ownerDocument.defaultView.getSelection();u&&!u.isCollapsed&&u.containsNode(o,!0)&&(t=!0),"selectionStart"in o&&"selectionEnd"in o&&o.selectionStart<o.selectionEnd&&o.ownerDocument.activeElement===o&&(t=!0)},n=document.createElement("style");n.textContent=`
@layer {
  * {
    overscroll-behavior: contain;
  }
}`.trim(),document.head.prepend(n);let d=r=>{if(!(r.touches.length===2||t)){if(!e||e===document.documentElement||e===document.body){r.preventDefault();return}e.scrollHeight===e.clientHeight&&e.scrollWidth===e.clientWidth&&r.preventDefault()}},l=r=>{let o=r.target,u=r.relatedTarget;if(u&&k(u))u.focus({preventScroll:!0}),S(u,k(o));else if(!u){var f;let c=(f=o.parentElement)===null||f===void 0?void 0:f.closest("[tabindex]");c==null||c.focus({preventScroll:!0})}},s=HTMLElement.prototype.focus;HTMLElement.prototype.focus=function(r){let o=document.activeElement!=null&&k(document.activeElement);s.call(this,{...r,preventScroll:!0}),(!r||!r.preventScroll)&&S(this,o)};let p=P(B(document,"touchstart",a,{passive:!1,capture:!0}),B(document,"touchmove",d,{passive:!1,capture:!0}),B(document,"blur",l,!0));return()=>{p(),n.remove(),HTMLElement.prototype.focus=s}}function E(e,t,a){let n=e.style[t];return e.style[t]=a,()=>{e.style[t]=n}}function B(e,t,a,n){return e.addEventListener(t,a,n),()=>{e.removeEventListener(t,a,n)}}function S(e,t){t||!y?H(e):y.addEventListener("resize",()=>H(e),{once:!0})}function H(e){let t=document.scrollingElement||document.documentElement,a=e;for(;a&&a!==t;){let n=j(a);if(n!==document.documentElement&&n!==document.body&&n!==a){let d=n.getBoundingClientRect(),l=a.getBoundingClientRect();if(l.top<d.top||l.bottom>d.top+a.clientHeight){let s=d.bottom;y&&(s=Math.min(s,y.offsetTop+y.height));let p=l.top-d.top-((s-d.top)/2-l.height/2);n.scrollTo({top:Math.max(0,Math.min(n.scrollHeight-n.clientHeight,n.scrollTop+p)),behavior:"smooth"})}}a=n.parentElement}}const x={default:{top:"tw-pt-14",horizontal:"tw-px-14",bottom:"tw-pb-14"},compact:{top:"tw-pt-6",horizontal:"tw-px-6",bottom:"tw-pb-6"}},g=m.createContext({compact:!1,padding:x.default});g.displayName="ModalLayoutContext";const T=({direction:e,children:t,horizontalPadding:a=!0})=>{const{padding:n}=m.useContext(g);return i.jsx("div",{"data-test-id":"modal-body",className:`tw-flex-auto tw-min-h-0 ${a?n.horizontal:"tw-pr-2"}`,children:i.jsx(_,{direction:e,children:t})})};T.displayName="FondueModalBody";T.__docgenInfo={description:"@deprecated Use `Dialog.Body` from `@frontify/fondue/components` instead. Also check {@link https://github.com/Frontify/fondue/blob/main/packages/components/MIGRATING.md#dialog the migration guide}.",methods:[],displayName:"FondueModalBody",props:{direction:{required:!1,tsType:{name:"ScrollWrapperDirection"},description:""},children:{required:!1,tsType:{name:"union",raw:"ReactElement | ReactElement[]",elements:[{name:"ReactElement"},{name:"Array",elements:[{name:"ReactElement"}],raw:"ReactElement[]"}]},description:""},horizontalPadding:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}}}};const R=({buttons:e})=>{const{padding:t}=m.useContext(g);return i.jsx("div",{"data-test-id":"modal-footer",className:`${t.bottom} ${t.horizontal}`,children:e&&i.jsx("div",{className:"tw-flex tw-gap-x-3 tw-justify-end",children:e.map((a,n)=>m.createElement(U,{...a,size:X.Medium,key:n}))})})};R.displayName="FondueModalFooter";R.__docgenInfo={description:"@deprecated Use `Dialog.Footer` from `@frontify/fondue/components` instead. Also check {@link https://github.com/Frontify/fondue/blob/main/packages/components/MIGRATING.md#dialog the migration guide}.",methods:[],displayName:"FondueModalFooter",props:{buttons:{required:!0,tsType:{name:"union",raw:"[ModalButton] | [ModalButton, ModalButton]",elements:[{name:"tuple",raw:"[ModalButton]",elements:[{name:"Omit",elements:[{name:"signature",type:"object",raw:`{
    type?: ButtonType;
    title?: string;
    style?: ButtonStyle;
