import{j as e}from"./jsx-runtime-Nms4Y4qS.js";import{r}from"./index-BwDkhjyp.js";import{g as ue,c as D}from"./fondue-icons331-DLB-AwW3.js";import{a as me}from"./chunk-454WOBUV-CM0pFb8Z.js";import{c as I}from"./index-DOnKqARA.js";import{c as be,P as Te}from"./index-DyYV4kFd.js";import{c as Z,R as pe,I as ge}from"./index-ImmjAmjo.js";import{P as y}from"./index-Brw_kfkv.js";import{u as fe}from"./index-C8IlRUt1.js";import{u as ve}from"./index-DGaPG0k3.js";import{u as he}from"./index-DduqEaLY.js";import{u as xe}from"./useControllableState-Bxhgt0vK.js";import{B as qe}from"./Button-Bmc9bttI.js";import{h as v}from"./Dropdown-D69oklj3.js";import"./_commonjsHelpers-BosuxZz1.js";import"./v4-CQkTLCs1.js";import"./index-BCwfsm-V.js";import"./index-BWD2N0gV.js";import"./index-DxjWwZXO.js";import"./styleUtilities-BnElyh0X.js";import"./focusStyle-IgMhxCMT.js";import"./index-9q6yCIGA.js";import"./index-kUwV4muI.js";import"./usePreventDropdownOverflow-hl17Ppn0.js";import"./index-BwIM2_zL.js";var w="Tabs",[Ce,rt]=be(w,[Z]),E=Z(),[je,A]=Ce(w),ee=r.forwardRef((i,n)=>{const{__scopeTabs:o,value:t,onValueChange:d,defaultValue:l,orientation:c="horizontal",dir:s,activationMode:m="automatic",...g}=i,b=fe(s),[u,p]=ve({prop:t,onChange:d,defaultProp:l});return e.jsx(je,{scope:o,baseId:he(),value:u,onValueChange:p,orientation:c,dir:b,activationMode:m,children:e.jsx(y.div,{dir:b,"data-orientation":c,...g,ref:n})})});ee.displayName=w;var te="TabsList",ie=r.forwardRef((i,n)=>{const{__scopeTabs:o,loop:t=!0,...d}=i,l=A(te,o),c=E(o);return e.jsx(pe,{asChild:!0,...c,orientation:l.orientation,dir:l.dir,loop:t,children:e.jsx(y.div,{role:"tablist","aria-orientation":l.orientation,...d,ref:n})})});ie.displayName=te;var ae="TabsTrigger",oe=r.forwardRef((i,n)=>{const{__scopeTabs:o,value:t,disabled:d=!1,...l}=i,c=A(ae,o),s=E(o),m=re(c.baseId,t),g=de(c.baseId,t),b=t===c.value;return e.jsx(ge,{asChild:!0,...s,focusable:!d,active:b,children:e.jsx(y.button,{type:"button",role:"tab","aria-selected":b,"aria-controls":g,"data-state":b?"active":"inactive","data-disabled":d?"":void 0,disabled:d,id:m,...l,ref:n,onMouseDown:I(i.onMouseDown,u=>{!d&&u.button===0&&u.ctrlKey===!1?c.onValueChange(t):u.preventDefault()}),onKeyDown:I(i.onKeyDown,u=>{[" ","Enter"].includes(u.key)&&c.onValueChange(t)}),onFocus:I(i.onFocus,()=>{const u=c.activationMode!=="manual";!b&&!d&&u&&c.onValueChange(t)})})})});oe.displayName=ae;var ne="TabsContent",se=r.forwardRef((i,n)=>{const{__scopeTabs:o,value:t,forceMount:d,children:l,...c}=i,s=A(ne,o),m=re(s.baseId,t),g=de(s.baseId,t),b=t===s.value,u=r.useRef(b);return r.useEffect(()=>{const p=requestAnimationFrame(()=>u.current=!1);return()=>cancelAnimationFrame(p)},[]),e.jsx(Te,{present:d||b,children:({present:p})=>e.jsx(y.div,{"data-state":b?"active":"inactive","data-orientation":s.orientation,role:"tabpanel","aria-labelledby":m,hidden:!p,id:g,tabIndex:0,...c,ref:n,style:{...i.style,animationDuration:u.current?"0s":void 0},children:p&&l})})});se.displayName=ne;function re(i,n){return`${i}-trigger-${n}`}function de(i,n){return`${i}-content-${n}`}var Re=ee,ye=ie,Se=oe,Le=se;const _e=(i,n)=>i.filter(o=>{var d;const t=(d=o.ref)==null?void 0:d.current;return t?t.offsetLeft+t.offsetWidth>(n==null?void 0:n.scrollLeft)+n.offsetWidth||t.offsetLeft-n.scrollLeft<0:!1}),h=(i,n)=>{const o=n.current,t=i==null?void 0:i.querySelector('[data-state="active"]');if(!i||!(t instanceof HTMLButtonElement)||!(o instanceof HTMLSpanElement))return;const d=(i==null?void 0:i.scrollLeft)>(t==null?void 0:t.offsetLeft),l=(t==null?void 0:t.offsetLeft)+(t==null?void 0:t.offsetWidth)>(i==null?void 0:i.offsetWidth);d?(i.offsetWidth>t.offsetWidth+t.offsetLeft?o.style.left=`${t.offsetLeft}px`:o.style.left=`${i.offsetWidth-t.offsetWidth}px`,o.style.width=`${t==null?void 0:t.offsetWidth}px`):l?(o.style.left=`${i.clientWidth-t.offsetWidth}px`,o.style.width=`${t.offsetWidth}px`):(o.style.left=`${t.offsetLeft}px`,o.style.width=`${t.offsetWidth}px`)},Ie=({activeTab:i})=>{const n=r.useRef(null),o=r.useRef(null),[t,d]=r.useState([]),[l,c]=r.useState([]);return r.useEffect(()=>{const s=n.current,m=s==null?void 0:s.querySelector('[data-state="active"]');m instanceof HTMLButtonElement&&s instanceof HTMLDivElement&&(h(s,o),m.scrollIntoView({behavior:"smooth",block:"nearest",inline:"end"}))},[i,o]),r.useLayoutEffect(()=>{var g;const s=n.current,m=s==null?void 0:s.querySelector('[data-state="active"]');if(s instanceof HTMLDivElement&&m instanceof HTMLButtonElement){h(s,o);const b=new MutationObserver(()=>{m.scrollIntoView({behavior:"instant",block:"nearest",inline:"end"}),h(s,o)});s.parentNode&&b.observe(s.parentNode,{childList:!0});const u=new IntersectionObserver(()=>{c(_e(t,s)),h(s,o)},{root:s,threshold:1});for(const p of t)(g=p.ref)!=null&&g.current&&u.observe(p.ref.current);return()=>{u.disconnect(),b.disconnect()}}},[t,n,o]),{triggerListRef:n,activeIndicatorRef:o,triggersOutOfView:l,triggers:t,addTrigger:s=>{d(m=>[...m,s])}}},we="_root_gfrd2_5",Ae="_triggerList_gfrd2_12",Fe="_triggerListWrapper_gfrd2_26",Ue="_trigger_gfrd2_12",Ne="_content_gfrd2_75",We="_activeIndicator_gfrd2_79",f={root:we,triggerList:Ae,triggerListWrapper:Fe,trigger:Ue,content:Ne,activeIndicator:We},F=r.createContext({value:"",disabled:!1}),ce=r.createContext({addTrigger:()=>{}}),S=({children:i,activeTab:n,defaultActiveTab:o,onActiveTabChange:t,size:d="medium",...l},c)=>{var W;const[s,m]=xe({prop:n,defaultProp:o,onChange:t}),g=r.useCallback(T=>{m(T)},[m]),{triggerListRef:b,activeIndicatorRef:u,triggers:p,triggersOutOfView:N,addTrigger:le}=Ie({activeTab:s});return console.log(p),e.jsx(ce.Provider,{value:{addTrigger:le},children:e.jsxs(Re,{ref:c,className:f.root,onValueChange:g,value:s??((W=p[0])==null?void 0:W.value),...l,children:[e.jsxs("div",{className:f.triggerListWrapper,children:[e.jsx(ye,{ref:b,"data-size":d,className:f.triggerList,children:p.map(T=>r.createElement(Se,{...T.props,key:T.value,value:T.value,disabled:T.disabled,className:f.trigger,ref:T.ref},T.element))}),e.jsxs(v.Root,{children:[N.length>0&&e.jsx(v.Trigger,{"data-test-id":"overflow-items-dropdown-trigger",children:e.jsx(qe,{emphasis:"default",aspect:"square",size:"small",children:e.jsx(ue,{size:16})})}),e.jsx(v.Content,{align:"end","data-test-id":"overflow-items-dropdown-content",children:N.map(T=>r.createElement(v.Item,{...T.props,disabled:T.disabled,onSelect:()=>g(T.value),key:T.value},T.element))})]}),e.jsx("span",{"data-test-id":"active-tab-indicator",ref:u,className:f.activeIndicator})]}),i]})})};S.displayName="Tabs.Root";const L=({children:i,value:n,disabled:o})=>e.jsx(F.Provider,{value:{value:n,disabled:o},children:i});L.displayName="Tabs.Tab";const U=({children:i,...n},o)=>{const{value:t,disabled:d}=r.useContext(F),{addTrigger:l}=r.useContext(ce),c=r.useRef(null);return r.useEffect(()=>{l({ref:c||o,value:t??"",disabled:d,props:n,element:i})},[]),null};U.displayName="Tabs.Trigger";const _=({children:i,...n},o)=>{const{value:t}=r.useContext(F);return e.jsx(Le,{ref:o,...n,className:f.content,value:t??"",children:i})};_.displayName="Tabs.Content";const a={Root:r.forwardRef(S),Tab:r.forwardRef(L),Trigger:r.forwardRef(U),Content:r.forwardRef(_)};S.__docgenInfo={description:"",methods:[],displayName:"Tabs.Root",props:{id:{required:!1,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""},defaultActiveTab:{required:!1,tsType:{name:"string"},description:`The default active tab
