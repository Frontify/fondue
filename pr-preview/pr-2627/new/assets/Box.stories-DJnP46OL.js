import{j as o}from"./iframe-pojAo36N.js";import{D as B}from"./DecorativeContent-ZCzVGikb.js";import{B as n}from"./Box-CN1b9pCB.js";import"./preload-helper-zta_rV5C.js";const j={title:"Layout/Box",component:n,tags:["autodocs"],parameters:{status:{type:"released"},docs:{description:{component:["A generic container with responsive spacing, sizing, and positioning props. The simplest layout primitive in Fondue.","","**When to use:** When you need margin, padding, or sizing control without Flex or Grid behavior. For directional layouts use `<Flex>`, for two-dimensional layouts use `<Grid>`."].join(`
