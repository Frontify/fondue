import{j as e}from"./iframe-pojAo36N.js";import{o as s,m as an}from"./fondue-icons372-CPCnPfhf.js";import{T as sn,a as rn,b as a}from"./Tag-Dhd6DVuK.js";import"./preload-helper-zta_rV5C.js";const{action:h}=__STORYBOOK_MODULE_ACTIONS__,ln={title:"Components/Tag",component:a,subcomponents:{"Tag.HoverContent":rn,"Tag.SecondaryContent":sn},tags:["autodocs"],parameters:{status:{type:"released"},docs:{description:{component:["A compact, interactive chip for representing keywords, categories, or user-generated labels. Supports selection, dismissal, and hover actions.","","**When to use:** For removable or selectable keywords — filter chips, applied tags, or multi-select tokens. For non-interactive status indicators, use `<Badge>` instead."].join(`
`)}}},args:{emphasis:"strong",variant:"default",size:"default",disabled:!1}},r={render:n=>e.jsx(a,{...n,children:"Text"})},o={render:n=>e.jsxs(a,{...n,children:["Text",e.jsx(a.SecondaryContent,{children:"Secondary"})]})},t={args:{onClick:h("onClick")},render:n=>e.jsx(a,{...n,children:"Text"})},c={args:{onDismiss:h("onDismiss")},render:n=>e.jsx(a,{...n,children:"Text"})},i={args:{onAddClick:h("onAddClick")},render:n=>e.jsx(a,{...n,children:"Text"})},d={args:{onClick:h("onClick"),onDismiss:h("onDismiss")},render:n=>e.jsx(a,{...n,children:"Text"})},l={render:n=>e.jsxs(a,{...n,children:[e.jsx(s,{size:"16"}),"Text"]})},g={render:n=>e.jsxs(a,{...n,children:[e.jsx(s,{size:"16"}),"Text",e.jsx(s,{size:"16"})]})},m={args:{onClick:h("onClick")},render:n=>e.jsxs(a,{...n,children:[e.jsx(s,{size:"16"})," Text"]})},p={render:n=>e.jsxs(e.Fragment,{children:["before"," ",e.jsxs(a,{...n,children:[e.jsx(s,{size:"16"})," Text"]})," ","after"]})},T={args:{onClick:h("onClick")},render:n=>e.jsxs(a,{...n,children:["This is a tag!",e.jsx(a.HoverContent,{children:e.jsx("div",{className:"tw-flex tw-w-full tw-justify-center",children:e.jsx(an,{})})})]})},u={render:n=>e.jsxs(a,{...n,children:[e.jsx(a.SecondaryContent,{children:"Before"}),"Main content"]})},C={render:n=>e.jsxs(a,{...n,children:[e.jsx(a.SecondaryContent,{children:"First"}),"Main content",e.jsx(a.SecondaryContent,{children:"Second"})]})},x={args:{onClick:h("onClick")},render:n=>e.jsxs(a,{...n,children:[e.jsx(a.SecondaryContent,{children:"Prefix"}),"Main content",e.jsx(a.HoverContent,{children:e.jsx(an,{})}),e.jsx(a.SecondaryContent,{children:"Suffix"})]})},f={render:n=>e.jsxs("div",{className:"tw-flex tw-flex-nowrap tw-border tw-border-line-mid tw-rounded-medium tw-p-2 tw-gap-2",children:[e.jsxs(a,{...n,children:[e.jsx(s,{size:"16"})," Text"]}),e.jsxs(a,{...n,children:[e.jsx(s,{size:"16"})," Text"]}),e.jsxs(a,{...n,children:[e.jsx(s,{size:"16"})," Text"]}),e.jsxs(a,{...n,children:[e.jsx(s,{size:"16"})," Text"]}),e.jsxs(a,{...n,children:[e.jsx(s,{size:"16"})," Text"]}),e.jsxs(a,{...n,children:[e.jsx(s,{size:"16"})," Text"]})]})};var S,z,y;r.parameters={...r.parameters,docs:{...(S=r.parameters)==null?void 0:S.docs,source:{code:`const LabelOnly = () => (
...
`,...(k=(v=o.parameters)==null?void 0:v.docs)==null?void 0:k.source}}};var w,b,I;t.parameters={...t.parameters,docs:{...(w=t.parameters)==null?void 0:w.docs,source:{code:`const WithOnClick = () => (
  <Tag
    emphasis="strong"
    variant="default"
    size="default"
...
`,...(I=(b=t.parameters)==null?void 0:b.docs)==null?void 0:I.source}}};var W,F,D;c.parameters={...c.parameters,docs:{...(W=c.parameters)==null?void 0:W.docs,source:{code:`const WithDismiss = () => (
  <Tag
    emphasis="strong"
    variant="default"
    size="default"
...
`,...(q=(Y=m.parameters)==null?void 0:Y.docs)==null?void 0:q.source}}};var G,J,Q;p.parameters={...p.parameters,docs:{...(G=p.parameters)==null?void 0:G.docs,source:{code:`const BetweenElements = () => (
  <>
    before{" "}
    <Tag emphasis="strong" variant="default" size="default" disabled={false}>
      <IconColorFan size="16" />
...
`,...(Q=(J=p.parameters)==null?void 0:J.docs)==null?void 0:Q.source}}};var V,X,Z;T.parameters={...T.parameters,docs:{...(V=T.parameters)==null?void 0:V.docs,source:{code:`const WithHoverContent = () => {
  return (
    <Tag
      emphasis="strong"
      variant="default"
...
`,...(Z=(X=T.parameters)==null?void 0:X.docs)==null?void 0:Z.source}}};var $,ee,ne;u.parameters={...u.parameters,docs:{...($=u.parameters)==null?void 0:$.docs,source:{code:`const WithSecondaryContentBefore = () => {
  return (
    <Tag emphasis="strong" variant="default" size="default" disabled={false}>
...
`,...(le=(de=f.parameters)==null?void 0:de.docs)==null?void 0:le.source}}};var ge,me,pe;r.parameters={...r.parameters,docs:{...(ge=r.parameters)==null?void 0:ge.docs,source:{originalSource:`{
  render: args => <Tag {...args}>Text</Tag>
}`,...(pe=(me=r.parameters)==null?void 0:me.docs)==null?void 0:pe.source}}};var Te,ue,Ce;o.parameters={...o.parameters,docs:{...(Te=o.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  ...
  render: args => <Tag {...args}>Text</Tag>
}`,...(ke=(ve=i.parameters)==null?void 0:ve.docs)==null?void 0:ke.source}}};var we,be,Ie;d.parameters={...d.parameters,docs:{...(we=d.parameters)==null?void 0:we.docs,source:{originalSource:`{
  args: {
    onClick: action('onClick'),
    onDismiss: action('onDismiss')
  },
  render: args => <Tag {...args}>Text</Tag>
}`,...(Ie=(be=d.parameters)==null?void 0:be.docs)==null?void 0:Ie.source}}};var We,Fe,De;l.parameters={...l.parameters,docs:{...(We=l.parameters)==null?void 0:We.docs,source:{originalSource:`{
  render: args => <Tag {...args}>
            <IconColorFan size="16" />
            Text
        </Tag>
...
}`,...(_e=(Me=m.parameters)==null?void 0:Me.docs)==null?void 0:_e.source}}};var Ne,Ee,Re;p.parameters={...p.parameters,docs:{...(Ne=p.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
  render: args => <>
            before{' '}
            <Tag {...args}>
                <IconColorFan size="16" /> Text
...
}`,...(Re=(Ee=p.parameters)==null?void 0:Ee.docs)==null?void 0:Re.source}}};var Le,Pe,Ke;T.parameters={...T.parameters,docs:{...(Le=T.parameters)==null?void 0:Le.docs,source:{originalSource:`{
  args: {
    onClick: action('onClick')
  },
  render: args => {
...
}`,...(Ke=(Pe=T.parameters)==null?void 0:Pe.docs)==null?void 0:Ke.source}}};var Ue,Ye,qe;u.parameters={...u.parameters,docs:{...(Ue=u.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
  render: args => {
    return <Tag {...args}>
...
}`,...(nn=(en=f.parameters)==null?void 0:en.docs)==null?void 0:nn.source}}};const gn=["LabelOnly","WithSecondaryContent","WithOnClick","WithDismiss","WithAddable","WithOnClickAndDismiss","WithIcon","WithIconOnBothSides","WithOnClickAndIcon","BetweenElements","WithHoverContent","WithSecondaryContentBefore","WithMultipleSecondaryContent","WithBothSlotTypes","MultipleTagsInRow"];export{p as BetweenElements,r as LabelOnly,f as MultipleTagsInRow,i as WithAddable,x as WithBothSlotTypes,c as WithDismiss,T as WithHoverContent,l as WithIcon,g as WithIconOnBothSides,C as WithMultipleSecondaryContent,t as WithOnClick,d as WithOnClickAndDismiss,m as WithOnClickAndIcon,o as WithSecondaryContent,u as WithSecondaryContentBefore,gn as __namedExportsOrder,ln as default};
