import{j as e}from"./iframe-BFXen_90.js";import{D as R}from"./DecorativeContent-BiO7nFEm.js";import{B as F}from"./Box-Bc14IpWc.js";import{G as t}from"./Grid-SUv7kvnI.js";import"./preload-helper-zta_rV5C.js";const r=s=>e.jsx(F,{width:"100px",height:"100px",...s,children:e.jsx(R,{})});r.displayName="DecorativeBox";const E={title:"Layout/Grid",component:t,tags:["autodocs"],parameters:{status:{type:"released"},docs:{description:{component:["A two-dimensional layout container using CSS Grid. Defines rows and columns for complex, responsive layouts.","","**When to use:** For two-dimensional layouts like card grids, dashboards, or form layouts. For single-axis layouts use `<Flex>`."].join(`
