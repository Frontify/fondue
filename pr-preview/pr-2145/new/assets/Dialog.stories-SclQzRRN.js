import{j as e}from"./jsx-runtime-Nms4Y4qS.js";import{r as d}from"./index-BwDkhjyp.js";import{B as i}from"./Button-wZ8em-5F.js";import{F as j}from"./Flex-CU151qQ-.js";import{F as m}from"./Flyout-UJYEiUbU.js";import{T as oe}from"./TextInput-BYbZmo9E.js";import{T as h}from"./Tooltip-BV_thiUK.js";import{e as Ut}from"./fondue-icons346-wUFpRcbj.js";import{c as T}from"./index-DOnKqARA.js";import{u as ie,P as v,S as Gt}from"./index-BtCsUTRM.js";import{c as Jt,a as zt}from"./index-BSNoMcJN.js";import{u as ae}from"./index-DduqEaLY.js";import{u as Kt}from"./index-DGaPG0k3.js";import{D as Yt,P as Zt}from"./index-CAR1Fn1S.js";import{R as Qt,h as Xt,u as eo,F as to}from"./Combination-_kzEJOyC.js";import{P as re}from"./index-C1SWbrhG.js";import{a as oo,b as ao}from"./domUtilities-DGDVwu3_.js";import"./_commonjsHelpers-BosuxZz1.js";import"./styleUtilities-CZDH020m.js";import"./focusStyle-IgMhxCMT.js";import"./propsToCssVariables-DuhnUZvM.js";import"./index-DzIefvJi.js";import"./index-CS4BWtGh.js";import"./index-BnOD_KYf.js";import"./index-kUwV4muI.js";var ne="Dialog",[Rt,Qo]=Jt(ne),[io,g]=Rt(ne),wt=o=>{const{__scopeDialog:a,children:r,open:n,defaultOpen:s,onOpenChange:l,modal:u=!0}=o,c=d.useRef(null),p=d.useRef(null),[f=!1,te]=Kt({prop:n,defaultProp:s,onChange:l});return e.jsx(io,{scope:a,triggerRef:c,contentRef:p,contentId:ae(),titleId:ae(),descriptionId:ae(),open:f,onOpenChange:te,onOpenToggle:d.useCallback(()=>te($t=>!$t),[te]),modal:u,children:r})};wt.displayName=ne;var qt="DialogTrigger",Ft=d.forwardRef((o,a)=>{const{__scopeDialog:r,...n}=o,s=g(qt,r),l=ie(a,s.triggerRef);return e.jsx(v.button,{type:"button","aria-haspopup":"dialog","aria-expanded":s.open,"aria-controls":s.contentId,"data-state":de(s.open),...n,ref:l,onClick:T(o.onClick,s.onOpenToggle)})});Ft.displayName=qt;var se="DialogPortal",[ro,Ht]=Rt(se,{forceMount:void 0}),St=o=>{const{__scopeDialog:a,forceMount:r,children:n,container:s}=o,l=g(se,a);return e.jsx(ro,{scope:a,forceMount:r,children:d.Children.map(n,u=>e.jsx(re,{present:r||l.open,children:e.jsx(Zt,{asChild:!0,container:s,children:u})}))})};St.displayName=se;var U="DialogOverlay",Nt=d.forwardRef((o,a)=>{const r=Ht(U,o.__scopeDialog),{forceMount:n=r.forceMount,...s}=o,l=g(U,o.__scopeDialog);return l.modal?e.jsx(re,{present:n||l.open,children:e.jsx(no,{...s,ref:a})}):null});Nt.displayName=U;var no=d.forwardRef((o,a)=>{const{__scopeDialog:r,...n}=o,s=g(U,r);return e.jsx(Qt,{as:Gt,allowPinchZoom:!0,shards:[s.contentRef],children:e.jsx(v.div,{"data-state":de(s.open),...n,ref:a,style:{pointerEvents:"auto",...n.style}})})}),D="DialogContent",Ot=d.forwardRef((o,a)=>{const r=Ht(D,o.__scopeDialog),{forceMount:n=r.forceMount,...s}=o,l=g(D,o.__scopeDialog);return e.jsx(re,{present:n||l.open,children:l.modal?e.jsx(so,{...s,ref:a}):e.jsx(lo,{...s,ref:a})})});Ot.displayName=D;var so=d.forwardRef((o,a)=>{const r=g(D,o.__scopeDialog),n=d.useRef(null),s=ie(a,r.contentRef,n);return d.useEffect(()=>{const l=n.current;if(l)return Xt(l)},[]),e.jsx(It,{...o,ref:s,trapFocus:r.open,disableOutsidePointerEvents:!0,onCloseAutoFocus:T(o.onCloseAutoFocus,l=>{var u;l.preventDefault(),(u=r.triggerRef.current)==null||u.focus()}),onPointerDownOutside:T(o.onPointerDownOutside,l=>{const u=l.detail.originalEvent,c=u.button===0&&u.ctrlKey===!0;(u.button===2||c)&&l.preventDefault()}),onFocusOutside:T(o.onFocusOutside,l=>l.preventDefault())})}),lo=d.forwardRef((o,a)=>{const r=g(D,o.__scopeDialog),n=d.useRef(!1),s=d.useRef(!1);return e.jsx(It,{...o,ref:a,trapFocus:!1,disableOutsidePointerEvents:!1,onCloseAutoFocus:l=>{var u,c;(u=o.onCloseAutoFocus)==null||u.call(o,l),l.defaultPrevented||(n.current||(c=r.triggerRef.current)==null||c.focus(),l.preventDefault()),n.current=!1,s.current=!1},onInteractOutside:l=>{var p,f;(p=o.onInteractOutside)==null||p.call(o,l),l.defaultPrevented||(n.current=!0,l.detail.originalEvent.type==="pointerdown"&&(s.current=!0));const u=l.target;((f=r.triggerRef.current)==null?void 0:f.contains(u))&&l.preventDefault(),l.detail.originalEvent.type==="focusin"&&s.current&&l.preventDefault()}})}),It=d.forwardRef((o,a)=>{const{__scopeDialog:r,trapFocus:n,onOpenAutoFocus:s,onCloseAutoFocus:l,...u}=o,c=g(D,r),p=d.useRef(null),f=ie(a,p);return eo(),e.jsxs(e.Fragment,{children:[e.jsx(to,{asChild:!0,loop:!0,trapped:n,onMountAutoFocus:s,onUnmountAutoFocus:l,children:e.jsx(Yt,{role:"dialog",id:c.contentId,"aria-describedby":c.descriptionId,"aria-labelledby":c.titleId,"data-state":de(c.open),...u,ref:f,onDismiss:()=>c.onOpenChange(!1)})}),e.jsxs(e.Fragment,{children:[e.jsx(uo,{titleId:c.titleId}),e.jsx(go,{contentRef:p,descriptionId:c.descriptionId})]})]})}),le="DialogTitle",_t=d.forwardRef((o,a)=>{const{__scopeDialog:r,...n}=o,s=g(le,r);return e.jsx(v.h2,{id:s.titleId,...n,ref:a})});_t.displayName=le;var Pt="DialogDescription",Et=d.forwardRef((o,a)=>{const{__scopeDialog:r,...n}=o,s=g(Pt,r);return e.jsx(v.p,{id:s.descriptionId,...n,ref:a})});Et.displayName=Pt;var Wt="DialogClose",At=d.forwardRef((o,a)=>{const{__scopeDialog:r,...n}=o,s=g(Wt,r);return e.jsx(v.button,{type:"button",...n,ref:a,onClick:T(o.onClick,()=>s.onOpenChange(!1))})});At.displayName=Wt;function de(o){return o?"open":"closed"}var Mt="DialogTitleWarning",[Xo,Vt]=zt(Mt,{contentName:D,titleName:le,docsSlug:"dialog"}),uo=({titleId:o})=>{const a=Vt(Mt),r=`\`${a.contentName}\` requires a \`${a.titleName}\` for the component to be accessible for screen reader users.

If you want to hide the \`${a.titleName}\`, you can wrap it with our VisuallyHidden component.

For more information, see https://radix-ui.com/primitives/docs/components/${a.docsSlug}`;return d.useEffect(()=>{o&&(document.getElementById(o)||console.error(r))},[r,o]),null},co="DialogDescriptionWarning",go=({contentRef:o,descriptionId:a})=>{const n=`Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${Vt(co).contentName}}.`;return d.useEffect(()=>{var l;const s=(l=o.current)==null?void 0:l.getAttribute("aria-describedby");a&&s&&(document.getElementById(a)||console.warn(n))},[n,o,a]),null},po=wt,mo=Ft,ho=St,fo=Nt,Do=Ot,xo=_t,jo=Et,kt=At;const To="_content_18vkf_6",vo="_underlay_18vkf_51",Co="_sideContent_18vkf_64",yo="_header_18vkf_76",Bo="_footer_18vkf_110",bo="_body_18vkf_141",x={content:To,underlay:vo,sideContent:Co,header:yo,footer:Bo,body:bo},Lt=d.createContext({isModal:!1}),G=({children:o,...a})=>e.jsx(Lt.Provider,{value:{isModal:a.modal??!1},children:e.jsx(po,{...a,children:o})});G.displayName="Dialog.Root";const J=({asChild:o=!0,children:a,"data-test-id":r="fondue-dialog-trigger",...n},s)=>e.jsx(mo,{onMouseDown:oo,"data-auto-focus-visible":"true","data-auto-focus-trigger":!0,"data-test-id":r,asChild:o,ref:s,...n,children:a});J.displayName="Dialog.Trigger";const Ro=({children:o,showUnderlay:a})=>{const{isModal:r}=d.useContext(Lt);return r?e.jsx(fo,{"data-visible":a,className:x.underlay,children:o}):e.jsx("div",{className:x.underlay,"data-visible":a,children:o})},z=({maxWidth:o="800px",minWidth:a="400px",minHeight:r="200px",verticalAlign:n="center","data-test-id":s="fondue-dialog-content",showUnderlay:l=!1,rounded:u=!0,children:c,...p},f)=>e.jsx(ho,{children:e.jsx(Ro,{showUnderlay:l,children:e.jsx(Do,{style:{"--dialog-max-width":o,"--dialog-min-width":a,"--dialog-min-height":r},ref:f,className:x.content,onFocus:ao,"data-dialog-rounded":u,"data-test-id":s,"data-dialog-vertical-align":n,...p,children:c})})});z.displayName="Dialog.Content";const K=({padding:o="compact",showBorder:a=!0,showCloseButton:r=!0,children:n,"data-test-id":s="fondue-dialog-header"},l)=>e.jsxs("div",{"data-test-id":s,ref:l,className:x.header,"data-dialog-header-padding":o,"data-show-border":a,"data-dialog-layout-component":!0,children:[e.jsx("div",{children:n}),r&&e.jsx(kt,{role:"button","data-test-id":`${s}-close`,className:"tw-cursor-pointer",children:e.jsx(Ut,{size:20})})]});K.displayName="Dialog.Header";const ue=({padding:o="compact",showBorder:a=!0,children:r,"data-test-id":n="fondue-dialog-footer"},s)=>e.jsx("div",{"data-test-id":n,ref:s,className:x.footer,"data-dialog-footer-padding":o,"data-show-border":a,"data-dialog-layout-component":!0,children:r});ue.displayName="Dialog.Footer";const Y=({padding:o="compact",children:a,"data-test-id":r="fondue-dialog-body"},n)=>e.jsx("div",{"data-test-id":r,ref:n,className:x.body,"data-dialog-body-padding":o,"data-dialog-layout-component":!0,children:a});Y.displayName="Dialog.Body";const Z=({children:o,"data-test-id":a="fondue-dialog-side-content"},r)=>e.jsx("div",{"data-test-id":a,ref:r,className:x.sideContent,"data-dialog-layout-component":!0,children:o});Z.displayName="Dialog.SideContent";const Q=({children:o})=>e.jsx(kt,{asChild:!0,children:o});Q.displayName="Dialog.Close";const X=({children:o,asChild:a})=>e.jsx(xo,{asChild:a,children:o});X.displayName="Dialog.Title";const ee=({children:o,asChild:a})=>e.jsx(jo,{asChild:a,children:o});ee.displayName="Dialog.Description";const t={Root:G,Title:X,Description:ee,Close:Q,Trigger:d.forwardRef(J),Content:d.forwardRef(z),Header:d.forwardRef(K),Footer:d.forwardRef(ue),Body:d.forwardRef(Y),SideContent:d.forwardRef(Z)};G.__docgenInfo={description:"",methods:[],displayName:"Dialog.Root",props:{modal:{required:!1,tsType:{name:"boolean"},description:`Disable interaction with the rest of the page
...
@default true`,defaultValue:{value:"true",computed:!1}},verticalAlign:{required:!1,tsType:{name:"union",raw:"'top' | 'center'",elements:[{name:"literal",value:"'top'"},{name:"literal",value:"'center'"}]},description:`The vertical alignment of the divider
...
}`,...(fe=(he=y.parameters)==null?void 0:he.docs)==null?void 0:fe.source}}};var De,xe,je;B.parameters={...B.parameters,docs:{...(De=B.parameters)==null?void 0:De.docs,source:{originalSource:`{
  args: {
    children: 'I am a dialog content'
  },
  render: args => {
...
}`,...(je=(xe=B.parameters)==null?void 0:xe.docs)==null?void 0:je.source}}};var Te,ve,Ce;b.parameters={...b.parameters,docs:{...(Te=b.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  args: {
    children: 'I am a dialog content'
  },
  render: args => {
...
}`,...(Ce=(ve=b.parameters)==null?void 0:ve.docs)==null?void 0:Ce.source}}};var ye,Be,be;R.parameters={...R.parameters,docs:{...(ye=R.parameters)==null?void 0:ye.docs,source:{originalSource:`{
  args: {
    children: 'I am a dialog content'
  },
  render: args => {
...
}`,...(be=(Be=R.parameters)==null?void 0:Be.docs)==null?void 0:be.source}}};var Re,we,qe;w.parameters={...w.parameters,docs:{...(Re=w.parameters)==null?void 0:Re.docs,source:{originalSource:`{
  args: {
    children: 'I am a dialog content',
    showUnderlay: true
  },
...
}`,...(qe=(we=w.parameters)==null?void 0:we.docs)==null?void 0:qe.source}}};var Fe,He,Se;q.parameters={...q.parameters,docs:{...(Fe=q.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
  args: {
...
}`,...(Se=(He=q.parameters)==null?void 0:He.docs)==null?void 0:Se.source}}};var Ne,Oe,Ie;F.parameters={...F.parameters,docs:{...(Ne=F.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
  args: {
    children: 'I am a dialog content'
  },
  render: args => {
...
}`,...(Ie=(Oe=F.parameters)==null?void 0:Oe.docs)==null?void 0:Ie.source}}};var _e,Pe,Ee;H.parameters={...H.parameters,docs:{...(_e=H.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  args: {
    children: 'I am a dialog content'
  },
  render: args => {
...
}`,...(Ee=(Pe=H.parameters)==null?void 0:Pe.docs)==null?void 0:Ee.source}}};var We,Ae,Me;S.parameters={...S.parameters,docs:{...(We=S.parameters)==null?void 0:We.docs,source:{originalSource:`{
  args: {
    children: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Consequat interdum varius sit amet mattis vulputate enim nulla aliquet. Eu lobortis elementum nibh tellus molestie nunc non blandit. Massa tincidunt nunc pulvinar sapien et ligula. Fringilla urna porttitor rhoncus dolor purus non enim praesent elementum. Facilisis gravida neque convallis a cras semper auctor neque vitae. Urna porttitor rhoncus dolor purus non enim. A iaculis at erat pellentesque adipiscing commodo. Tristique magna sit amet purus gravida quis. Magna ac placerat vestibulum lectus mauris ultrices eros. Libero volutpat sed cras ornare arcu dui. Imperdiet sed euismod nisi porta lorem mollis aliquam. Odio pellentesque diam volutpat commodo. Varius vel pharetra vel turpis nunc. Justo nec ultrices dui sapien eget mi proin sed. Consectetur adipiscing elit ut aliquam. Arcu dictum varius duis at consectetur lorem. Pharetra diam sit amet nisl. Odio ut sem nulla pharetra diam sit. Nam aliquam sem et tortor consequat id. Egestas maecenas pharetra convallis posuere morbi leo urna. Id volutpat lacus laoreet non curabitur. Sagittis purus sit amet volutpat consequat mauris nunc. Eu nisl nunc mi ipsum faucibus. Pretium viverra suspendisse potenti nullam ac. Enim neque volutpat ac tincidunt vitae semper. Rutrum tellus pellentesque eu tincidunt tortor aliquam nulla facilisi. Metus vulputate eu scelerisque felis imperdiet proin fermentum leo. Orci eu lobortis elementum nibh tellus molestie nunc non blandit. Maecenas accumsan lacus vel facilisis volutpat est. Porttitor massa id neque aliquam vestibulum morbi blandit cursus. Tempor orci dapibus ultrices in iaculis nunc sed augue lacus. Facilisis sed odio morbi quis commodo. Aliquam sem et tortor consequat id porta nibh venenatis cras. Adipiscing at in tellus integer feugiat scelerisque. Netus et malesuada fames ac turpis egestas sed tempus. Eget mauris pharetra et ultrices.'
  },
  render: args => {
...
}`,...(Me=(Ae=S.parameters)==null?void 0:Ae.docs)==null?void 0:Me.source}}};var Ve,ke,Le;N.parameters={...N.parameters,docs:{...(Ve=N.parameters)==null?void 0:Ve.docs,source:{originalSource:`{
  args: {
...
}`,...(Le=(ke=N.parameters)==null?void 0:ke.docs)==null?void 0:Le.source}}};var $e,Ue,Ge;O.parameters={...O.parameters,docs:{...($e=O.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  render: () => {
    return <Dialog.Root>
                <Dialog.Trigger>
                    <Button>Open dialog</Button>
...
}`,...(Ge=(Ue=O.parameters)==null?void 0:Ue.docs)==null?void 0:Ge.source}}};var Je,ze,Ke;I.parameters={...I.parameters,docs:{...(Je=I.parameters)==null?void 0:Je.docs,source:{originalSource:`{
  render: () => {
    return <Dialog.Root>
                <Dialog.Trigger>
                    <Button>Open dialog</Button>
...
}`,...(Ke=(ze=I.parameters)==null?void 0:ze.docs)==null?void 0:Ke.source}}};var Ye,Ze,Qe;_.parameters={..._.parameters,docs:{...(Ye=_.parameters)==null?void 0:Ye.docs,source:{originalSource:`{
  render: () => {
    return <Dialog.Root>
                <Dialog.Trigger>
                    <Button>Open dialog</Button>
...
}`,...(Qe=(Ze=_.parameters)==null?void 0:Ze.docs)==null?void 0:Qe.source}}};var Xe,et,tt;P.parameters={...P.parameters,docs:{...(Xe=P.parameters)==null?void 0:Xe.docs,source:{originalSource:`{
  render: () => {
    return <Dialog.Root>
                <Dialog.Trigger>
                    <Button>Open dialog</Button>
...
}`,...(tt=(et=P.parameters)==null?void 0:et.docs)==null?void 0:tt.source}}};var ot,at,it;E.parameters={...E.parameters,docs:{...(ot=E.parameters)==null?void 0:ot.docs,source:{originalSource:`{
  render: () => {
    return <Dialog.Root>
                <Dialog.Trigger>
                    <Button>Open dialog</Button>
...
}`,...(it=(at=E.parameters)==null?void 0:at.docs)==null?void 0:it.source}}};var rt,nt,st;W.parameters={...W.parameters,docs:{...(rt=W.parameters)==null?void 0:rt.docs,source:{originalSource:`{
  args: {
    verticalAlign: 'top'
  }
}`,...(st=(nt=W.parameters)==null?void 0:nt.docs)==null?void 0:st.source}}};var lt,dt,ut;A.parameters={...A.parameters,docs:{...(lt=A.parameters)==null?void 0:lt.docs,source:{originalSource:`{
  parameters: {
    viewport: {
      viewports: {
        mobile: {
...
}`,...(ut=(dt=A.parameters)==null?void 0:dt.docs)==null?void 0:ut.source}}};var ct,gt,pt;M.parameters={...M.parameters,docs:{...(ct=M.parameters)==null?void 0:ct.docs,source:{originalSource:`{
  args: {
    children: 'I am a dialog content'
  },
  render: args => {
...
}`,...(pt=(gt=M.parameters)==null?void 0:gt.docs)==null?void 0:pt.source}}};var mt,ht,ft;V.parameters={...V.parameters,docs:{...(mt=V.parameters)==null?void 0:mt.docs,source:{originalSource:`{
  args: {
    children: 'I am a dialog content'
  },
  render: args => {
...
}`,...(ft=(ht=V.parameters)==null?void 0:ht.docs)==null?void 0:ft.source}}};var Dt,xt,jt;k.parameters={...k.parameters,docs:{...(Dt=k.parameters)==null?void 0:Dt.docs,source:{originalSource:`{
  render: args => {
...
}`,...(jt=(xt=k.parameters)==null?void 0:xt.docs)==null?void 0:jt.source}}};var Tt,vt,Ct;L.parameters={...L.parameters,docs:{...(Tt=L.parameters)==null?void 0:Tt.docs,source:{originalSource:`{
  render: args => {
    return <Dialog.Root>
                <Dialog.Trigger>
                    <Button>Open dialog</Button>
...
}`,...(Ct=(vt=L.parameters)==null?void 0:vt.docs)==null?void 0:Ct.source}}};var yt,Bt,bt;$.parameters={...$.parameters,docs:{...(yt=$.parameters)==null?void 0:yt.docs,source:{originalSource:`{
  args: {
    children: 'I am a dialog content'
  },
...
}`,...(bt=(Bt=$.parameters)==null?void 0:Bt.docs)==null?void 0:bt.source}}};const ta=["WithFullLayout","WithHeader","WithCloseButton","WithFooter","WithSideContent","WithUnderlay","WithLongText","WithCustomElementForClose","WithAnnouncedDescription","WithCustomElementAnnouncements","WithFocusableContent","WithNoPadding","WithTightPadding","WithCompactPadding","WithComfortablePadding","WithSpaciousPadding","TopAligned","MobileView","WithoutBorders","ControlledComponent","WithFlyoutAndTooltip","WithButtonInTheHeader","WithTooltip"];export{V as ControlledComponent,A as MobileView,W as TopAligned,H as WithAnnouncedDescription,L as WithButtonInTheHeader,B as WithCloseButton,P as WithComfortablePadding,_ as WithCompactPadding,S as WithCustomElementAnnouncements,F as WithCustomElementForClose,k as WithFlyoutAndTooltip,N as WithFocusableContent,b as WithFooter,C as WithFullLayout,y as WithHeader,q as WithLongText,O as WithNoPadding,R as WithSideContent,E as WithSpaciousPadding,I as WithTightPadding,$ as WithTooltip,w as WithUnderlay,M as WithoutBorders,ta as __namedExportsOrder,ea as default};
