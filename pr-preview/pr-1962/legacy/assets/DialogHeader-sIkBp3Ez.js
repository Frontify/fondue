import{j as e}from"./jsx-runtime-Nms4Y4qS.js";import{B as t}from"./Box-DzMiH1vl.js";import{F as c}from"./Flex-B7Iwa1Jn.js";import{I as p}from"./IconCross-Bt-I3opn.js";import{a as f}from"./focusStyle-CBFElZiz.js";import{m as n}from"./merge-DI-veSMP.js";import{d as g,a as y}from"./dialog-Dre1eVQK.js";const l=({title:d,separator:u=!0,padding:i="comfortable",onClose:r,icon:s,badge:o,children:m,"data-test-id":a="fondue-dialog-header"})=>e.jsxs(t,{"data-test-id":a,className:n(["tw-w-full tw-flex tw-items-center tw-border-b tw-border-b-line",g[i],!u&&"tw-pb-0 tw-border-none"]),children:[e.jsxs(c,{alignItems:"center","data-test-id":`${a}-title`,children:[e.jsxs(t,{className:"tw-flex tw-items-center tw-text-box-neutral-mighty",children:[s&&e.jsx("span",{"data-test-id":`${a}-icon`,className:"tw-mr-1.5",children:s}),e.jsx("p",{className:n([y[i],"tw-font-medium tw-whitespace-nowrap"]),children:d}),o&&e.jsx("div",{"data-test-id":`${a}-badge`,className:"tw-ml-1.5",children:o})]}),e.jsx(t,{className:"tw-flex-shrink tw-ml-1",children:m})]}),r&&e.jsx("button",{"data-test-id":`${a}-close`,"aria-label":`${a}-close`,onClick:r,className:n([f,"tw-rounded tw-absolute tw-right-5 tw-text-text"]),children:e.jsx(p,{})})]});l.displayName="FondueDialogHeader";l.__docgenInfo={description:"",methods:[],displayName:"FondueDialogHeader",props:{title:{required:!0,tsType:{name:"string"},description:""},separator:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},icon:{required:!1,tsType:{name:"ReactElement",elements:[{name:"intersection",raw:`GeneratedIconProps & {
    icon: IconEnum;
