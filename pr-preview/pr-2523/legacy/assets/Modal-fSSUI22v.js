import{r as m,j as i}from"./iframe-DXv6_zxw.js";import{b as W,$ as C,a as F}from"./useDialog-d2Eqy3G1.js";import{$ as A}from"./FocusScope-DF8eB_8k.js";import{a as V}from"./useOverlayTriggerState-BF9Ejr7z.js";import{b as P}from"./chain-Cep8FPJT.js";import{$ as O}from"./useEffectEvent-Cb0J6-Z5.js";import{$ as M,b as k}from"./keyboard-cPqzm9YB.js";import{u as G}from"./useFocusRing-BDH3dCmG.js";import{m as w}from"./merge-DI-veSMP.js";import{S as _}from"./ScrollWrapper-BmB4jCRF.js";import{B as U,e as X}from"./Button-DB7dFfFM.js";import{I as K}from"./IconSize-BcCrF_mi.js";import{F as Y,P as Z,b as J,p as Q}from"./FrontifyPattern-BX5LHg0H.js";import{A as ee}from"./index-68lz1G71.js";import{m as L}from"./proxy-CdB0uKz_.js";function j(e,t){let a=e;for(M(a,t)&&(a=a.parentElement);a&&!M(a,t);)a=a.parentElement;return a||document.scrollingElement||document.documentElement}const y=typeof document<"u"&&window.visualViewport;let h=0,E;function te(e={}){let{isDisabled:t}=e;O(()=>{if(!t)return h++,h===1&&(G()?E=ne():E=ae()),()=>{h--,h===0&&E()}},[t])}function ae(){let e=window.innerWidth-document.documentElement.clientWidth;return P(e>0&&("scrollbarGutter"in document.documentElement.style?q(document.documentElement,"scrollbarGutter","stable"):q(document.documentElement,"paddingRight",`${e}px`)),q(document.documentElement,"overflow","hidden"))}function ne(){let e,t=!1,a=r=>{let o=r.target;e=M(o)?o:j(o,!0),t=!1;let u=o.ownerDocument.defaultView.getSelection();u&&!u.isCollapsed&&u.containsNode(o,!0)&&(t=!0),"selectionStart"in o&&"selectionEnd"in o&&o.selectionStart<o.selectionEnd&&o.ownerDocument.activeElement===o&&(t=!0)},n=document.createElement("style");n.textContent=`
@layer {
  * {
