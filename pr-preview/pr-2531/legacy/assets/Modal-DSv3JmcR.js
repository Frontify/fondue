import{r as m,j as i}from"./iframe-CfBLd35K.js";import{b as W,$ as C,a as F}from"./useDialog-BMdAN5J6.js";import{$ as A}from"./FocusScope-NaJ6X-7k.js";import{a as V}from"./useOverlayTriggerState-6pXikwCB.js";import{b as P}from"./chain-pG_FVjze.js";import{$ as O}from"./useEffectEvent-DtYDcY6c.js";import{$ as M,b as k}from"./keyboard-D8xRU-Ay.js";import{u as G}from"./useFocusRing-HQOnF_Kw.js";import{m as w}from"./merge-DI-veSMP.js";import{S as _}from"./ScrollWrapper-DxRTCFbO.js";import{B as U,e as X}from"./Button-BMq1fE2z.js";import{I as K}from"./IconSize-BcCrF_mi.js";import{F as Y,P as Z,b as J,p as Q}from"./FrontifyPattern-eVslJpay.js";import{A as ee}from"./index-Bvl4aFjT.js";import{m as L}from"./proxy-C8Q4eWOI.js";function j(e,t){let a=e;for(M(a,t)&&(a=a.parentElement);a&&!M(a,t);)a=a.parentElement;return a||document.scrollingElement||document.documentElement}const y=typeof document<"u"&&window.visualViewport;let h=0,E;function te(e={}){let{isDisabled:t}=e;O(()=>{if(!t)return h++,h===1&&(G()?E=ne():E=ae()),()=>{h--,h===0&&E()}},[t])}function ae(){let e=window.innerWidth-document.documentElement.clientWidth;return P(e>0&&("scrollbarGutter"in document.documentElement.style?q(document.documentElement,"scrollbarGutter","stable"):q(document.documentElement,"paddingRight",`${e}px`)),q(document.documentElement,"overflow","hidden"))}function ne(){let e,t=!1,a=r=>{let o=r.target;e=M(o)?o:j(o,!0),t=!1;let u=o.ownerDocument.defaultView.getSelection();u&&!u.isCollapsed&&u.containsNode(o,!0)&&(t=!0),"selectionStart"in o&&"selectionEnd"in o&&o.selectionStart<o.selectionEnd&&o.ownerDocument.activeElement===o&&(t=!0)},n=document.createElement("style");n.textContent=`
@layer {
  * {
