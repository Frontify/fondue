...
`})}),`
`,e.jsxs(n.p,{children:["For cases where developers do not have access to Diatype, the tokens specifiy a fallbaclk font ",e.jsx(n.code,{children:"Geist"}),`.
...
`,e.jsxs(n.p,{children:["If you want to use a component, you can import them through the ",e.jsx(n.code,{children:"@frontify/fondue/components"})," subexport in the fondue package."]}),`
