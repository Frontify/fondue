import{j as r,r as d}from"./iframe-CYFO02LQ.js";import{C as h}from"./Container-26qsoB5l.js";import{a as v,b as O,c as k,d as E,e as _,f as N,T as c}from"./Tree-Dxj-ensO.js";import{t as g,u as xe,a as me}from"./mocks-CYBR3aIU.js";import{I as Ie}from"./IconDocument-BNhfdz27.js";import{T as j,u as be}from"./TreeItem-BSD18JkY.js";import"./preload-helper-DZlTBIiG.js";import"./Box-i9h4AIqE.js";import"./focusStyle-6rwBDk7H.js";import"./merge-DI-veSMP.js";import"./index-_F18RhcY.js";import"./index-BpacS63L.js";import"./IconSize-BcCrF_mi.js";const{action:l}=__STORYBOOK_MODULE_ACTIONS__,He={title:"Legacy Components/Tree",component:c,tags:["autodocs"],args:{id:"storybook-tree",draggable:!0,selectedIds:["2"],dragHandlerPosition:"left",showDragHandlerOnHoverOnly:!0,showContentWhileDragging:!1,spacingY:"none",contentHight:"single-line",shadow:"none",borderRadius:"small",borderWidth:"none",borderStyle:"none",activeColorStyle:"neutral"},argTypes:{draggable:{control:{type:"boolean"}},showDragHandlerOnHoverOnly:{table:{category:"Item Options"},control:{type:"boolean"}},showContentWhileDragging:{table:{category:"Item Options"},control:{type:"boolean"}},dragHandlerPosition:{table:{category:"Item Options"},options:["left","right","none"],control:{type:"inline-radio"}},spacingY:{table:{category:"Item Style"},name:"itemStyle.spacingY",options:[...Object.keys(N)],mapping:[...Object.values(N)],control:{type:"inline-radio"}},contentHight:{table:{category:"Item Style"},name:"itemStyle.contentHight",options:["content-fit","single-line"],control:{type:"inline-radio"}},shadow:{table:{category:"Item Style"},name:"itemStyle.shadow",options:[...Object.keys(_)],mapping:[...Object.values(_)],control:{type:"select"}},borderRadius:{table:{category:"Item Style"},name:"itemStyle.borderRadius",options:[...Object.keys(E)],mapping:[...Object.values(E)],control:{type:"select"}},borderWidth:{table:{category:"Item Style"},name:"itemStyle.borderWidth",options:[...Object.keys(k)],mapping:[...Object.values(k)],control:{type:"select"}},borderStyle:{table:{category:"Item Style"},name:"itemStyle.borderStyle",options:[...Object.keys(O)],mapping:[...Object.values(O)],control:{type:"select"}},activeColorStyle:{table:{category:"Item Style"},name:"itemStyle.activeColorStyle",options:[...Object.keys(v)],mapping:[...Object.values(v)],control:{type:"inline-radio"}},selectedIds:{control:{type:"object"}},expandedIds:{control:{type:"object"}}},parameters:{docs:{description:{component:`### *Legacy component warning*
#### This is a unmaintained legacy component. It will be deprecated and replaced with a new component in an upcoming release.`}}}},pe=({title:e})=>r.jsxs("div",{className:"tw-flex tw-space-x-1.5 tw-w-full",children:[r.jsx("span",{className:"tw-flex tw-justify-center tw-items-center tw-w-5",children:r.jsx(Ie,{})}),r.jsx("span",{children:e})]}),Te=({label:e,contentComponent:t,nodes:o,...n})=>{const s=`${e} CUSTOM`,a=()=>l("onDrop");return r.jsx(j,{label:s,...n,onDrop:a,children:o==null?void 0:o.map(i=>ue({...i,nodes:i.nodes}))})},ue=({id:e,onDrop:t,...o})=>r.jsx(Te,{id:e,onDrop:t??l("onDrop"),...o},`${e}-custom`),f=({nodes:e,onDrop:t,ignoreItemDoubleClick:o,expandOnSelect:n,...s})=>d.createElement(j,{...s,ignoreItemDoubleClick:o,expandOnSelect:n,key:s.id,onDrop:t??l("onDrop")},e==null?void 0:e.map(a=>f({...a,nodes:a.nodes,onDrop:t,ignoreItemDoubleClick:o,expandOnSelect:n}))),p=({nodes:e,label:t,numChildNodes:o,onDrop:n,...s})=>{const a=(e==null?void 0:e.length)??0,i=o!==void 0?!!o:a>0;return d.createElement(j,{...s,key:s.id,contentComponent:r.jsx(pe,{title:t||"NO TITLE"}),onDrop:n??l("onDrop"),showCaret:i},e==null?void 0:e.map(p))},u=({...e})=>{const t={spacingY:e.spacingY,contentHight:e.contentHight,shadow:e.shadow,borderRadius:e.borderRadius,borderWidth:e.borderWidth,borderStyle:e.borderStyle,activeColorStyle:e.activeColorStyle,...e.itemStyle};return delete e.spacingY,delete e.contentHight,delete e.shadow,delete e.borderRadius,delete e.borderWidth,delete e.borderStyle,delete e.activeColorStyle,{...e,itemStyle:t}},y=({...e})=>{const t=()=>l("onDrop");return r.jsx(h,{maxWidth:"400px",children:r.jsx(c,{id:e.id,...u(e),children:g.map(o=>f({...o,onDrop:t}))})})},x=({...e})=>{const t=()=>l("onDrop");return r.jsx(h,{maxWidth:"400px",children:r.jsx(c,{id:e.id,...u(e),children:g.map(o=>ue({...o,onDrop:t}))})})},I=({...e})=>{const[t,o]=d.useState([]),n=a=>{o(i=>[...i,a])},s=a=>{o(i=>i.filter(m=>m!==a))};return r.jsx("div",{style:{position:"fixed",height:"800px",width:"800px",backgroundColor:"white"},children:r.jsx("div",{style:{width:"800px",height:"300px",overflow:"auto",position:"absolute"},children:r.jsx(c,{id:e.id,...u(e),expandedIds:t,onExpand:n,onShrink:s,children:g.map(f)})})})},b=({...e})=>r.jsx(h,{maxWidth:"400px",children:r.jsx(c,{id:e.id,...u(e),children:g.map(p)})}),T=({...e})=>{const[t,o]=d.useState([]),n=u(e);return d.useEffect(()=>{setTimeout(()=>{o([{id:"2-1",label:"Document Category 2",nodes:[{id:"2-1-1",label:"Home",type:"document-page"},{id:"2-1-2",label:"Members",type:"document-page"},{id:"2-1-3",label:"About us",type:"document-page"}],type:"document-category",accepts:["document-page","document-page-within","document-category"].join(", ")}])},500)},[]),r.jsx(h,{maxWidth:"400px",children:r.jsxs(c,{id:e.id,...n,children:[g.map(p),t.map(p)]})})},Se=({...e})=>{const[t,o]=d.useState([]),[n]=xe(t),s=i=>{o([...t,i])},a=i=>{o(t.filter(m=>m!==i))};return r.jsxs(c,{id:e.id,...u(e),draggable:!0,expandedIds:t,onExpand:s,onShrink:a,children:[p({id:"first-fixed-tree-item",draggable:!1,label:"First Fixed TreeItem"}),n.length>0&&n.map(p),p({id:"last-fixed-tree-item",draggable:!1,label:"Last Fixed TreeItem"})]})},S=({...e})=>r.jsx(h,{maxWidth:"400px",children:r.jsx(Se,{...e,id:"dynamic-navigation"})}),he=d.memo(({label:e,numChildNodes:t,onDrop:o,...n})=>{const{isExpanded:s}=be(n.id),{nodes:a}=me(n.id,s),i=d.useMemo(()=>a.map(L=>L),[a]),m=()=>l("onDrop");return r.jsx(j,{contentComponent:r.jsx(pe,{title:e||"NO TITLE"}),onDrop:o??m,showCaret:!!t,...n,children:i.map(ge)})});he.displayName="FondueStoryLazyLoadingTreeItem";const ge=({id:e,...t})=>r.jsx(he,{id:`${e}-lazyloaded`,...t},`${e}-lazyloaded`),ye=d.memo(({...e})=>{const[t,o]=d.useState([]),{nodes:n}=me(void 0,!0,!0),s=m=>{o([...t,m])},a=m=>{o(t.filter(L=>L!==m))},i=()=>l("onDrop");return r.jsxs(c,{...e,draggable:!0,expandedIds:t,onExpand:s,onShrink:a,children:[p({id:"first-fixed-tree-item",draggable:!1,label:"First Fixed TreeItem",onDrop:i}),...n.map(ge),p({id:"last-fixed-tree-item",draggable:!1,label:"Last Fixed TreeItem",onDrop:i})]})});ye.displayName="FondueStoryLazyLoadingTreeRoot";const C=({...e})=>r.jsx(ye,{...u(e),id:"dynamic-navigation",children:null}),w=({...e})=>{const t=()=>l("onDrop");return r.jsx(h,{maxWidth:"400px",children:r.jsx(c,{id:e.id,...u(e),children:g.map(o=>f({...o,onDrop:t,ignoreItemDoubleClick:!0}))})})},W=({...e})=>{const t=()=>l("onDrop");return r.jsx(h,{maxWidth:"400px",children:r.jsx(c,{id:e.id,...u(e),children:g.map(o=>f({...o,onDrop:t,expandOnSelect:!0}))})})},Ce=e=>y(e),D=Ce.bind({});D.args={id:"storybook-tree",draggable:!0,selectedIds:["2"],dragHandlerPosition:"left",showDragHandlerOnHoverOnly:!0,showContentWhileDragging:!0,spacingY:"large",contentHight:"content-fit",shadow:"small",borderRadius:"large",borderWidth:"x-small",borderStyle:"solid",activeColorStyle:"soft"};y.__docgenInfo={description:"",methods:[],displayName:"WithLabel"};x.__docgenInfo={description:"",methods:[],displayName:"WithCustomTreeItem"};I.__docgenInfo={description:"",methods:[],displayName:"ScrollableWithLabel"};b.__docgenInfo={description:"",methods:[],displayName:"WithBasicItem"};T.__docgenInfo={description:"",methods:[],displayName:"WithAwaitedItem"};S.__docgenInfo={description:"",methods:[],displayName:"WithDynamicNavigation"};C.__docgenInfo={description:"",methods:[],displayName:"CustomItemsWithLazyLoadedChildren"};w.__docgenInfo={description:"",methods:[],displayName:"WithCancelSelectionOnDoubleClick"};W.__docgenInfo={description:"",methods:[],displayName:"WithExpandOnSelect"};var M,H,P;y.parameters={...y.parameters,docs:{...(M=y.parameters)==null?void 0:M.docs,source:{originalSource:`({
  ...args
}) => {
...
}`,...(te=(ee=C.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};var oe,re,ne;w.parameters={...w.parameters,docs:{...(oe=w.parameters)==null?void 0:oe.docs,source:{originalSource:`({
  ...args
}: TreeProps) => {
  const onDrop = () => action('onDrop');
  return <Container maxWidth="400px">
...
}`,...(ne=(re=w.parameters)==null?void 0:re.docs)==null?void 0:ne.source}}};var ae,ie,se;W.parameters={...W.parameters,docs:{...(ae=W.parameters)==null?void 0:ae.docs,source:{originalSource:`({
  ...args
}: TreeProps) => {
  const onDrop = () => action('onDrop');
  return <Container maxWidth="400px">
...
}`,...(le=(ce=D.parameters)==null?void 0:ce.docs)==null?void 0:le.source}}};const Pe=["WithLabel","WithCustomTreeItem","ScrollableWithLabel","WithBasicItem","WithAwaitedItem","WithDynamicNavigation","CustomItemsWithLazyLoadedChildren","WithCancelSelectionOnDoubleClick","WithExpandOnSelect","WithTreeItemsStyled"];export{C as CustomItemsWithLazyLoadedChildren,I as ScrollableWithLabel,T as WithAwaitedItem,b as WithBasicItem,w as WithCancelSelectionOnDoubleClick,x as WithCustomTreeItem,S as WithDynamicNavigation,W as WithExpandOnSelect,y as WithLabel,D as WithTreeItemsStyled,Pe as __namedExportsOrder,He as default};
