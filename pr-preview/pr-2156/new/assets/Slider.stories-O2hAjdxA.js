import{j as u}from"./jsx-runtime-Nms4Y4qS.js";import{r as c}from"./index-BwDkhjyp.js";import{L as Ue}from"./Label-Dm6TJ1JV.js";import{T as $e}from"./TextInput-PCS8TH18.js";import{c as De}from"./index-BdQq_4o_.js";import{c as _}from"./index-DOnKqARA.js";import{u as A,P as U}from"./index-BtCsUTRM.js";import{c as We}from"./index-BSNoMcJN.js";import{u as Ye}from"./index-DGaPG0k3.js";import{u as Ge}from"./index-C8IlRUt1.js";import{u as Xe}from"./index-BgCrdp81.js";import{u as Je}from"./index-kUwV4muI.js";import{c as Qe}from"./index-B0lKOUy8.js";import"./_commonjsHelpers-BosuxZz1.js";import"./styleUtilities-CZDH020m.js";import"./fondue-icons346-wUFpRcbj.js";import"./index-CS4BWtGh.js";import"./index-BnOD_KYf.js";var Ee=["PageUp","PageDown"],Me=["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"],je={"from-left":["Home","PageDown","ArrowDown","ArrowLeft"],"from-right":["Home","PageDown","ArrowDown","ArrowRight"],"from-bottom":["Home","PageDown","ArrowDown","ArrowLeft"],"from-top":["Home","PageDown","ArrowUp","ArrowLeft"]},D="Slider",[X,Ze,et]=Qe(D),[Ie,Ht]=We(D,[et]),[tt,$]=Ie(D),Ae=c.forwardRef((e,t)=>{const{name:r,min:n=0,max:a=100,step:s=1,orientation:o="horizontal",disabled:i=!1,minStepsBetweenThumbs:d=0,defaultValue:f=[n],value:g,onValueChange:l=()=>{},onValueCommit:m=()=>{},inverted:v=!1,form:x,...S}=e,h=c.useRef(new Set),p=c.useRef(0),y=o==="horizontal"?nt:rt,[b=[],M]=Ye({prop:g,defaultProp:f,onChange:w=>{var P;(P=[...h.current][p.current])==null||P.focus(),l(w)}}),W=c.useRef(b);function Y(w){const R=lt(b,w);j(w,R)}function qe(w){j(w,p.current)}function Oe(){const w=W.current[p.current];b[p.current]!==w&&m(b)}function j(w,R,{commit:P}={commit:!1}){const ee=mt(s),G=ft(Math.round((w-n)/s)*s+n,ee),I=De(G,[n,a]);M((V=[])=>{const C=st(V,I,R);if(ct(C,d*s)){p.current=C.indexOf(I);const te=String(C)!==String(V);return te&&P&&m(C),te?C:V}else return V})}return u.jsx(tt,{scope:e.__scopeSlider,name:r,disabled:i,min:n,max:a,valueIndexToChangeRef:p,thumbs:h.current,values:b,orientation:o,form:x,children:u.jsx(X.Provider,{scope:e.__scopeSlider,children:u.jsx(X.Slot,{scope:e.__scopeSlider,children:u.jsx(y,{"aria-disabled":i,"data-disabled":i?"":void 0,...S,ref:t,onPointerDown:_(S.onPointerDown,()=>{i||(W.current=b)}),min:n,max:a,inverted:v,onSlideStart:i?void 0:Y,onSlideMove:i?void 0:qe,onSlideEnd:i?void 0:Oe,onHomeKeyDown:()=>!i&&j(n,0,{commit:!0}),onEndKeyDown:()=>!i&&j(a,b.length-1,{commit:!0}),onStepKeyDown:({event:w,direction:R})=>{if(!i){const G=Ee.includes(w.key)||w.shiftKey&&Me.includes(w.key)?10:1,I=p.current,V=b[I],C=s*G*R;j(V+C,I,{commit:!0})}}})})})})});Ae.displayName=D;var[Be,ke]=Ie(D,{startEdge:"left",endEdge:"right",size:"width",direction:1}),nt=c.forwardRef((e,t)=>{const{min:r,max:n,dir:a,inverted:s,onSlideStart:o,onSlideMove:i,onSlideEnd:d,onStepKeyDown:f,...g}=e,[l,m]=c.useState(null),v=A(t,y=>m(y)),x=c.useRef(),S=Ge(a),h=S==="ltr",p=h&&!s||!h&&s;function T(y){const b=x.current||l.getBoundingClientRect(),M=[0,b.width],Y=Z(M,p?[r,n]:[n,r]);return x.current=b,Y(y-b.left)}return u.jsx(Be,{scope:e.__scopeSlider,startEdge:p?"left":"right",endEdge:p?"right":"left",direction:p?1:-1,size:"width",children:u.jsx(Ke,{dir:S,"data-orientation":"horizontal",...g,ref:v,style:{...g.style,"--radix-slider-thumb-transform":"translateX(-50%)"},onSlideStart:y=>{const b=T(y.clientX);o==null||o(b)},onSlideMove:y=>{const b=T(y.clientX);i==null||i(b)},onSlideEnd:()=>{x.current=void 0,d==null||d()},onStepKeyDown:y=>{const M=je[p?"from-left":"from-right"].includes(y.key);f==null||f({event:y,direction:M?-1:1})}})})}),rt=c.forwardRef((e,t)=>{const{min:r,max:n,inverted:a,onSlideStart:s,onSlideMove:o,onSlideEnd:i,onStepKeyDown:d,...f}=e,g=c.useRef(null),l=A(t,g),m=c.useRef(),v=!a;function x(S){const h=m.current||g.current.getBoundingClientRect(),p=[0,h.height],y=Z(p,v?[n,r]:[r,n]);return m.current=h,y(S-h.top)}return u.jsx(Be,{scope:e.__scopeSlider,startEdge:v?"bottom":"top",endEdge:v?"top":"bottom",size:"height",direction:v?1:-1,children:u.jsx(Ke,{"data-orientation":"vertical",...f,ref:l,style:{...f.style,"--radix-slider-thumb-transform":"translateY(50%)"},onSlideStart:S=>{const h=x(S.clientY);s==null||s(h)},onSlideMove:S=>{const h=x(S.clientY);o==null||o(h)},onSlideEnd:()=>{m.current=void 0,i==null||i()},onStepKeyDown:S=>{const p=je[v?"from-bottom":"from-top"].includes(S.key);d==null||d({event:S,direction:p?-1:1})}})})}),Ke=c.forwardRef((e,t)=>{const{__scopeSlider:r,onSlideStart:n,onSlideMove:a,onSlideEnd:s,onHomeKeyDown:o,onEndKeyDown:i,onStepKeyDown:d,...f}=e,g=$(D,r);return u.jsx(U.span,{...f,ref:t,onKeyDown:_(e.onKeyDown,l=>{l.key==="Home"?(o(l),l.preventDefault()):l.key==="End"?(i(l),l.preventDefault()):Ee.concat(Me).includes(l.key)&&(d(l),l.preventDefault())}),onPointerDown:_(e.onPointerDown,l=>{const m=l.target;m.setPointerCapture(l.pointerId),l.preventDefault(),g.thumbs.has(m)?m.focus():n(l)}),onPointerMove:_(e.onPointerMove,l=>{l.target.hasPointerCapture(l.pointerId)&&a(l)}),onPointerUp:_(e.onPointerUp,l=>{const m=l.target;m.hasPointerCapture(l.pointerId)&&(m.releasePointerCapture(l.pointerId),s(l))})})}),ze="SliderTrack",Ne=c.forwardRef((e,t)=>{const{__scopeSlider:r,...n}=e,a=$(ze,r);return u.jsx(U.span,{"data-disabled":a.disabled?"":void 0,"data-orientation":a.orientation,...n,ref:t})});Ne.displayName=ze;var J="SliderRange",Fe=c.forwardRef((e,t)=>{const{__scopeSlider:r,...n}=e,a=$(J,r),s=ke(J,r),o=c.useRef(null),i=A(t,o),d=a.values.length,f=a.values.map(m=>Le(m,a.min,a.max)),g=d>1?Math.min(...f):0,l=100-Math.max(...f);return u.jsx(U.span,{"data-orientation":a.orientation,"data-disabled":a.disabled?"":void 0,...n,ref:i,style:{...e.style,[s.startEdge]:g+"%",[s.endEdge]:l+"%"}})});Fe.displayName=J;var Q="SliderThumb",He=c.forwardRef((e,t)=>{const r=Ze(e.__scopeSlider),[n,a]=c.useState(null),s=A(t,i=>a(i)),o=c.useMemo(()=>n?r().findIndex(i=>i.ref.current===n):-1,[r,n]);return u.jsx(at,{...e,ref:s,index:o})}),at=c.forwardRef((e,t)=>{const{__scopeSlider:r,index:n,name:a,...s}=e,o=$(Q,r),i=ke(Q,r),[d,f]=c.useState(null),g=A(t,T=>f(T)),l=d?o.form||!!d.closest("form"):!0,m=Je(d),v=o.values[n],x=v===void 0?0:Le(v,o.min,o.max),S=it(n,o.values.length),h=m==null?void 0:m[i.size],p=h?ut(h,x,i.direction):0;return c.useEffect(()=>{if(d)return o.thumbs.add(d),()=>{o.thumbs.delete(d)}},[d,o.thumbs]),u.jsxs("span",{style:{transform:"var(--radix-slider-thumb-transform)",position:"absolute",[i.startEdge]:`calc(${x}% + ${p}px)`},children:[u.jsx(X.ItemSlot,{scope:e.__scopeSlider,children:u.jsx(U.span,{role:"slider","aria-label":e["aria-label"]||S,"aria-valuemin":o.min,"aria-valuenow":v,"aria-valuemax":o.max,"aria-orientation":o.orientation,"data-orientation":o.orientation,"data-disabled":o.disabled?"":void 0,tabIndex:o.disabled?void 0:0,...s,ref:g,style:v===void 0?{display:"none"}:e.style,onFocus:_(e.onFocus,()=>{o.valueIndexToChangeRef.current=n})})}),l&&u.jsx(ot,{name:a??(o.name?o.name+(o.values.length>1?"[]":""):void 0),form:o.form,value:v},n)]})});He.displayName=Q;var ot=e=>{const{value:t,...r}=e,n=c.useRef(null),a=Xe(t);return c.useEffect(()=>{const s=n.current,o=window.HTMLInputElement.prototype,d=Object.getOwnPropertyDescriptor(o,"value").set;if(a!==t&&d){const f=new Event("input",{bubbles:!0});d.call(s,t),s.dispatchEvent(f)}},[a,t]),u.jsx("input",{style:{display:"none"},...r,ref:n,defaultValue:t})};function st(e=[],t,r){const n=[...e];return n[r]=t,n.sort((a,s)=>a-s)}function Le(e,t,r){const s=100/(r-t)*(e-t);return De(s,[0,100])}function it(e,t){return t>2?`Value ${e+1} of ${t}`:t===2?["Minimum","Maximum"][e]:void 0}function lt(e,t){if(e.length===1)return 0;const r=e.map(a=>Math.abs(a-t)),n=Math.min(...r);return r.indexOf(n)}function ut(e,t,r){const n=e/2,s=Z([0,50],[0,n]);return(n-s(t)*r)*r}function dt(e){return e.slice(0,-1).map((t,r)=>e[r+1]-t)}function ct(e,t){if(t>0){const r=dt(e);return Math.min(...r)>=t}return!0}function Z(e,t){return r=>{if(e[0]===e[1]||t[0]===t[1])return t[0];const n=(t[1]-t[0])/(e[1]-e[0]);return t[0]+n*(r-e[0])}}function mt(e){return(String(e).split(".")[1]||"").length}function ft(e,t){const r=Math.pow(10,t);return Math.round(e*r)/r}var pt=Ae,gt=Ne,ht=Fe,bt=He;const St="_root_fs3zj_5",vt="_thumb_fs3zj_17",yt="_track_fs3zj_21",wt="_range_fs3zj_28",B={root:St,thumb:vt,track:yt,range:wt},xt=({value:e,defaultValue:t=[0],onChange:r,onCommit:n,"data-test-id":a="fondue-slider",...s},o)=>{const i=c.useRef(null);return u.jsxs(pt,{ref:o,className:B.root,value:e,defaultValue:t,onValueChange:r,onValueCommit:n,"data-test-id":a,...s,children:[u.jsx(gt,{onPointerDown:()=>{i.current&&(i.current.dataset.showFocusRing="false")},className:B.track,children:u.jsx(ht,{className:B.range})}),(e||t).map((d,f)=>u.jsx(bt,{ref:i,className:B.thumb,onPointerDown:g=>{g.currentTarget.dataset.showFocusRing="false"},onBlur:g=>{g.currentTarget.dataset.showFocusRing="true"}},f))]})},E=c.forwardRef(xt);E.displayName="Slider";E.__docgenInfo={description:"",methods:[],displayName:"Slider",props:{id:{required:!1,tsType:{name:"string"},description:""},name:{required:!1,tsType:{name:"string"},description:""},defaultValue:{required:!1,tsType:{name:"Array",elements:[{name:"number"}],raw:"number[]"},description:`The default value of the slider
...
}`,...(ie=(se=K.parameters)==null?void 0:se.docs)==null?void 0:ie.source}}};var le,ue,de;z.parameters={...z.parameters,docs:{...(le=z.parameters)==null?void 0:le.docs,source:{originalSource:`{
  args: {
    min: 50,
    max: 1000
  }
...
}`,...(ve=(Se=H.parameters)==null?void 0:Se.docs)==null?void 0:ve.source}}};var ye,we,xe;L.parameters={...L.parameters,docs:{...(ye=L.parameters)==null?void 0:ye.docs,source:{originalSource:`{
  render: args => {
