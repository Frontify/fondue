import{r as m,j as i}from"./iframe-DH_Vpvc8.js";import{b as W,$ as C,a as F}from"./useDialog-CG4u1SUI.js";import{$ as A}from"./FocusScope-C0gGXBZu.js";import{a as V}from"./useOverlayTriggerState-COk8Iisv.js";import{b as P}from"./chain-BXWUlVD-.js";import{$ as O}from"./useEffectEvent-ClEuPD_7.js";import{$ as M,b as k}from"./keyboard-Dm7GTj2e.js";import{u as G}from"./useFocusRing-CBL7_Hgl.js";import{m as w}from"./merge-DI-veSMP.js";import{S as _}from"./ScrollWrapper-B8ghzj8w.js";import{B as U,e as X}from"./Button-CRfrGFua.js";import{I as K}from"./IconSize-BcCrF_mi.js";import{F as Y,P as Z,b as J,p as Q}from"./FrontifyPattern-UxDlZxj7.js";import{A as ee}from"./index-JNMU5Ngj.js";import{m as L}from"./proxy-BE0try5U.js";function j(e,t){let a=e;for(M(a,t)&&(a=a.parentElement);a&&!M(a,t);)a=a.parentElement;return a||document.scrollingElement||document.documentElement}const y=typeof document<"u"&&window.visualViewport;let h=0,E;function te(e={}){let{isDisabled:t}=e;O(()=>{if(!t)return h++,h===1&&(G()?E=ne():E=ae()),()=>{h--,h===0&&E()}},[t])}function ae(){let e=window.innerWidth-document.documentElement.clientWidth;return P(e>0&&("scrollbarGutter"in document.documentElement.style?q(document.documentElement,"scrollbarGutter","stable"):q(document.documentElement,"paddingRight",`${e}px`)),q(document.documentElement,"overflow","hidden"))}function ne(){let e,t=!1,a=r=>{let o=r.target;e=M(o)?o:j(o,!0),t=!1;let u=o.ownerDocument.defaultView.getSelection();u&&!u.isCollapsed&&u.containsNode(o,!0)&&(t=!0),"selectionStart"in o&&"selectionEnd"in o&&o.selectionStart<o.selectionEnd&&o.ownerDocument.activeElement===o&&(t=!0)},n=document.createElement("style");n.textContent=`
@layer {
  * {
