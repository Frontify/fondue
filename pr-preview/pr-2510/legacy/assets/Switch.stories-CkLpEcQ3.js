import{r as c,j as P}from"./iframe-DxfotSS9.js";import{T as I}from"./TooltipIcon-DRNfXv40.js";import{I as _}from"./LegacyTooltip-BRORIEgS.js";import{S as z}from"./Switch-CoQEYtyM.js";import"./preload-helper-qBSLZfTS.js";import"./IconQuestionMarkCircle-B2qDKiRV.js";import"./IconSize-BcCrF_mi.js";import"./focusStyle-Ch_WJ4aJ.js";import"./merge-DI-veSMP.js";import"./useLink-D_fwx5cq.js";import"./useFocusable-BqelGtsA.js";import"./useFocusRing-Cl2cI3Lp.js";import"./useEffectEvent-D8_6AnRF.js";import"./chain-DM-najzk.js";import"./index-DpBu0Yu5.js";import"./usePopper-k_Qq_7j_.js";import"./index-GOXnEJ6I.js";import"./Button-CMmxZlIG.js";import"./useButton-To_o5pjp.js";import"./Portal-BqvWEzGw.js";import"./useMemoizedId-DPND1Hj9.js";import"./IconCheckMark-CRZ1v2hw.js";import"./IconExclamationMarkCircle24-BUygXcvA.js";import"./IconExclamationMarkTriangle-DWC4GrnU.js";import"./IconExclamationMarkTriangle24-BQSC-xnV.js";import"./InputLabel-yMo-9wjq.js";const H=["small","medium"],k=["on","off","indeterminate"],q=["default","heading"],ce={title:"Components/Switch",component:z,tags:["autodocs"],argTypes:{size:{options:H,control:{type:"radio"}},labelStyle:{options:q,control:{type:"radio"}},label:{placeholder:"Switch label",type:{name:"string",required:!1},control:{type:"text"}},mode:{options:k,control:{type:"radio"}},onChange:{table:{disable:!1},action:"Change"}},args:{mode:"on",disabled:!1,labelStyle:"default",hug:!1,name:"switch-name",size:"small"},parameters:{status:{type:"deprecated"},docs:{description:{component:"### This component is deprecated, please use the [new Switch component](/docs/current_components-switch--documentation) instead."}}}},o=e=>{const[d,m]=c.useState(e.mode||"off");c.useEffect(()=>{e.mode&&m(e.mode)},[e.mode]);const j=A=>{m(d==="on"?"off":"on"),e.onChange&&e.onChange(A)};return P.jsx(z,{...e,onChange:j,mode:d})},t=o.bind({});t.args={size:"small"};const n=o.bind({});n.args={size:"medium"};const s=o.bind({});s.args={label:"Switch label"};const r=o.bind({});r.args={label:"Switch label",tooltip:{content:"Switch tooltip"}};const a=o.bind({});a.args={label:"Switch label",tooltip:[{content:"First tooltip"},{content:"Second Tooltip",triggerIcon:P.jsx(_,{}),triggerStyle:I.Warning}]};const i=o.bind({});i.args={hug:!0,label:"Switch label"};var g,l,p;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:`(args: Props) => {
