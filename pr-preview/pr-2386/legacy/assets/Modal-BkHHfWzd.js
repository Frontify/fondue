import{j as n}from"./jsx-runtime-DF2Pcvd1.js";import{a as j,b as W,c as D}from"./useDialog-80Ilykdk.js";import{a as C}from"./FocusScope-BnEotdBu.js";import{a as F}from"./useOverlayTriggerState-BBiMiYGb.js";import{a as q}from"./chain-z5L_5vtA.js";import{$ as A}from"./useEffectEvent-BOE4tD14.js";import{$ as L}from"./isScrollable-BSEN4xi5.js";import{p as O}from"./useFocusRing-BL9DkcEN.js";import{r as l}from"./index-B2-qRKKC.js";import{m as b}from"./merge-DI-veSMP.js";import{a as V}from"./ScrollWrapper-BRXVXsWJ.js";import{c as G,B as _}from"./Button-B03MOMoD.js";import{I as U}from"./IconSize-BcCrF_mi.js";import{F as X,P as Y,b as K,p as Z}from"./FrontifyPattern-5PG0oenB.js";import{A as J}from"./index-D309HAth.js";import{m as z}from"./motion-bD4j9jgw.js";function H(e,t){let a=e;for(L(a,t)&&(a=a.parentElement);a&&!L(a,t);)a=a.parentElement;return a||document.scrollingElement||document.documentElement}const k=typeof document<"u"&&window.visualViewport,Q=new Set(["checkbox","radio","range","color","file","image","button","submit","reset"]);let g=0,E;function ee(e={}){let{isDisabled:t}=e;A(()=>{if(!t)return g++,g===1&&(O()?E=ae():E=te()),()=>{g--,g===0&&E()}},[t])}function te(){let e=window.innerWidth-document.documentElement.clientWidth;return q(e>0&&("scrollbarGutter"in document.documentElement.style?m(document.documentElement,"scrollbarGutter","stable"):m(document.documentElement,"paddingRight",`${e}px`)),m(document.documentElement,"overflow","hidden"))}function ae(){let e,t,a=s=>{e=H(s.target,!0),!(e===document.documentElement&&e===document.body)&&e instanceof HTMLElement&&window.getComputedStyle(e).overscrollBehavior==="auto"&&(t=m(e,"overscrollBehavior","contain"))},i=s=>{if(!e||e===document.documentElement||e===document.body){s.preventDefault();return}e.scrollHeight===e.clientHeight&&e.scrollWidth===e.clientWidth&&s.preventDefault()},u=()=>{t&&t()},o=s=>{let d=s.target;ne(d)&&(h(),d.style.transform="translateY(-2000px)",requestAnimationFrame(()=>{d.style.transform="",k&&(k.height<window.innerHeight?requestAnimationFrame(()=>{S(d)}):k.addEventListener("resize",()=>S(d),{once:!0}))}))},r=null,h=()=>{if(r)return;let s=()=>{window.scrollTo(0,0)},d=window.pageXOffset,v=window.pageYOffset;r=q(c(window,"scroll",s),m(document.documentElement,"paddingRight",`${window.innerWidth-document.documentElement.clientWidth}px`),m(document.documentElement,"overflow","hidden"),m(document.body,"marginTop",`-${v}px`),()=>{window.scrollTo(d,v)}),window.scrollTo(0,0)},w=q(c(document,"touchstart",a,{passive:!1,capture:!0}),c(document,"touchmove",i,{passive:!1,capture:!0}),c(document,"touchend",u,{passive:!1,capture:!0}),c(document,"focus",o,!0));return()=>{t==null||t(),r==null||r(),w()}}function m(e,t,a){let i=e.style[t];return e.style[t]=a,()=>{e.style[t]=i}}function c(e,t,a,i){return e.addEventListener(t,a,i),()=>{e.removeEventListener(t,a,i)}}function S(e){let t=document.scrollingElement||document.documentElement,a=e;for(;a&&a!==t;){let i=H(a);if(i!==document.documentElement&&i!==document.body&&i!==a){let u=i.getBoundingClientRect().top,o=a.getBoundingClientRect().top;o>u+a.clientHeight&&(i.scrollTop+=o-u)}a=i.parentElement}}function ne(e){return e instanceof HTMLInputElement&&!Q.has(e.type)||e instanceof HTMLTextAreaElement||e instanceof HTMLElement&&e.isContentEditable}const B={default:{top:"tw-pt-14",horizontal:"tw-px-14",bottom:"tw-pb-14"},compact:{top:"tw-pt-6",horizontal:"tw-px-6",bottom:"tw-pb-6"}},f=l.createContext({compact:!1,padding:B.default});f.displayName="ModalLayoutContext";const M=({direction:e,children:t,horizontalPadding:a=!0})=>{const{padding:i}=l.useContext(f);return n.jsx("div",{"data-test-id":"modal-body",className:`tw-flex-auto tw-min-h-0 ${a?i.horizontal:"tw-pr-2"}`,children:n.jsx(V,{direction:e,children:t})})};M.displayName="FondueModalBody";M.__docgenInfo={description:"@deprecated Use `Dialog.Body` from `@frontify/fondue/components` instead. Also check {@link https://github.com/Frontify/fondue/blob/main/packages/components/MIGRATING.md#dialog the migration guide}.",methods:[],displayName:"FondueModalBody",props:{direction:{required:!1,tsType:{name:"ScrollWrapperDirection"},description:""},children:{required:!1,tsType:{name:"union",raw:"ReactElement | ReactElement[]",elements:[{name:"ReactElement"},{name:"Array",elements:[{name:"ReactElement"}],raw:"ReactElement[]"}]},description:""},horizontalPadding:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}}}};const x=({buttons:e})=>{const{padding:t}=l.useContext(f);return n.jsx("div",{"data-test-id":"modal-footer",className:`${t.bottom} ${t.horizontal}`,children:e&&n.jsx("div",{className:"tw-flex tw-gap-x-3 tw-justify-end",children:e.map((a,i)=>l.createElement(G,{...a,size:_.Medium,key:i}))})})};x.displayName="FondueModalFooter";x.__docgenInfo={description:"@deprecated Use `Dialog.Footer` from `@frontify/fondue/components` instead. Also check {@link https://github.com/Frontify/fondue/blob/main/packages/components/MIGRATING.md#dialog the migration guide}.",methods:[],displayName:"FondueModalFooter",props:{buttons:{required:!0,tsType:{name:"union",raw:"[ModalButton] | [ModalButton, ModalButton]",elements:[{name:"tuple",raw:"[ModalButton]",elements:[{name:"Omit",elements:[{name:"signature",type:"object",raw:`{
    type?: ButtonType;
    title?: string;
    style?: ButtonStyle;
