import{j as e,r as c}from"./iframe-Ty-u12G_.js";import{a as V,b as W}from"./chain-BHGxKHSf.js";import{m as A}from"./merge-DI-veSMP.js";import{T as Y,a as L,b as H,c as M,d as k,e as P,f as R}from"./Tree-CEOylsv4.js";import{T as F}from"./TreeItem-CDPd8y48.js";import"./preload-helper-B_jBegVy.js";import"./useLayoutEffect-pJB3k99z.js";import"./focusStyle-hm6eSJHh.js";import"./index-gz1kNy6S.js";import"./index-IBvwm2LM.js";import"./fondue-icons369-Fp3dKR-P.js";var r=(n=>(n.Violet="Violet",n.Green="Green",n.Red="Red",n))(r||{});const K={[r.Violet]:"tw-text-violet-60",[r.Green]:"tw-text-green-60",[r.Red]:"tw-text-red-60"},a=({color:n,children:t})=>e.jsx("span",{className:A(["tw-font-medium",K[n]]),children:t}),z=[{id:"1",textContent:e.jsxs("p",{children:["The list rendering is completely customizable through the  ",e.jsx(a,{color:r.Green,children:"renderContent"})," callback prop, but also"," ",e.jsx(a,{color:r.Violet,children:"Tree"})," component functionality can be used for styling."]}),alt:"one",sort:1},{id:"3",textContent:e.jsxs("p",{children:["Use the ",e.jsx(a,{color:r.Green,children:"sort"})," property in the  ",e.jsx(a,{color:r.Green,children:"OrderableListItem"})," to determine the position of items items in the list."]}),alt:"three",sort:2},{id:"4",textContent:e.jsx("p",{children:"Items can contain multiple focusable elements."}),alt:"four",sort:null},{id:"7",textContent:e.jsxs("p",{children:["The dragHandler can be positioned to the ",e.jsx(a,{color:r.Green,children:"left"}),","," ",e.jsx(a,{color:r.Green,children:"right"}),", or"," ",e.jsx(a,{color:r.Green,children:"hide (none)"}),". When the setting is drag handler is set to ",e.jsx(a,{color:r.Green,children:"none"})," means that the whole lit item is draggable, otherwise only dragging from the handler will do the job."]}),alt:"seven",sort:3}],N=({textContent:n,id:t,onSelect:s})=>{const i=l=>{l.key==="Enter"&&s(t)};return e.jsxs("div",{role:"button",tabIndex:0,className:"tw-break-words tw-border tw-border-line tw-border-solid tw-rounded-md tw-p-3 tw-outline-none",onClick:()=>s(t),onKeyDown:i,children:[e.jsxs("div",{className:"tw-text-xs tw-text-black-60",children:["id: ",t]}),e.jsx("hr",{className:"tw-mt-2 tw-mb-2 tw-border-black-20 tw-bg-black-20"}),e.jsx("div",{children:n})]})};N.__docgenInfo={description:"",methods:[],displayName:"renderContent",props:{textContent:{required:!0,tsType:{name:"JSX.Element"},description:""},id:{required:!0,tsType:{name:"string"},description:""},onSelect:{required:!0,tsType:{name:"signature",type:"function",raw:"(id: string) => void",signature:{arguments:[{type:{name:"string"},name:"id"}],return:{name:"void"}}},description:""}}};const B=(n,t)=>n.sort===null&&t.sort===null||n.sort===null?1:t.sort===null?-1:n.sort-t.sort,J=(n,t,s)=>{const i=s.find(l=>l.id===n);return i?[{...i,sort:t}]:[]},w=({onMove:n,dragDisabled:t,items:s,dragHandlerPosition:i="none",enableDragDelay:l=!0,itemStyle:y,selectedId:b,renderContent:x,"data-test-id":f="orderable-list"})=>{const[h,v]=c.useState(s),C=V(),m=!t;c.useEffect(()=>{const o=[...s];o.sort(B),v(o)},[s]);const j=o=>{n(J(o.id,o.sort,h))},p=c.useMemo(()=>({spacingY:"small",contentHight:"content-fit",shadow:"small",borderRadius:"medium",borderWidth:"x-small",borderStyle:"solid",activeColorStyle:"soft",...y}),[y]);return e.jsx(Y,{draggable:m,id:C,onDrop:j,"data-test-id":f,selectedIds:b?[b]:[],itemStyle:p,showDragHandlerOnHoverOnly:!m,dragHandlerPosition:m?i:"none",showContentWhileDragging:!0,enableDragDelay:l,children:h.map(o=>{const I=`collection-item-${o.id}`;return e.jsx(F,{"data-test-id":`${f}-item`,id:o.id,type:"collection-item",accepts:"collection-item",expandable:!1,levelConstraint:0,contentComponent:x(o)},I)})})};w.displayName="FondueOrderableList";w.__docgenInfo={description:"",methods:[],displayName:"FondueOrderableList",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"intersection",raw:`DraggableItem<T> & {
    alt: string;
...
}`,...(G=(E=g.parameters)==null?void 0:E.docs)==null?void 0:G.source}}};const le=["OrderableList"];export{g as OrderableList,le as __namedExportsOrder,ae as default};
