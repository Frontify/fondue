import{r as m,j as i}from"./iframe-BsrH74wW.js";import{b as W,$ as C,a as F}from"./useDialog-CPGsUaen.js";import{$ as A}from"./FocusScope-D-MiZ49_.js";import{a as V}from"./useOverlayTriggerState-CQObmmI1.js";import{b as P}from"./chain-F-BtQllU.js";import{$ as O}from"./useEffectEvent-BNtJsWpB.js";import{$ as M,b as k}from"./keyboard-DY2UNgnm.js";import{u as G}from"./useFocusRing-hWS3vXVU.js";import{m as w}from"./merge-DI-veSMP.js";import{S as _}from"./ScrollWrapper-P6xaaaHu.js";import{B as U,e as X}from"./Button-Ca7IJx5d.js";import{I as K}from"./IconSize-BcCrF_mi.js";import{F as Y,P as Z,b as J,p as Q}from"./FrontifyPattern-BqLXEs9x.js";import{A as ee}from"./index-Das9SwiT.js";import{m as L}from"./proxy-D1wxvBJp.js";function j(e,t){let a=e;for(M(a,t)&&(a=a.parentElement);a&&!M(a,t);)a=a.parentElement;return a||document.scrollingElement||document.documentElement}const y=typeof document<"u"&&window.visualViewport;let h=0,E;function te(e={}){let{isDisabled:t}=e;O(()=>{if(!t)return h++,h===1&&(G()?E=ne():E=ae()),()=>{h--,h===0&&E()}},[t])}function ae(){let e=window.innerWidth-document.documentElement.clientWidth;return P(e>0&&("scrollbarGutter"in document.documentElement.style?q(document.documentElement,"scrollbarGutter","stable"):q(document.documentElement,"paddingRight",`${e}px`)),q(document.documentElement,"overflow","hidden"))}function ne(){let e,t=!1,a=r=>{let o=r.target;e=M(o)?o:j(o,!0),t=!1;let u=o.ownerDocument.defaultView.getSelection();u&&!u.isCollapsed&&u.containsNode(o,!0)&&(t=!0),"selectionStart"in o&&"selectionEnd"in o&&o.selectionStart<o.selectionEnd&&o.ownerDocument.activeElement===o&&(t=!0)},n=document.createElement("style");n.textContent=`
@layer {
  * {
