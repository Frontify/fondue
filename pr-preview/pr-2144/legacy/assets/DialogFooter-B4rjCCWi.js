import{j as e}from"./jsx-runtime-Nms4Y4qS.js";import{B as t}from"./Box-DUobCvly.js";import{B as l,c,a as f}from"./Button-BBdFcQ_2.js";import{F as y}from"./Flex-8mjM_2n0.js";import{I as v}from"./IconArrowLeft-CK1u11Y9.js";import{u as g}from"./Tooltip-BlJs8OXG.js";import{m as u}from"./merge-DI-veSMP.js";import{d as b}from"./dialog-Dre1eVQK.js";const d=({actionButtons:n,children:r,backButton:i,padding:m="comfortable",separator:p=!0,"data-test-id":a="fondue-dialog-footer"})=>{const o=g();return e.jsxs(t,{"data-test-id":a,className:u(["tw-border-t tw-border-t-line",b[m],!p&&"tw-pt-0 tw-border-none"]),children:[o&&e.jsx(t,{className:u(["tw-w-full",i||n.length>0?"tw-pb-2":""]),"data-test-id":`${a}-content`,children:r}),e.jsxs(y,{justify:"between",alignItems:"center",spacingX:12,children:[i&&e.jsx(l,{"data-test-id":`${a}-back-button`,...i,emphasis:c.Default,icon:e.jsx(v,{})}),!o&&e.jsx(t,{className:"tw-grow","data-test-id":`${a}-content`,children:r}),n.length>0?e.jsx(t,{className:"tw-flex tw-gap-x-3","data-test-id":`${a}-action-buttons`,children:n.map(s=>e.jsx(l,{...s,size:f.Medium},`${a}-button-${s.children}`))}):null]})]})};d.displayName="FondueDialogFooter";d.__docgenInfo={description:"@deprecated Use `Dialog` from `@frontify/fondue/components` instead. Also check {@link https://github.com/Frontify/fondue/blob/main/packages/components/MIGRATING.md#dialog the migration guide}.",methods:[],displayName:"FondueDialogFooter",props:{children:{required:!1,tsType:{name:"ReactNode"},description:""},actionButtons:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type?: ButtonType;
    title?: string;
    style?: ButtonStyle;
