import{j as e}from"./jsx-runtime-Nms4Y4qS.js";import{$ as _,a as V}from"./chain-CSFqNvhK.js";import{r as m}from"./index-BwDkhjyp.js";import{m as Y}from"./merge-DI-veSMP.js";import{T as q,a as D,b as N,c as L,d as P,e as H}from"./ExpandButton-DbY3d-Fg.js";import{T as z}from"./Tree-BmY49tx_.js";import{T as A}from"./TreeItem-Bb1Fivie.js";import"./SSRProvider-CYXx33DY.js";import"./_commonjsHelpers-BosuxZz1.js";import"./focusStyle-CBFElZiz.js";import"./index-CS4BWtGh.js";import"./immer-DBm1MMjE.js";import"./index-CfyPTyT-.js";import"./IconGrabHandle12-OyP2wwdJ.js";import"./useDebounce-CC5nrT7M.js";import"./noop-DX6rZLP_.js";const F=(n,t)=>n.sort===null&&t.sort===null||n.sort===null?1:t.sort===null?-1:n.sort-t.sort,B=(n,t,l)=>{const i=l.find(o=>o.id===n);return i?[{...i,sort:t}]:[]},w=({onMove:n,dragDisabled:t,items:l,dragHandlerPosition:i="none",enableDragDelay:o=!0,itemStyle:y,selectedId:b,renderContent:S,"data-test-id":f="orderable-list"})=>{const[v,x]=m.useState(l),T=_(),u=!t;m.useEffect(()=>{const a=[...l];a.sort(F),x(a)},[l]);const C=a=>{n(B(a.id,a.sort,v))},c=m.useMemo(()=>({spacingY:"small",contentHight:"content-fit",shadow:"small",borderRadius:"medium",borderWidth:"x-small",borderStyle:"solid",activeColorStyle:"soft",...y}),[y]);return e.jsx(z,{draggable:u,id:T,onDrop:C,"data-test-id":f,selectedIds:b?[b]:[],itemStyle:c,showDragHandlerOnHoverOnly:!u,dragHandlerPosition:u?i:"none",showContentWhileDragging:!0,enableDragDelay:o,children:v.map(a=>{const h=`collection-item-${a.id}`;return e.jsx(A,{"data-test-id":`${f}-item`,id:a.id,type:"collection-item",accepts:"collection-item",expandable:!1,levelConstraint:0,contentComponent:S(a)},h)})})};w.displayName="FondueOrderableList";w.__docgenInfo={description:"",methods:[],displayName:"FondueOrderableList",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"intersection",raw:`DraggableItem<T> & {
    alt: string;
    ...
    alt: string;
}`,signature:{properties:[{key:"alt",value:{name:"string",required:!0}}]}}]},name:"items"}],return:{name:"ReactElement"}}},description:""},"data-test-id":{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'orderable-list'",computed:!1}},enableDragDelay:{defaultValue:{value:"true",computed:!1},required:!1}}};var r=(n=>(n.Violet="Violet",n.Green="Green",n.Red="Red",n))(r||{});const K={[r.Violet]:"tw-text-violet-60",[r.Green]:"tw-text-green-60",[r.Red]:"tw-text-red-60"},s=({color:n,children:t})=>e.jsx("span",{className:Y(["tw-font-medium",K[n]]),children:t}),J=[{id:"1",textContent:e.jsxs("p",{children:["The list rendering is completely customizable through the  ",e.jsx(s,{color:r.Green,children:"renderContent"})," callback prop, but also"," ",e.jsx(s,{color:r.Violet,children:"Tree"})," component functionality can be used for styling."]}),alt:"one",sort:1},{id:"3",textContent:e.jsxs("p",{children:["Use the ",e.jsx(s,{color:r.Green,children:"sort"})," property in the  ",e.jsx(s,{color:r.Green,children:"OrderableListItem"})," to determine the position of items items in the list."]}),alt:"three",sort:2},{id:"4",textContent:e.jsx("p",{children:"Items can contain multiple focusable elements."}),alt:"four",sort:null},{id:"7",textContent:e.jsxs("p",{children:["The dragHandler can be positioned to the ",e.jsx(s,{color:r.Green,children:"left"}),","," ",e.jsx(s,{color:r.Green,children:"right"}),", or"," ",e.jsx(s,{color:r.Green,children:"hide (none)"}),". When the setting is drag handler is set to ",e.jsx(s,{color:r.Green,children:"none"})," means that the whole lit item is draggable, otherwise only dragging from the handler will do the job."]}),alt:"seven",sort:3}],G=({textContent:n,id:t,onSelect:l})=>{const i=o=>{o.key==="Enter"&&l(t)};return e.jsxs("div",{className:"tw-break-word tw-border tw-border-black-40 tw-border-solid tw-rounded-md tw-p-3 tw-outline-none tw-border-line",onClick:()=>l(t),onKeyDown:i,children:[e.jsxs("div",{className:"tw-text-xs tw-text-black-60",children:["id: ",t]}),e.jsx("hr",{className:"tw-mt-2 tw-mb-2 tw-border-black-20 tw-bg-black-20"}),e.jsx("div",{children:n})]})};G.__docgenInfo={description:"",methods:[],displayName:"renderContent",props:{textContent:{required:!0,tsType:{name:"JSX.Element"},description:""},id:{required:!0,tsType:{name:"string"},description:""},onSelect:{required:!0,tsType:{name:"signature",type:"function",raw:"(id: string) => void",signature:{arguments:[{type:{name:"string"},name:"id"}],return:{name:"void"}}},description:""}}};const ce={title:"Components/Orderable List",component:w,tags:["autodocs"],args:{dragDisabled:!1,dragHandlerPosition:"right",enableDragDelay:!0,spacingY:"small",contentHight:"content-fit",shadow:"small",borderRadius:"medium",borderWidth:"x-small",borderStyle:"solid",activeColorStyle:"soft",selectedId:"3"},argTypes:{onMove:{action:"onMove"},selectedId:{type:"string"},dragHandlerPosition:{table:{category:"Item Options"},options:["left","right","none"],control:{type:"inline-radio"}},enableDragDelay:{table:{category:"Item Options"},defaultValue:!0,control:{type:"boolean"}},spacingY:{table:{category:"Item Style"},name:"itemStyle.spacingY",options:[...Object.keys(q)],mapping:[...Object.values(q)],control:{type:"inline-radio"}},contentHight:{table:{category:"Item Style"},name:"itemStyle.contentHight",options:["content-fit","single-line"],control:{type:"inline-radio"}},shadow:{table:{category:"Item Style"},name:"itemStyle.shadow",options:[...Object.keys(D)],mapping:[...Object.values(D)],control:{type:"inline-radio"}},borderRadius:{table:{category:"Item Style"},name:"itemStyle.borderRadius",options:[...Object.keys(N)],mapping:[...Object.values(N)],control:{type:"inline-radio"}},borderWidth:{table:{category:"Item Style"},name:"itemStyle.borderWidth",options:[...Object.keys(L)],mapping:[...Object.values(L)],control:{type:"inline-radio"}},borderStyle:{table:{category:"Item Style"},name:"itemStyle.borderStyle",options:[...Object.keys(P)],mapping:[...Object.values(P)],control:{type:"inline-radio"}},activeColorStyle:{table:{category:"Item Style"},name:"itemStyle.activeColorStyle",options:[...Object.keys(H)],mapping:[...Object.values(H)],control:{type:"inline-radio"}}}},g=({onMove:n,selectedId:t,dragDisabled:l,dragHandlerPosition:i,enableDragDelay:o,spacingY:y,contentHight:b,shadow:S,borderRadius:f,borderWidth:v,borderStyle:x,activeColorStyle:T})=>{const[u,C]=m.useState(J),c=m.useRef(t),[a,h]=m.useState(t);m.useEffect(()=>{c.current!==t&&(c.current=t,h(t))},[t,c]);const W=d=>{if(d.length===0)return;const I=d[0],p=[];let j=1,k=!0;for(const O of u)O.id!==I.id&&(p.length-1===I.sort&&(p.push(I),j++,k=!1),p.push({...O,sort:j}),j++);k&&p.push(I),C(p)},$=d=>{h(d)};return e.jsx("div",{className:"tw-m-auto tw-w-[600px] tw-pb-6",children:e.jsx(w,{items:u,onMove:V(W,n),dragDisabled:l,dragHandlerPosition:i,enableDragDelay:o,selectedId:a,itemStyle:{spacingY:y,contentHight:b,shadow:S,borderRadius:f,borderWidth:v,borderStyle:x,activeColorStyle:T},renderContent:(...d)=>G({textContent:d[0].textContent,id:d[0].id,onSelect:$})})})};g.__docgenInfo={description:"",methods:[],displayName:"OrderableList"};var M,R,E;g.parameters={...g.parameters,docs:{...(M=g.parameters)==null?void 0:M.docs,source:{originalSource:`({
  onMove,
  selectedId,
  dragDisabled,
  dragHandlerPosition,
...
}`,...(E=(R=g.parameters)==null?void 0:R.docs)==null?void 0:E.source}}};const pe=["OrderableList"];export{g as OrderableList,pe as __namedExportsOrder,ce as default};
