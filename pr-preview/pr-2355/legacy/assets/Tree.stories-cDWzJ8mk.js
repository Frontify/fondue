...
}`,...(Q=(K=q.parameters)==null?void 0:K.docs)==null?void 0:Q.source}}};var X,Z,ee;I.parameters={...I.parameters,docs:{...(X=I.parameters)==null?void 0:X.docs,source:{originalSource:`({
  ...args
}: TreeProps) => {
  return <Container maxWidth="400px">
            <DynamicNavigation {...args} id="dynamic-navigation" />
        </Container>;
}`,...(ee=(Z=I.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var ae,ne,re;w.parameters={...w.parameters,docs:{...(ae=w.parameters)==null?void 0:ae.docs,source:{originalSource:`({
  ...args
}: TreeProps) => {
  return <LazyLoadingTreeRoot {...cleanProps(args)} id="dynamic-navigation">
            {null}
        </LazyLoadingTreeRoot>;
}`,...(re=(ne=w.parameters)==null?void 0:ne.docs)==null?void 0:re.source}}};var te,le,ie;k.parameters={...k.parameters,docs:{...(te=k.parameters)==null?void 0:te.docs,source:{originalSource:`({
  ...args
}: TreeProps) => {
  const onDrop = useCallback(() => action('onDrop'), []);
  return <Container maxWidth="400px">
...
}`,...(ye=(ce=C.parameters)==null?void 0:ce.docs)==null?void 0:ye.source}}};const Ca=["WithLabel","WithCustomTreeItem","ScrollableWithLabel","WithBasicItem","WithAwaitedItem","WithDynamicNavigation","CustomItemsWithLazyLoadedChildren","WithCancelSelectionOnDoubleClick","WithExpandOnSelect","InsideInlineDialog","WithTreeItemsStyled"];export{w as CustomItemsWithLazyLoadedChildren,N as InsideInlineDialog,x as ScrollableWithLabel,q as WithAwaitedItem,h as WithBasicItem,k as WithCancelSelectionOnDoubleClick,f as WithCustomTreeItem,I as WithDynamicNavigation,S as WithExpandOnSelect,b as WithLabel,C as WithTreeItemsStyled,Ca as __namedExportsOrder,Na as default};
