import{j as e}from"./jsx-runtime-DF2Pcvd1.js";import{$ as _,a as V}from"./chain-z5L_5vtA.js";import{r as m}from"./index-B2-qRKKC.js";import{m as Y}from"./merge-DI-veSMP.js";import{f as z,T as q,a as D,b as N,c as L,d as P,e as H}from"./Tree-CqQ8tOBa.js";import{T as A}from"./TreeItem-CGO5FxAj.js";import"./useEffectEvent-BOE4tD14.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./focusStyle-BtNTXUM4.js";import"./index-CFX93qP1.js";import"./_Uint8Array-BOVeyo6w.js";import"./index-DlnOb27V.js";import"./useDebounce-SACYbSE1.js";const F=(n,t)=>n.sort===null&&t.sort===null||n.sort===null?1:t.sort===null?-1:n.sort-t.sort,B=(n,t,l)=>{const i=l.find(o=>o.id===n);return i?[{...i,sort:t}]:[]},w=({onMove:n,dragDisabled:t,items:l,dragHandlerPosition:i="none",enableDragDelay:o=!0,itemStyle:y,selectedId:b,renderContent:S,"data-test-id":f="orderable-list"})=>{const[v,x]=m.useState(l),C=_(),u=!t;m.useEffect(()=>{const a=[...l];a.sort(F),x(a)},[l]);const T=a=>{n(B(a.id,a.sort,v))},c=m.useMemo(()=>({spacingY:"small",contentHight:"content-fit",shadow:"small",borderRadius:"medium",borderWidth:"x-small",borderStyle:"solid",activeColorStyle:"soft",...y}),[y]);return e.jsx(z,{draggable:u,id:C,onDrop:T,"data-test-id":f,selectedIds:b?[b]:[],itemStyle:c,showDragHandlerOnHoverOnly:!u,dragHandlerPosition:u?i:"none",showContentWhileDragging:!0,enableDragDelay:o,children:v.map(a=>{const h=`collection-item-${a.id}`;return e.jsx(A,{"data-test-id":`${f}-item`,id:a.id,type:"collection-item",accepts:"collection-item",expandable:!1,levelConstraint:0,contentComponent:S(a)},h)})})};w.displayName="FondueOrderableList";w.__docgenInfo={description:"",methods:[],displayName:"FondueOrderableList",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"intersection",raw:`DraggableItem<T> & {
    alt: string;
...
}`,...(E=(R=g.parameters)==null?void 0:R.docs)==null?void 0:E.source}}};const me=["OrderableList"];export{g as OrderableList,me as __namedExportsOrder,de as default};
