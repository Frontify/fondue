import{j as M}from"./jsx-runtime-DF2Pcvd1.js";import{m as Y}from"./merge-DI-veSMP.js";import{r as T}from"./index-B2-qRKKC.js";import{b as pe}from"./MenuItem-DgG-AEwR.js";import{n as W,o as Te,$ as Me}from"./useFocusRing-BL9DkcEN.js";import{c as J,b as K,d as ye,$ as fe,h as Ee,e as ge,f as be}from"./useFocusable-ChjCOJSh.js";import{b as F,$ as he}from"./chain-z5L_5vtA.js";import{$ as ke,c as we,a as Le,d as He,g as xe,e as Ae,m as qe,f as $e}from"./helper-DOAGjx3a.js";import{d as Be}from"./focusStyle-BtNTXUM4.js";import{S as Ie}from"./Switch-DDWwL_vA.js";import{$ as Se,a as Pe,b as Fe}from"./SelectionManager-CwM1DjHu.js";import{$ as Ce}from"./useControlledState-CmdEzstM.js";const O=T.forwardRef(({ariaProps:e,children:t,scrollable:n=!1,border:a=!0},o)=>M.jsx("ul",{...e,ref:o,className:Y(["tw-list-none tw-p-0 tw-m-0 tw-bg-base tw-z-20 focus-visible:tw-outline-none",a&&"tw-border tw-border-line tw-rounded",n&&"tw-overflow-y-auto"]),children:t}));O.displayName="FondueAriaList";O.__docgenInfo={description:"",methods:[],displayName:"FondueAriaList",props:{scrollable:{defaultValue:{value:"false",computed:!1},required:!1},border:{defaultValue:{value:"true",computed:!1},required:!1}}};const Q=new WeakMap;function Ke(e,t,n){let{shouldFocusWrap:a=!0,onKeyDown:o,onKeyUp:u,...l}=e;!e["aria-label"]&&e["aria-labelledby"];let s=J(e,{labelable:!0}),{listProps:i}=ke({...l,ref:n,selectionManager:t.selectionManager,collection:t.collection,disabledKeys:t.disabledKeys,shouldFocusWrap:a,linkBehavior:"override"});return Q.set(t,{onClose:e.onClose,onAction:e.onAction,shouldUseVirtualFocus:e.shouldUseVirtualFocus}),{menuProps:K(s,{onKeyDown:o,onKeyUp:u},{role:"menu",...i,onKeyDown:c=>{var v;(c.key!=="Escape"||e.shouldUseVirtualFocus)&&((v=i.onKeyDown)===null||v===void 0||v.call(i,c))}})}}function Oe(e,t,n){let{id:a,key:o,closeOnSelect:u,isVirtualized:l,"aria-haspopup":s,onPressStart:i,onPressUp:c,onPress:v,onPressChange:y,onPressEnd:h,onClick:f,onHoverStart:E,onHoverChange:g,onHoverEnd:x,onKeyDown:H,onKeyUp:q,onFocus:$,onFocusChange:Z,onBlur:ee,selectionManager:m=t.selectionManager}=e,p=!!s,B=p&&e["aria-expanded"]==="true";var I;let b=(I=e.isDisabled)!==null&&I!==void 0?I:m.isDisabled(o);var S;let j=(S=e.isSelected)!==null&&S!==void 0?S:m.isSelected(o),k=Q.get(t),d=t.collection.getItem(o),w=e.onClose||k.onClose,ne=ye(),te=()=>{var r;if(!p&&(!(d==null||(r=d.props)===null||r===void 0)&&r.onAction?d.props.onAction():e.onAction&&e.onAction(o),k.onAction)){let ve=k.onAction;ve(o)}},P="menuitem";p||(m.selectionMode==="single"?P="menuitemradio":m.selectionMode==="multiple"&&(P="menuitemcheckbox"));let z=F(),V=F(),_=F(),A={id:a,"aria-disabled":b||void 0,role:P,"aria-label":e["aria-label"],"aria-labelledby":z,"aria-describedby":[V,_].filter(Boolean).join(" ")||void 0,"aria-controls":e["aria-controls"],"aria-haspopup":s,"aria-expanded":e["aria-expanded"]};m.selectionMode!=="none"&&!p&&(A["aria-checked"]=j),l&&(A["aria-posinset"]=d==null?void 0:d.index,A["aria-setsize"]=we(t.collection));let oe=r=>{r.pointerType==="keyboard"&&!m.isLink(o)&&r.target.click(),i==null||i(r)},D=T.useRef(!1),ae=r=>{y==null||y(r),D.current=r},re=r=>{r.pointerType==="mouse"&&(D.current||r.target.click()),r.pointerType!=="keyboard"&&!p&&w&&(u??(m.selectionMode!=="multiple"||m.isLink(o)))&&w(),c==null||c(r)},ie=r=>{f==null||f(r),te(),be(r,ne,d.props.href,d==null?void 0:d.props.routerOptions)},{itemProps:L,isFocused:U}=Le({id:a,selectionManager:m,key:o,ref:n,shouldSelectOnPressUp:!0,allowsDifferentPressOrigin:!0,linkBehavior:"none",shouldUseVirtualFocus:k.shouldUseVirtualFocus}),{pressProps:se,isPressed:le}=fe({onPressStart:oe,onPress:v,onPressUp:re,onPressChange:ae,onPressEnd:h,isDisabled:b}),{hoverProps:ue}=He({isDisabled:b,onHoverStart(r){!W()&&!(B&&s)&&(m.setFocused(!0),m.setFocusedKey(o)),E==null||E(r)},onHoverChange:g,onHoverEnd:x}),{keyboardProps:de}=Ee({onKeyDown:r=>{if(r.repeat){r.continuePropagation();return}switch(r.key){case" ":!b&&m.selectionMode==="none"&&!p&&u!==!1&&w&&w();break;case"Enter":!b&&u!==!1&&!p&&w&&w();break;default:p||r.continuePropagation(),H==null||H(r);break}},onKeyUp:q}),{focusProps:ce}=Te({onBlur:ee,onFocus:$,onFocusChange:Z}),G=J(d==null?void 0:d.props);delete G.id;let me=ge(d==null?void 0:d.props);return{menuItemProps:{...A,...K(G,me,p?{onFocus:L.onFocus,"data-collection":L["data-collection"],"data-key":L["data-key"]}:L,se,ue,de,ce,k.shouldUseVirtualFocus||p?{onMouseDown:r=>r.preventDefault()}:void 0,b?void 0:{onClick:ie}),tabIndex:L.tabIndex!=null&&B&&!k.shouldUseVirtualFocus?-1:L.tabIndex},labelProps:{id:z},descriptionProps:{id:V},keyboardShortcutProps:{id:_},isFocused:U,isFocusVisible:U&&m.isFocused&&W()&&!B,isSelected:j,isPressed:le,isDisabled:b}}function Re(e){let{heading:t,"aria-label":n}=e,a=he();return{itemProps:{role:"presentation"},headingProps:t?{id:a,role:"presentation"}:{},groupProps:{role:"group","aria-label":n,"aria-labelledby":t?a:void 0}}}const Ne=e=>typeof e.onClick<"u"&&typeof e.type>"u",C=e=>typeof e.onClick<"u"&&e.type==="switch",je=(e,t)=>{const[n,a]=T.useState(t??!1),[o,u]=T.useState({switchComponent:void 0,switchValue:null,toggleSwitch:null});return T.useEffect(()=>{if(e){const l=()=>a(!n);u({switchComponent:M.jsx(Ie,{size:"small",mode:n?"on":"off"}),switchValue:n,toggleSwitch:l})}},[e,n]),o},R=({menuItem:e,node:t,state:n,isSelected:a,onClick:o})=>{const u=T.useRef(null),l=C(e)?e.initialValue:!1,{switchComponent:s=void 0,switchValue:i=null,toggleSwitch:c=null}=je(C(e),l),{menuItemProps:v}=Oe({...t,onAction:()=>{Ne(e)&&e.onClick(),C(e)&&(c==null||c(),e.onClick(!i))},isDisabled:(e==null?void 0:e.disabled)||!1,"aria-label":typeof(e==null?void 0:e.title)=="string"?e==null?void 0:e.title:"Menu item"},n,u),{title:y,decorator:h,subtitle:f,size:E,style:g,disabled:x,selectionIndicator:H}=e,{isFocusVisible:q,focusProps:$}=Me();return M.jsx("li",{...K(v,$,{onClick:()=>o==null?void 0:o()}),"data-test-id":"menu-item",className:Y(["tw-relative hover:tw-bg-box-neutral-hover tw-list-none tw-outline-none",x&&"tw-pointer-events-none tw-top-px",q&&Be]),ref:u,children:M.jsx(pe,{title:y,decorator:h,subtitle:f,size:E,style:g,disabled:x,active:a,selectionIndicator:H,switchComponent:s})})};R.displayName="FondueAriaMenuItem";R.__docgenInfo={description:"",methods:[],displayName:"FondueAriaMenuItem",props:{menuItem:{required:!0,tsType:{name:"union",raw:"MenuItemType | ActionMenuItemType | ActionMenuSwitchItemType",elements:[{name:"intersection",raw:"Omit<MenuItemProps, 'switchComponent'> & { id: string | number; link?: string }",elements:[{name:"Omit",elements:[{name:"intersection",raw:`{
    style?: MenuItemStyle;
    disabled?: boolean;
    active?: boolean;
    checked?: boolean;
