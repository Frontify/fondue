import{r as c,j as P}from"./iframe-BqgOTfwa.js";import{T as I}from"./TooltipIcon-BCy_DpZQ.js";import{I as _}from"./LegacyTooltip-DGO3TtJt.js";import{S as z}from"./Switch-Ctc9Ldob.js";import"./preload-helper-r7mqpNn-.js";import"./IconQuestionMarkCircle-BwHtgLG2.js";import"./IconSize-BcCrF_mi.js";import"./focusStyle-Ch_WJ4aJ.js";import"./merge-DI-veSMP.js";import"./useLink-BejGtILL.js";import"./useFocusable-D_4hoYqL.js";import"./useFocusRing-BweZAzx4.js";import"./useEffectEvent-B4X5HiKo.js";import"./chain-HAlYixg1.js";import"./index-CgrGmFqi.js";import"./usePopper-DiPlZxVo.js";import"./index-BejIcTrN.js";import"./Button-BE7kNGjk.js";import"./useButton-BpBUB3rp.js";import"./Portal-7bvFvlVR.js";import"./useMemoizedId-DSuw5pzl.js";import"./IconCheckMark-SXJwau5u.js";import"./IconExclamationMarkCircle24-C3Etd_Ph.js";import"./IconExclamationMarkTriangle-B4aOvOZA.js";import"./IconExclamationMarkTriangle24-C4r90FB-.js";import"./InputLabel-CCR5wAUJ.js";const H=["small","medium"],k=["on","off","indeterminate"],q=["default","heading"],ce={title:"Components/Switch",component:z,tags:["autodocs"],argTypes:{size:{options:H,control:{type:"radio"}},labelStyle:{options:q,control:{type:"radio"}},label:{placeholder:"Switch label",type:{name:"string",required:!1},control:{type:"text"}},mode:{options:k,control:{type:"radio"}},onChange:{table:{disable:!1},action:"Change"}},args:{mode:"on",disabled:!1,labelStyle:"default",hug:!1,name:"switch-name",size:"small"},parameters:{status:{type:"deprecated"},docs:{description:{component:"### This component is deprecated, please use the [new Switch component](/docs/current_components-switch--documentation) instead."}}}},o=e=>{const[d,m]=c.useState(e.mode||"off");c.useEffect(()=>{e.mode&&m(e.mode)},[e.mode]);const j=A=>{m(d==="on"?"off":"on"),e.onChange&&e.onChange(A)};return P.jsx(z,{...e,onChange:j,mode:d})},t=o.bind({});t.args={size:"small"};const n=o.bind({});n.args={size:"medium"};const s=o.bind({});s.args={label:"Switch label"};const r=o.bind({});r.args={label:"Switch label",tooltip:{content:"Switch tooltip"}};const a=o.bind({});a.args={label:"Switch label",tooltip:[{content:"First tooltip"},{content:"Second Tooltip",triggerIcon:P.jsx(_,{}),triggerStyle:I.Warning}]};const i=o.bind({});i.args={hug:!0,label:"Switch label"};var g,l,p;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:`(args: Props) => {
