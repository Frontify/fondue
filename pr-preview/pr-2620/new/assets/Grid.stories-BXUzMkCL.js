import{j as e}from"./iframe-CQSKmblA.js";import{D as R}from"./DecorativeContent-D2_kQMwZ.js";import{B as F}from"./Box-V_eTPlH7.js";import{G as t}from"./Grid-0eo9Ll-t.js";import"./preload-helper-DI-8CSFo.js";const r=s=>e.jsx(F,{width:"100px",height:"100px",...s,children:e.jsx(R,{})});r.displayName="DecorativeBox";const E={title:"Layout/Grid",component:t,tags:["autodocs"],parameters:{status:{type:"released"},docs:{description:{component:["A two-dimensional layout container using CSS Grid. Defines rows and columns for complex, responsive layouts.","","**When to use:** For two-dimensional layouts like card grids, dashboards, or form layouts. For single-axis layouts use `<Flex>`."].join(`
