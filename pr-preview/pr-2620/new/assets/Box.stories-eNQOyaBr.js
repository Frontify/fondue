import{j as o}from"./iframe-CQSKmblA.js";import{D as B}from"./DecorativeContent-D2_kQMwZ.js";import{B as n}from"./Box-V_eTPlH7.js";import"./preload-helper-DI-8CSFo.js";const j={title:"Layout/Box",component:n,tags:["autodocs"],parameters:{status:{type:"released"},docs:{description:{component:["A generic container with responsive spacing, sizing, and positioning props. The simplest layout primitive in Fondue.","","**When to use:** When you need margin, padding, or sizing control without Flex or Grid behavior. For directional layouts use `<Flex>`, for two-dimensional layouts use `<Grid>`."].join(`
