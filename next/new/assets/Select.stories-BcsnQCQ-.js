...
`,...(k=(V=m.parameters)==null?void 0:V.docs)==null?void 0:k.source}}};var M,_,R;S.parameters={...S.parameters,docs:{...(M=S.parameters)==null?void 0:M.docs,source:{code:`const Clearable = () => {
  return (
    <Select aria-label="Select an item" placeholder="Select an item">
...
`,...(ye=(Ce=b.parameters)==null?void 0:Ce.docs)==null?void 0:ye.source}}};var Ge,ze,Be;o.parameters={...o.parameters,docs:{...(Ge=o.parameters)==null?void 0:Ge.docs,source:{code:`const WithDecorator = () => {
  return (
    <Select aria-label="Select an item" placeholder="Select an item">
      <Select.Slot name="left">
        <IconIcon size={16} />
...
`,...(Be=(ze=o.parameters)==null?void 0:ze.docs)==null?void 0:Be.source}}};var Ae,We,Fe;c.parameters={...c.parameters,docs:{...(Ae=c.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
  name: 'Select',
  render: args => {
    return <Select {...args}>
                <Select.Item value="test1">Test1</Select.Item>
