...
`,...(I=(T=l.parameters)==null?void 0:T.docs)==null?void 0:I.source}}};var g,S,f;s.parameters={...s.parameters,docs:{...(g=s.parameters)==null?void 0:g.docs,source:{code:`const WithSelect = () => {
  return (
    <div className="tw-flex tw-flex-col tw-gap-2">
...
`,...(f=(S=s.parameters)==null?void 0:S.docs)==null?void 0:f.source}}};var y,w,v;p.parameters={...p.parameters,docs:{...(y=p.parameters)==null?void 0:y.docs,source:{code:`const WithCombobox = () => {
  return (
    <div className="tw-flex tw-flex-col tw-gap-2">
...
`,...(v=(w=p.parameters)==null?void 0:w.docs)==null?void 0:v.source}}};var N,j,W;c.parameters={...c.parameters,docs:{...(N=c.parameters)==null?void 0:N.docs,source:{code:`const WithCheckbox = () => {
  // Used to get the correct component name in the Storybook of the \`TextInput\` (instead of \`TextInput.Root\`)
  const STextInput = (props: ComponentProps<typeof TextInput>) => (
    <TextInput {...props} />
  );
...
`,...(W=(j=c.parameters)==null?void 0:j.docs)==null?void 0:W.source}}};var C,L,k;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{code:`const WithTooltip = () => {
  // Used to get the correct component name in the Storybook of the \`TextInput\` (instead of \`TextInput.Root\`)
  const STextInput = (props: ComponentProps<typeof TextInput>) => (
    <TextInput {...props} />
  );
...
`,...(k=(L=i.parameters)==null?void 0:L.docs)==null?void 0:k.source}}};var F,H,R;d.parameters={...d.parameters,docs:{...(F=d.parameters)==null?void 0:F.docs,source:{code:`const Strong = () => {
  // Used to get the correct component name in the Storybook of the \`TextInput\` (instead of \`TextInput.Root\`)
  const STextInput = (props: ComponentProps<typeof TextInput>) => (
    <TextInput {...props} />
  );
...
`,...(R=(H=d.parameters)==null?void 0:H.docs)==null?void 0:R.source}}};var E,O,P;r.parameters={...r.parameters,docs:{...(E=r.parameters)==null?void 0:E.docs,source:{code:`const Mandatory = () => {
  // Used to get the correct component name in the Storybook of the \`TextInput\` (instead of \`TextInput.Root\`)
  const STextInput = (props: ComponentProps<typeof TextInput>) => (
    <TextInput {...props} />
  );
...
`,...(P=(O=r.parameters)==null?void 0:O.docs)==null?void 0:P.source}}};var U,q,M;a.parameters={...a.parameters,docs:{...(U=a.parameters)==null?void 0:U.docs,source:{code:`const WithTextInput = () => {
  // Used to get the correct component name in the Storybook of the \`TextInput\` (instead of \`TextInput.Root\`)
  const STextInput = (props: ComponentProps<typeof TextInput>) => (
    <TextInput {...props} />
  );
...
`,...(M=(q=a.parameters)==null?void 0:q.docs)==null?void 0:M.source}}};var z,D,Q;r.parameters={...r.parameters,docs:{...(z=r.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    required: true
  },
  render: args => {
...
}`,...(ce=(pe=d.parameters)==null?void 0:pe.docs)==null?void 0:ce.source}}};const Oe=["Mandatory","WithTextInput","WithDisabledInput","WithSelect","WithCombobox","WithCheckbox","WithTooltip","Strong"];export{r as Mandatory,d as Strong,c as WithCheckbox,p as WithCombobox,l as WithDisabledInput,s as WithSelect,a as WithTextInput,i as WithTooltip,Oe as __namedExportsOrder,Ee as default};
