...
`,...(I=(T=a.parameters)==null?void 0:T.docs)==null?void 0:I.source}}};var g,S,f;l.parameters={...l.parameters,docs:{...(g=l.parameters)==null?void 0:g.docs,source:{code:`const WithDisabledInput = () => {
  // Used to get the correct component name in the Storybook of the \`TextInput\` (instead of \`TextInput.Root\`)
  const STextInput = (props: ComponentProps<typeof TextInput>) => (
    <TextInput {...props} />
  );
...
`,...(f=(S=l.parameters)==null?void 0:S.docs)==null?void 0:f.source}}};var y,w,v;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{code:`const WithSelect = () => {
  return (
    <div className="tw-flex tw-flex-col tw-gap-2">
...
`,...(v=(w=s.parameters)==null?void 0:w.docs)==null?void 0:v.source}}};var N,j,W;p.parameters={...p.parameters,docs:{...(N=p.parameters)==null?void 0:N.docs,source:{code:`const WithCombobox = () => {
  return (
    <div className="tw-flex tw-flex-col tw-gap-2">
...
`,...(W=(j=p.parameters)==null?void 0:j.docs)==null?void 0:W.source}}};var C,L,k;c.parameters={...c.parameters,docs:{...(C=c.parameters)==null?void 0:C.docs,source:{code:`const WithCheckbox = () => {
  // Used to get the correct component name in the Storybook of the \`TextInput\` (instead of \`TextInput.Root\`)
  const STextInput = (props: ComponentProps<typeof TextInput>) => (
    <TextInput {...props} />
  );
...
`,...(k=(L=c.parameters)==null?void 0:L.docs)==null?void 0:k.source}}};var F,H,R;i.parameters={...i.parameters,docs:{...(F=i.parameters)==null?void 0:F.docs,source:{code:`const WithTooltip = () => {
  // Used to get the correct component name in the Storybook of the \`TextInput\` (instead of \`TextInput.Root\`)
  const STextInput = (props: ComponentProps<typeof TextInput>) => (
    <TextInput {...props} />
  );
...
`,...(R=(H=i.parameters)==null?void 0:H.docs)==null?void 0:R.source}}};var E,O,P;d.parameters={...d.parameters,docs:{...(E=d.parameters)==null?void 0:E.docs,source:{code:`const Strong = () => {
  // Used to get the correct component name in the Storybook of the \`TextInput\` (instead of \`TextInput.Root\`)
  const STextInput = (props: ComponentProps<typeof TextInput>) => (
    <TextInput {...props} />
  );
...
`,...(P=(O=d.parameters)==null?void 0:O.docs)==null?void 0:P.source}}};var U,q,M;r.parameters={...r.parameters,docs:{...(U=r.parameters)==null?void 0:U.docs,source:{code:`const Mandatory = () => {
  // Used to get the correct component name in the Storybook of the \`TextInput\` (instead of \`TextInput.Root\`)
  const STextInput = (props: ComponentProps<typeof TextInput>) => (
    <TextInput {...props} />
  );
...
`,...(M=(q=r.parameters)==null?void 0:q.docs)==null?void 0:M.source}}};var z,D,Q;r.parameters={...r.parameters,docs:{...(z=r.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    required: true
  },
  render: args => {
