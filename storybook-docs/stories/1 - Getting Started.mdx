...
For cases where developers do not have access to Diatype, the tokens specifiy a fallbaclk font `Geist`.
...
If you want to use a component, you can import them through the `@frontify/fondue/components` subexport in the fondue package.
