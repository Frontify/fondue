...
8. Preserve the "Setup for AI-Assisted Figma→Code (CLAUDE.md snippet)" section at the bottom — this section provides a ready-to-paste snippet for consuming repositories and should not be removed or modified during regeneration.
